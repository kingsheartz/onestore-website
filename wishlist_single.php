    ...
    <div class="breadcrumbs" style="background-color: #eaeded">
        <div class="container">
            <ol class="breadcrumb breadcrumb1" style="background-color: #eaeded">
                ...
                <li><a href="wishlist.php"><span class="glyphicon glyphicon-file" aria-hidden="true"></span>Wish list</a></li>
...
.settings_show h3,.wishlist_items_show h3{
...
<br>
<h3 style="color: #0599dd;display: flex;" class="div-wrapper"><div><img src="images/logo/wishlist2.png" style="max-height: 45px;"> </div><div style="display: flex;align-items: center;"><?=$update_setting_row['list_name']?> <div class="wishlist_cnt">(<?=$rowcount?>)</div></div></h3>
    ...
    <h3>Settings <i class="fa fa-cog"></i></h3>
        <form action="#" onsubmit="return update_my_list()" class=" shadow_b" style="background-color: white;padding: 15px;border-radius: 5px;">
             ...
             <table style="width: 100%;padding: 5px;" class="create_wishlist_table">
                    ...
                    <tr>                        
                        <td>
                            <div class="input-group bar-srch listgrp" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;grid-gap: 0px;" >  
                                <input type="text" placeholder="Wishlist name" id="wishlist_name_input" onkeyup="changed_details()"  value="<?=$update_setting_row['list_name']?>" name="" style="width: 100%;border-radius: 5px;outline-color: #e59700;border-top-right-radius: 0px;border-bottom-right-radius: 0px;" required="" readonly>
                    ...
                    <tr>    
                        <td>
                            ...
                            <div class="form-group listgrp" style="text-align: right;width: 100%;position: relative;">
                                <textarea rows="4" onkeyup="changed_details()" id="wishlist_description_input" style="width: 100%;border-radius: 5px;outline-color: #e59700" placeholder="Describe your wishlist" readonly><?=$update_setting_row['wishlist_description']?></textarea>
                    ...
                    <tr>
                        <td>
                            <div class="div-wrapper" onclick="changed_details()" style="grid-gap: 0;margin: auto;display: flex;"><input type="radio" value="public" id="public" name="privacy"><label for="public">&nbsp;Public</label><div><span style="font-size: 12px;color: #666">-Anyone can search for and see this list.You can also share using a link</span></div></div>
                        </td>                   
                    </tr>
                    <tr>
                        <td>
                            <div class="div-wrapper" onclick="changed_details()" style="grid-gap: 0;margin: auto;display: flex;"><input type="radio" value="shared" id="shared" name="privacy"><label for="shared">&nbsp;Shared</label><div><span style="font-size: 12px;color: #666">-Only people with the link see this list.It will not appear in public search results.</span></div></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="radio" id="private" onclick="changed_details()" value="private" name="privacy"><label for="private">&nbsp;Private</label><span style="font-size: 12px;color: #666"> - Only you can see the list</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td><br><br>
                           <center>
                            <button style="width: 40%;color: white;padding-top: 3px;padding-bottom: 3px;float:left" type="submit" id="createlist" class="btn btn-default search" name="createlist" disabled=""><h4 style="text-transform: capitalize;">Save changes</h4></button>
                            </center>
                        </td>
                    </tr>
...
?>                    
        <div class="col-md-12" style="margin:0px;padding: 0px;">
            ...
            <div class="product-content-right nopadding-margin" style="margin:0px;padding: 0px;margin-right:0px;background-color: white;border-radius: 10px;">
                <h2 class="sidebar-title" style="border-left: 5px solid #c50505;border-top-left-radius: 10px;text-align: left;padding-bottom: 30px;padding-top: 20px;background-color: white;margin-top: 0px;font-weight:normal;border-bottom:#333;margin-bottom: 0px;border-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; ">Wish List <i style="color: red" class="fa fa-heart"></i>
                    <span style="float: right;margin-right: 5px;margin-top: -16px;">
                        <input type="button" style="max-width: 150px;height: 60px;font-weight: bold;border-top-right-radius: 10px;background-color: #c50505" onclick="updateall_cart()" value="Move to cart" id="proceed" name="proceed" class="checkout-button button alt wc-forward">
                    </span>
                </h2>
...
?>
                                            <a href="#" style="color: white;font-weight: normal;text-align:justify;font-size:17px;"><i class="fa fa-product-hunt" style=""></i> <?=$item_name2?></a>
                                        </div> 
                                    </p> 
                                </div>
                                            ...
                                            <div style="width: 180px;margin-top: 5px;" class="tbl_wi<?=$wishlist_items_id?>">
                                                <div class="product-quantity quantity buttons_added" style="justify-content: center;display: flex;text-align: center;align-items: center;position: relative;margin-right: 0px">
                                                    <div class="product_img div-wrapper" style="padding: 0px; margin-top: 7px;margin-left: 15px;grid-gap: 10px;">
                                                        <input style="display:none" id="check_s<?=$store_id."i".$item_description_id?>" type="checkbox" name="select_item">    
                                                        <p class="product-thumbnail" style="text-align:right;">
                                                            <a href="single.php?id=<?=$row2['item_description_id']?>">
                                                                <img style="max-width:180px;max-height:180px;" alt="<?=$row2['item_name']?>" class="shop_thumbnail" src="images/<?=$row2['category_id']?>/<?=$row2['sub_category_id']?>/<?=$row2['item_description_id']?>.jpg">
                                                            </a>
                                                        </p>
                                                    </div>      
                                                </div>     
                                            ...
                                            <div>
                                                ...
                                                <ul>
                                                    ...
                                                    <p class="large_specs_seen">
                                                        <img alt="" src="images/logo/logofill-sm.png" style="max-width:115px" data-a-hires="https://m.media-amazon.com/images/G/31/marketing/fba/fba-badge_18px-2x._CB485942108_.png">
                                                    </p>
...
?> 
                                ...
                                <div width="100%" class="tbl_wi<?=$wishlist_items_id?>">
                                    <div class="product-quantity quantity buttons_added big_bottom_pdt_dtls" style="margin-right: 0px;width: 100%">
                                        ...
                                        <div>
                                            <p class="product-store"><i style="color: #303030;bottom: 0px;margin-top: 2px;margin-left: 5px;" class="fas fa-store">&nbsp;</i> 
...
<div class="row" style="margin:0px;padding: 0px">
    ...
    <div class="col-md-4 small" id="small_screen" style="margin:0px;padding: 0px"></div>
        ...
        <center style="margin-bottom:0px;margin-top: 50px;"><h4>Need more ?<a href="onestore.php"> Start adding!</a></h4></center>
<?php
}else{
 /*COLOR PICKER*/
...
?>          <div class="row emp_cart">
                <div class="product-content-right">
                    ...
                    <h2 class="sidebar-title" style="text-align: center;display: inline-flex;font-weight: 600;color:#c50505">Your Wish List is Empty</h2>
                    <h4>No items in your wishlist.<a href="onestore.php">Start adding!</a></h4></center>
                </div>
                  ...
                  <div class="shadow_b">
                    <h4 class="show_cat_list_main tb-padding sidebar-title cart_empty_show_cat" style="border-left: 5px solid <?=$bgcolor[$rancolor1]?>;border-top-left-radius: 10px;text-align: left;padding-bottom: 10px;padding-top: 10px;background-color: white;font-weight:normal;border-bottom:#333;margin-bottom: -5px;margin-top: 13px;border-top-right-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; overflow: hidden;font-size: 18px;"><?=$sub_cat_name1?> <i style="color: #ff5722;" class="fa fa-arrow-right"></i>
                        <span style="float: right;margin-right: 5px;margin-top: -4px;">
                            <button type="button" style="max-width: 150px;height: 30px;font-weight: bold;border-top-right-radius: 10px;background-color: <?=$bgcolor[$rancolor1]?>;padding: 11px auto;font-size: 12px;"  name="proceed" class="checkout-button button alt wc-forward"><a href="" style="color:<?=$c1?>;">View all</a></button>
                        </span>
                    </h4>
...
<br>
                <div class="shadow_b">
                    <h4 class="show_cat_list_main tb-padding sidebar-title cart_empty_show_cat" style="border-left: 5px solid <?=$bgcolor[$rancolor2]?>;border-top-left-radius: 10px;text-align: left;padding-bottom: 10px;padding-top: 10px;background-color: white;font-weight:normal;border-bottom:#333;margin-bottom: -5px;margin-top: 13px;border-top-right-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; overflow: hidden;font-size: 18px;"><?=$sub_cat_name2?> <i style="color: #ff5722;" class="fa fa-arrow-right"></i>
                        <span style="float: right;margin-right: 5px;margin-top: -4px;">
                            <button type="button" style="max-width: 150px;height: 30px;font-weight: bold;border-top-right-radius: 10px;background-color: <?=$bgcolor[$rancolor2]?>;padding: 11px auto;font-size: 12px;"  name="proceed" class="checkout-button button alt wc-forward"><a href="" style="color:<?=$c2?>;">View all</a></button>
                        </span>
                    </h4>
                    <hr style="padding: 0;margin:0;">
                ...
                $.ajax({
                        ...
                        success: function(data){    //if registration is success
                            if(data.status=='success'){
                                        ...
                                        .then((willSubmit1) => {
                                            if(willSubmit1) {
                                                location.href="wishlist_single.php";
                                                return;
                                            }
                                            else{
                                                return ;
