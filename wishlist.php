...
@media (max-width: 700px){
	.your_wishlist_head,.create_wishlist_head,.search_wishlist_head{
		font-size: 20px;
	}
	.img_wishlist{
...
@media (max-width: 345px){
	...
	.yw span,.sw span,.caw span,.yw-active span,.sw-active span,.caw-active span{
...
<div style="background: url(images/logo/check1.jpg);">
	<div style="background-color: rgba(0,0,0,.65);">
		<center>
			<div class="img_wishlist_div" style="background-color: rgba(255,255,255);padding: 30px;display: inline-block;border-radius: 50%;margin-top: 20px;border:3px solid black">
				...
				<h2 style="display: none;" class="create_wishlist_head">
					<a href="#" style="color: #000;font-size: 1.5em">
						<span class="fa fa-file-text" style="color: #F1E5B5;"></span><span style="color: #fff"> Create a wishlist </span>
					</a>                    
				</h2>

				<h2  class="your_wishlist_head">
					<a href="#" style="color: #000;font-size: 1.5em">
						<span class="fa fa-heart" style="color: #c50505;"></span><span style="color: #fff"> Your Wishlists </span>
					</a>                    
				</h2>

				<h2 style="display: none;"  class="search_wishlist_head">
					<a href="#" style="color: #000;font-size: 1.5em">
						<span class="fa fa-search" style="color: #fe9126;"></span><span style="color: #fff"> Search Wishlist </span>
					</a>                    
				</h2>
					...
					<div class="col-md-12">
						<h3>
							 <div class="div-wrapper">	
								<div class="wishlist-method caw" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#myModal_create_wishlist">
									<span class="fa fa-file-text"> Create a wishlist</span>
									
								</div>
								<div class="wishlist-method  caw-active" style="display: none;">
									<span class="fa fa-file-text" style="color: #F1E5B5"> <span style="color: #0f99ff;">Create a wishlist</span></span>
								</div>
								...
								<div class="wishlist-method yw-active" style="border-left:1px solid #fff;">
									<span class="fa fa-heart" style="color:#c50505 "> <span style="color: #0f99ff">Your wishlist</span></span>
								</div>
								...
								<div class="wishlist-method sw-active" style="border-left:1px solid #fff;display: none;">
									<span class="fa fa-search" style="color: #fe9126"> <span style="color: #0f99ff">Search wishlist</span></span>
								</div>
							</div>
						</h3>
					</div>
					...
					<div class="col-md-12">
						<h3>	
							<div class="div-wrapper">
								...
								<div style="background-color: black;padding: 15px;border-radius: 5px;" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#myModal_create_wishlist">
									...
									<div class="wishlist-method  caw-active" style="display:flex;align-items: center;justify-content: center;display: none;">
										<span class="fa fa-file-text" style="color: #F1E5B5"> <span style="color: #0f99ff;">Create</span></span>
									</div>
								...
								<div style="background-color: black;padding: 15px;border-radius: 5px;">
									...
									<div class="wishlist-method yw" style="display:flex;align-items: center;justify-content: center;display: none;">
										<span class="fa fa-heart"> Wishlist</span>
									</div>

									<div class="wishlist-method yw-active" style="display:flex;align-items: center;justify-content: center;">
										<span class="fa fa-heart" style="color:#c50505 "> <span style="color: #0f99ff;">Wishlist</span></span>
									</div>
								...
								<div style="background-color: black;padding: 15px;border-radius: 5px;"> 
									...
									<div style="" class="wishlist-method sw" style="display:flex;align-items: center;justify-content: center;">
										<span class="fa fa-search"> Search</span>
									</div>

									<div class="wishlist-method sw-active" style="display:flex;align-items: center;justify-content: center;display: none;">
										<span class="fa fa-search" style="color: #fe9126"> <span style="color: #0f99ff;">Search</span></span>
									</div>
						...
						<div class="col-md-12">
								...
								<tbody>
									...
									<tr style="background-color: #0f99cc;"> 
										<th><h4>Wishlists</h4></th>
										<th><h4>Privacy</h4></th>
										<th><h4>Item count</h4></th>
...
?>										<div onclick="location.href='wishlist_single.php?wishlist_id=<?=$row_wish['wishlist_id']?>'">
										<td onclick="location.href='wishlist_single.php?wishlist_id=<?=$row_wish['wishlist_id']?>'"><h4 title="<?=$row_wish['list_name']?>"><?=$listname?></h4></td>
										<td onclick="location.href='wishlist_single.php?wishlist_id=<?=$row_wish['wishlist_id']?>'"><h4><?=$row_wish['privacy']?></h4></td>
										<td onclick="location.href='wishlist_single.php?wishlist_id=<?=$row_wish['wishlist_id']?>'"><h4><?=$row_wish1['item_count']?></h4></td>
										<td onclick="location.href='wishlist_single.php?wishlist_id=<?=$row_wish['wishlist_id']?>'"><h4><?=$row_wish['date']?></h4></td>
										</div>


										<td><h4>
											<select style="font-size: 16px;" onchange="actions(this,'<?=$row_wish['wishlist_id']?>')" id="sharewid_<?=$row_wish['wishlist_id']?>">
												<option value="0" selected="" disabled="">Select</option>
                                                <option value='1' style="color: #333;">Edit</option>
                                                <option value="2" style="color: #333;">Delete</i></option>
												<option value="https://one-store.ml/wishlist_share.php?sharelink=<?=$row_wish['share_link']?>" style="color: #333;">Share</i></option>
                                            </select>
										</h4></td>
									</tr>
	<?php
	...
	?>							
	<h4 style="margin-top: 50px;color: #ccc">No lists are found.<a  data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#myModal_create_wishlist" >Create one!</a></h4>
	...
	<h4 style="margin-top: 50px;color: #ccc">You are not logged in. Please <a href="#myModal" data-toggle="modal" data-dismiss="modal">Log in!</a></h4>
...
?>										
							...
							<div id="show_wishlist_small">
								...
								<table class="wltr ywl_table_small del_w_<?=$row_wish['wishlist_id']?>" cellpadding="20px" cellspacing="20px" width="100%" style="background-color: rgba(0,0,0,.65);">

									<tr style="background-color: #0f99cc;" onclick="location.href='wishlist_single.php?wishlist_id=<?=$row_wish['wishlist_id']?>'"> 
										<th colspan="2"><h4 class="ywl_table_small_list_head" title="<?=$row_wish['list_name']?>"><?=$listname?> &nbsp;<i class="fa fa-file-text"></i><i class="fa fa-heart" style="font-size: 12px;color:#c50505 "></i></h4></th>
									</tr>
									
									<tr>
										<th class="ywl_small_table_th"><h4>Privacy</h4></th>
										<td class="ywl_small_table_td"><h4><?=$row_wish['privacy']?></h4></td>
									</tr>
									<tr>
										<th class="ywl_small_table_th"><h4>Item count</h4></th>
										<td class="ywl_small_table_td"><h4><?=$row_wish1['item_count']?></h4></td>
									</tr>
									<tr>
										<th class="ywl_small_table_th"><h4>Created on</h4></th>
										<td class="ywl_small_table_td"><h4><?=$row_wish['date']?></h4></td>
									</tr>										
									<tr>
									<td colspan="2">
									<table style="width:100%">
										<tr>
											<td><h4><i class="fa fa-edit" onclick="location.href='wishlist_single.php?wishlist_id=<?=$row_wish['wishlist_id']?>&setting=1'"></i></h4></td>

											<td><h4><i class="fa fa-trash" onclick='del_list("<?=$row_wish['wishlist_id']?>")'></i></h4></td>

											<td><h4><i class="fa fa-share" onclick="copylink(<?=$row_wish['wishlist_id']?>,'https://one-store.ml/wishlist_share.php?sharelink=<?=$row_wish['share_link']?>')"></i></h4></td>
										</tr>
									</table>
									</td>
									</tr>
...
function dispsrch(){
	...
	var inputVal = $('#wishsrch').val();
        $.get("getwishlist.php", {name: inputVal}).done(function(data){
...
<div class="search_wishlist" style="display: none;">
								...
								<table id="wishlisttable"cellpadding="20px" cellspacing="20px" width="100%">
									...
									<tr>
										<div  class="input-group bar-srch"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;" > 
                                			<input  type="text" class="" id="wishsrch"  placeholder="Search wishlist" value="" name="" required=" " style="width: 100%;margin: 0px;z-index: 0;border-radius: 3px;border-top-right-radius: 0px;border-bottom-right-radius: 0px;outline: none;">

                                
                                			<span id="" class="input-group-btn" >
                                        		<button onclick="dispsrch()" onmouseover="$(this).css('background-color','#ee8126')" onmouseleave="$(this).css('background-color','#fe9126')" style="color: white;background-color:#fe9126;padding-top:10px;padding-bottom: 10px;outline: none;border-radius: 0;" class="btn btn-default search_btn" type="button"><span class="fa fa-search"></span></button>
                                			</span>
                                			<span id="" class="input-group-btn" >
                                        		<button onmouseover="$(this).css('background-color','#0d99cc')" onmouseleave="$(this).css('background-color','#0f99cc')" onclick="$('#wishsrch').val('');dispsrch()" style="color: white;background-color:#0f99cc;padding-top:10px;padding-bottom: 10px;outline: none;" class="btn btn-default search_btn" type="button"><span class="fa fa-refresh"></span></button>
                                			</span>
                            			</div>
                        			</tr>

									<tr style="background-color: #0f99cc;"> 
										<th><h4>Wishlist of</h4></th>
										<th><h4>Name</h4></th>
										<th><h4>Item count</h4></th>
										<th><h4>Created on</h4></th>
									</tr>
	...
	?>
									...
									<tr class="wltr" onclick="location.href='wishlist_public.php?wishlist_id=<?=$row_wish1['wishlist_id']?>'">
	<?php
...
if(strlen($row_wish1['list_name'])<15){
	...
	?>
										<td><h4 title="<?=$row_wish1['first_name']?>"><?=$listownername?></h4></td>
										<td><h4 title="<?=$row_wish1['list_name']?>"><?=$listname?></h4></td>
										<td><h4><?=$row_wish2['item_count']?></h4></td>
										<td><h4><?=$row_wish1['date']?></h4></td>
									</tr>
	<?php
	}
		?>								
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #fe9126">
          ...
          <h4 class="modal-title">
          	...
          	<span style="color: #fff"> Create a wishlist </span></h4>
        </div>
        <div class="modal-body">
        	<center>
        		<div style="background-color: rgba(255,255,255);padding: 10px;display: inline-block;border-radius: 50%;margin-top: 0px;border:3px solid black;">
            ...
            <form action="#" onsubmit="return create_my_list()" method="post" enctype="multipart/form-data">
				<table style="background-color: #fff;width: 100%" class="create_wishlist_table">
					...
					<tr>						
						<td>
							<input type="text" placeholder="Wishlist name" name="Wishlist_name" id="Wishlist_name" required="" style="width: 100%;border-radius: 5px;outline-color: #e59700">	
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>	
						<td>
							<textarea placeholder="Describe your wishlist" name="Wishlist_descibe" id="Wishlist_descibe" style="width: 100%;border-radius: 5px;outline-color: #e59700"></textarea> 
						</td>	
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<div class="div-wrapper" style="grid-gap: 0;margin: auto;display: flex;"><input type="radio" id="public" class="privacy" name="privacy" value='public' ><label for="public">&nbsp;Public</label><div><span style="font-size: 12px;color: #666">-Anyone can search for and see this list.You can also share using a link</span></div></div>
						</td>					
					</tr>
					<tr>
						<td>
							<div class="div-wrapper" style="grid-gap: 0;margin: auto;display: flex;"><input type="radio" id="shared" class="privacy" name="privacy" value="shared"><label for="shared">&nbsp;Shared</label><div><span style="font-size: 12px;color: #666">-Only people with the link see this list.It will not appear in public search results.</span></div></div>
						</td>
					</tr>
					<tr>
						<td>
							<input type="radio" id="private" class="privacy" name="privacy" value="private"><label for="private">&nbsp;Private</label><span style="font-size: 12px;color: #666"> - Only you can see the list</span>
						</td>
					</tr>
					...
					<tr>
						<td><br><br>
							<center>
							<button style="width: 100%;color: white;padding-top: 3px;padding-bottom: 3px;" type="submit" id="createlist" class="btn btn-default search" name="createlist" onclick=""><h4 style="text-transform: capitalize;">create wishlist</h4></button>
							</center>
						</td>
					</tr>
    ...
    <div class="modal-dialog modal-m" style="background-color: white;border-radius: 7px;">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #c50505">
          ...
          <h4 class="modal-title">
          	<span class="fa fa-file-text" style="color: #fff;"></span>
          	<span style="color: #fff"> Share your wishlist </span></h4>
        </div>
        <div class="modal-body">
        	<center>
        		<div style="background-color: rgba(255,255,255);padding: 10px;display: inline-block;border-radius: 50%;margin-top: 0px;border:3px solid black;">
					...
					<tr>						
						<td>
							<div  class="input-group bar-srch"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 0px;" > 
								...
								<span id="" class="input-group-btn" >
										<button id="copy_wl" onclick="clipboard()"  style="color: white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #740000), color-stop(1, #ff0000)) !important;padding-top:10px;padding-bottom: 10px;outline: none;border-radius: 0;border-bottom-right-radius: 3px;border-top-right-radius: 3px;" class="btn btn-default search_btn" type="button"><span class="fas fa-copy"></span></button>
								</span>
							</div>
						</td>
					</tr>
...
function copylink(wid,link) {
  ...
  var fb_content='<div class="fb-share-button"  data-href="'+link+'" data-layout="button_count" data-size="small" style="margin:auto;width: 30px;height: 30px;background-color: #395693;border-radius:3px;display: flex;align-items: center;justify-content: center;"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fone-store.ml%2Fwishlist.php%3Fsharelink%3D'+code[1]+'&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore"><i class="fa fa-facebook fa-lg" style="color: white;"></i></a></div><p>Facebook</p>';
  $('.facebook').html(fb_content);
 "https://one-store.ml/wishlist_share.php?sharelink=62_60c9b30ccaa8a&amp;fbclid=IwAR310ESZCEPJ8uFUub--H6gnJ3FkFRjgzz1duPK3NVdARhV2f8VD1GWtpX0"
...
function actions(selectmenu , wishlist_id){
	...
	if(selectmenu.value==2){
		...
		location.href='wishlist_single.php?wishlist_id='+wishlist_id+'&setting=1';
	}
	else{
...
var markup='<tr class="wltr del_w_'+data.wid+'"><td onclick="location.href=\'wishlist_single.php?wishlist_id=\''+data.wid+'"><h4 title="list_name">'+listname+'</h4></td><td onclick="location.href=\'wishlist_single.php?wishlist_id=\''+data.wid+'"><h4>'+privacy+'</h4></td><td onclick="location.href=\'wishlist_single.php?wishlist_id=\''+data.wid+'"><h4>0</h4></td><td onclick="location.href=\'wishlist_single.php?wishlist_id=\''+data.wid+'"><h4>'+data.date+'</h4></td><td><h4><select style="font-size: 16px;" onchange=\'actions(this,'+data.wid+')\'><option value="0" selected="" disabled="">Select</option><option value="1" style="color: #333;">Edit</option><option value="2" style="color: #333;">Delete</i></option><option value="https://one-store.ml/wishlist.php?sharelink='+data.link+'" style="color: #333;">Share</i></option></select></h4></td></tr>';
var tableBody=$('#show_wishlist');
tableBody.append(markup);


var link='https://one-store.ml/wishlist.php?sharelink='+data.link;
