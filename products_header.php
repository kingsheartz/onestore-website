...
<meta name="keywords" content="One Store,OneStore,onestore,shoppingcart,One,one,Store,store,shopping,cart,for all your needs" />
...
.loader{
    ...
    justify-content: center;
    align-items: center;
    background: url(images/logo/store.jpg);
}
.loader{
...
.side_nav_content_head:hover,.category_side_head:hover{
  color:white !important;
  background-color: #0c99cc !important;
  border-bottom:0px;
  border-bottom-right-radius: 0px;
 ...
 .side_nav_content_head,.category_side_head{
  color:white !important;
 }
...
.category_side_head a:active,.category_side_head a:focus{
  color:white !important;
  background-color: #000 !important;
  border-bottom:0px;
  border-bottom-right-radius: 0px;
...
<body id="strt" class="scroll_handle_blue hidescroll" style="overflow-x:hidden; width: 100%;padding: 0px;">
...
<div id="side_nav_bar_lock" style="padding: 0px;margin: 0px;">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()" style="float: left;"><img src="images/close.png" alt="close" ></a>
</div>
<!--SIDE-BAR-DIV-->   
...
<div class="std_text" style="color:white;font-size:17px;width:100%"><center>Cancelling...</center></div>
<div class="std_text1" style="color:white;font-size:17px">Wait a sec...</div>
<div class="std_text2" style="color:white;font-size:17px;width:100%"><center>Please wait...</center></div>
<!--RESPONSE AWAITING-->

<!--ANIMATION-->
<div class="loader">
  <img src="images/logo/store.jpg" class="si" />
</div>
<div class="loader1">
  <img src="images/load/3.svg" height="70" class="ri">
</div>
<div class="loader2">
...
<div class="headimg" style="padding: 0px;margin: 0px;left: 0px;right: 0px;"><!--#1-->
  <div class="container top" style="width:100%;padding-top: 12px;margin: 0px;left: 0px;right: 0px;padding-bottom: 5px;">
    <div style="height: 100% ;width: 100%;display: block;margin: 0px;left: 0px;right: 0px">
      
      <div ><center>
        <div class="w3ls_logo_products_left1" style="width: 100% ;align-items:center;justify-content: center;left: 0px;right: 0px">   
          <ul class="phone_email topli" style="padding: 0px;margin: 0px;left: 0px;right: 0px">
            <li class=" topli " style="float: left;" style="padding: 0px;margin: 0px;left: 0px;right: 0px">
              <div class="logo_img" style="padding: 0px;margin: 0px;left: 0px;right: 0px">
                            ...
                            <a href="onestore.php" ><img src="images/logo/logo.svg" height="50px" style="padding: 0px;margin: 0px;left: 0px;right: 0px">
                            </a>

              </div>
            </li>
            <li style="color: white;float: right;" class="topli" id="lg_top_ph_mail"><a href="tel:+918113990368" style="color:white;font-family:arial"><i class="fa fa-phone" aria-hidden="true"></i>Ph : <span><i>+91 8113990368</i></span></a><br><i><span>onestoreforallyourneeds</span></i>
						</li>
            <li style="color: white;float: right;" class="topli" id="sm_top_ph_mail"><i class="fa fa-phone" aria-hidden="true"></i><br><i><span><i class="fa fa-envelope"></i></span></i>
            </li>
          </ul>       
        </div></center>
...
<div class="col-lg-2 col-md-3 col-sm-3 icon-set" style="padding-right:0;">
          ...
          <li style="float: left;margin-top: 5px;" class="cartdiv">
              <form action="#" method="post" class="last" >
                <div id="cart" class="btn-group btn-shopping-cart">
                  <a href="cart.php" >
                    <div class="shopcart">
                    <div id="lg-cartcnt" style="position: relative;margin-bottom: -10px;background-color: red;border-radius: 50px;width: 20px;height:20px;margin-left: 20px" class="crt-count">
                   	<?php
                    ...
                    <button class="w3view-cart carticon" type="button" onclick="cartview()" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>
                    </button><span style="bottom: 0px;display: flex;justify-content:center;font-weight: normal;" id="location">Cart</span>
                    </div>
                  </a>
                  <!--<ul class="tab-content content dropdown-menu pull-left shoppingcart-box" role="menu">
                    <li>
                      <div>
                        <table class="table table-bordered cart-tb" style="border: none;">
                          <tbody>
                            <tr>
                              <td class="text-left"><strong>Sub-Total (Ex. Tax)</strong>
                              </td>
                        ...
                        <p class="text-right"> <a class="btn view-cart" href="view-cart.php"><i class="fa fa-shopping-cart"></i>View Cart</a></p>
                      </div>
                    </li>
                  </ul>-->
                </div>
            ...
            <li style="float: left;" class="wishdiv">
              <form action="#" method="post" class="last"> 
                <button class="w3view-cart wishicon" type="button" name="submit" value="" onclick="location.href='wishlist.php';">
                  <i class="fa fa-heart" aria-hidden="true"></i>
                </button><span style="bottom: 0px;display: flex;justify-content:center;" id="location">Wishlist</span>
              </form>
            </li>         
        </ul>
      </div>
        ...
        <div class=" bar-srch" style="margin-left: 0px;width: 100%;">
          <div class="input-group bar-srch"style="padding: 0px;margin: 0px;left: 0px;right: 0px" >
                <div class="input-group-btn search-panel"  style=" position: relative;">
                    ...
                    <ul id="category" class="dropdown-menu" name="cat2" role="menu" style="position: absolute;display: none;background-color: #CACACA !important">
...
?>
  <li value="<?=$row['category_id']?>" style="border-color: white;"><a style='font-family:sans-serif ' href="#<?=$row['category_id']?>"><?=$row['category_name']?></a>
  </li>
...
?>
                ...
                <span class="input-group-btn">
                    <button onclick="check()" onmouseover="$(this).css('background-color','#0c99cc')" onmouseleave="$(this).css('background-color','#fe9126')" style="color: white;background-color:#fe9126 " class="btn btn-default search_btn" type="button"><span class="fa fa-search"></span></button>
                </span>
            </div>
        </div>
  </div>
          ...
          <ul style="margin-top: -13px;">
            <li>
              <form action="registered.php" method="post" class="last" onclick="openNav()"> 
                ...
                </button><span style="bottom: 0px;display: flex;justify-content:center;" id="location"><?=$_SESSION['name']?></span>
...
?>  
        ...
        <div style="float: right;" id="menu_items_reglog" class="menu_items_reglog">
          <ul >
            ...
            <a href="#myModal" data-toggle="modal" data-dismiss="modal" style="color: white">
        ...
        <div class=" bar-srch" style="margin-left: 0px;width: 100%;">
          <div class="input-group bar-srch"style="padding: 0px;margin: 0px;left: 0px;right: 0px" >
                <div id="v-small-div" class="input-group-btn search-panel"  style=" position: relative;">
                    <button type="button" id="search-panel2" class="btn btn-default dropdown-toggle" onclick="catlistview2()"  style="position: relative;">
                      <span id="search_concept2">All</span> <span class="caret" id="srch_pan2"></span>
                    </button>

                    <ul id="category2" class="dropdown-menu" name="cat2" role="menu" style="position: absolute;z-index: 1;display: none;background-color: #CACACA !important; margin-bottom:10px;">
                      <li><a href="#all">All</a></li>
...
<?php
  ...
  while ($row=$sql->fetch(PDO::FETCH_ASSOC)) {
?>
  <li value="<?=$row['category_id']?>"><a style='font-family:sans-serif;border:1px white;' href="#<?=$row['category_name']?>"><?=$row['category_name']?></a></li>
...
?>
                ...
                <input type="text" class="form-control" id="search2" autocomplete="off"  onkeyup ="searchele2()" name="Search" placeholder="Search" style="margin-top: 0px;">
                <span class="input-group-btn">
                    <button onclick="check2()" onmouseover="$(this).css('background-color','#0c99cc')" onmouseleave="$(this).css('background-color','#fe9126')" style="color: white;background-color:#fe9126 " class="btn btn-default search_btn" type="button"><span class="fa fa-search"></span></button>
                </span>
            </div>
        </div>
  </div>
          ...
          <ul class="phone_email topli"><!--SIDE OPEN NAV BAR
            ...
            <li style="float: left;margin-top: 5px;" class="cartdiv">
              <form action="#" method="post" class="last" >
                <div id="cart" class="btn-group btn-shopping-cart">
                  <a href="cart.php">
                    <div class="shopcart">
                      <div id="sm-cartcnt" style="position: relative;margin-bottom: -10px;background-color: red;border-radius: 50px;width: 20px;height:20px;margin-left: 20px" class="crt-count">
                      <?php
                      if(isset($_SESSION['cart_count'])){
                        echo $_SESSION['cart_count'];
                      }
                      ...
                      ?>
                        ...
                        <input type="hidden" name="cmd" value="_cart">
                        <input type="hidden" name="display" value="1">
                        <button class="w3view-cart carticon" onclick="cartview()" type="button" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>
                        </button>
                        <span style="bottom: 0px;display: flex;justify-content:center;font-weight: normal;" id="location">Cart</span>
                    </div>
                  </a>
                  <!--<ul class="tab-content content dropdown-menu pull-right shoppingcart-box" role="menu" style="left: 0px">
                    <li>
                      <div>
                        <table class="table table-bordered cart-tb">
                          <tbody>
                            <tr>
                              <td class="text-left"><strong>Sub-Total (Ex. Tax)</strong>
                              </td>
                        ...
                        <p class="text-right"> <a class="btn view-cart" href="cart.php"><i class="fa fa-shopping-cart"></i>View Cart</a></p>
                      </div>
                    </li>
                  </ul>-->
                </div>
            ...
            <li style="float: left;" class="catdiv" id="sm_category">
              <form action="#" method="post" class="last"> 
                ...
                </button><span style="bottom: 0px;display: flex;justify-content:center;" id="location">Category</span>
              </form>
            </li>
...
?>        
        <div style="float: right;margin-top: 40px;" id="menu_items_reglog">
            ...
            <li><a href="registered.php"> Create Account </a></li>
            <li style="margin-left: -20px;"><a href="#myModal" data-toggle="modal" data-dismiss="modal">Login</a></li>
          ...
          <a href="registered.php" id="sm_sign_up">
            <li class="userdiv" style="float: right;">
              <form action="registered.php" method="post" class="last"> 
                <button class="w3view-cart usericon " type="button" name="submit" value="">
                  <i class="fa fa-user" aria-hidden="true"></i>
                </button><span style="bottom: 0px;display: flex;justify-content:center;font-weight: normal;" id="location">Sign up</span>
              </form>
            </li>
          </a>
          <a href="#myModal" data-toggle="modal" data-dismiss="modal">
            <li class="logindiv" style="float: right;">
              <form action="login.php" method="post" class="last"> 
                ...
                </button><span style="bottom: 0px;display: flex;justify-content:center;font-weight: normal;" id="location">Log in</span>
            ...
            <a href="#">            
              <li class="logindiv" style="float: right;">
                ...
                <?php if(isset($_SESSION['name'])){ ?>
                    ...
                    <span style="bottom: 0px;display: flex;justify-content:center;" id="location"> <?=$_SESSION['name']?>
                    </span>
                <?php } else{?>
                    <button class="w3view-cart loginicon" type="button" name="submit" value="" onclick="location.href='login.php'">
                      <i class="fa fa-sign-in" aria-hidden="true"></i>
                    </button>
                    <span style="bottom: 0px;display: flex;justify-content:center;" id="location">Log in</span><?php } ?>
                </form>
              </li>
            </a>
          </div>  
          <div id=xxsmall>  
            ...
            <li class="logindiv" style="float: right;">
              <form action="#" method="post" class="last"> 
                ...
                <span style="bottom: 0px;display: flex;justify-content:center;" id="location"><?php echo "You";?>
                </span>
                <?php }else{?>
                <button class="w3view-cart loginicon " type="button" name="submit" value="" onclick="location.href='login.php'">
                  <i class="fa fa-sign-in" aria-hidden="true"></i>
            ...
            <div class="row" style="padding:0px !important">
                <div class="col-lg-12" style="padding: 0px">
                    ...
                    <div class="navbar-header">
                        <button class="navbar-toggle" data-target="#mobile_menu" data-toggle="collapse" onclick="myFun(this)"><span class="icon-bar icon-bar1" ></span><span class="icon-bar icon-bar2"></span><span class="icon-bar icon-bar3"></span></button>
                    </div>
                    ...
                    <div class="navbar-collapse collapse" id="mobile_menu" style="margin-top: 0px">
                        <ul class="nav navbar-nav navbar-center">
                          <li id="lg_side_active">
                            ...
                            <li id="homeactive" class="active"><a href="onestore.php"><i class="fa fa-home fa-lg"></i> Home</a></li>
<?php
...
?>	
                            ...
                            <!--
                            <li id="catactive"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-lg fa-cubes"></i> Categories <span class="caret"></span></a>
                                <ul class="dropdown-menu" style="border:1px solid #337ab7;padding: 0px">
                                    <a href="products.php?category_id=1">
                    <li  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                                        <span class="fa fa-arrow-right"></span>
                                        <span style="font-family: arial;font-weight: 700; "> Personal care</span>
                                      </li>
                                     </a>
                    ...
                    <li onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                                        <span class="fa fa-arrow-right"></span>
                                        <span style="font-family: arial;font-weight: 700; "> Food & Groceries</span>
                                      </li>
                                     </a>
                                </ul>
                            </li>-->
                            <li id="aboutactive"><a href="about.php"><i class="fa fa-lg fa-info-circle"></i> About</a></li>
                            <li id="contactactive"><a href="contact.php"><i class="fa fa-lg fa-users"></i> Contact Us</a></li>
                        </ul>
<!--                        
...
-->
                        <ul class="nav navbar-nav navbar-right navbar-center">
                            <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" ><span class="glyphicon glyphicon-user"></span> Profile <span class="caret"></span></a>
                                <ul class="dropdown-menu"  style="border:1px solid #337ab7;padding: 0px">
<?php
                              ...
                              <li  id="">
                                <!--pop up location-->
																<div style="width: 100%">
																	...
																	<label for="Personal care">Personal care</label></p></p>
																	<hr>
																	...
																	<label for="Electronics">Electronics</label></p>
																	<hr>
...
<!--SIDE NAV BAR-->
<div id="mySidenav" class="sidenav scroll_handle_orange" style="z-index: 99999999;padding-top: 0px;overflow-y: scroll;">
  <a style="text-decoration:none;background-color: white;color: black">
    <i class="fas fa-user-circle fa-2x"><span style="font-family: arial;font-weight: bold;font-size: 22px"> Hello,
      <?php if(isset($_SESSION['name'])){?>
...
<!--////////////////////////////////////////////////#1#/////////////////////////////////////////////////////////////////-->
    <a class="side_nav_content_header" href="#"  style="color: #fe9126"> <i class="fa fa-sm fa-shopping-cart" style="color:white "></i> Shop By Category</a>
    <button class="dropdown-btn  category_side_head" id="list_enda" style="width: 100%;float: left;padding-left: 0px;"><a href="#" style="color: white;"> Personal care
        <i class="fa fa-caret-down"></i></a>
    </button>
    <div class="dropdown-container  side_drop_li_main slide_drop_li_main_first">
        <a href="products_limited.php?category_id=1&subcategory_id=1" style="width: 100%;padding: 0px">
        ...
        <a href="products_limited.php?category_id=1&subcategory_id=2" style="width: 100%;padding: 0px">
        ...
        <a href="products_limited.php?category_id=1&subcategory_id=3" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=1&subcategory_id=4" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=1&subcategory_id=5" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=1&subcategory_id=6" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#2#/////////////////////////////////////////////////////////////////-->
    ...
    <button class="dropdown-btn category_side_head"  id="list_endb" style="width: 100%;float: left;padding-left: 0px;"><a href="#" style="color: white;"> Food & Groceries
        <i class="fa fa-caret-down"></i></a>
    </button>
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products_limited.php?category_id=2&subcategory_id=7" style="width: 100%;padding: 0px;padding-top: 37px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px; ">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=2&subcategory_id=8" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=2&subcategory_id=9" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=2&subcategory_id=10" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=2&subcategory_id=11" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=2&subcategory_id=12" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
                <span style="font-family: arial;font-weight: 700; "> Dried Fruits,Nuts and Seeds</span>
            </li>
        </a>
        <a href="products_limited.php?category_id=2&subcategory_id=13" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
                <span style="font-family: arial;font-weight: 700; "> Rice,Flour and Pulses</span>
            </li>
        </a>
        <a href="products_limited.php?category_id=2&subcategory_id=14" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
                <span style="font-family: arial;font-weight: 700; "> Snack Foods</span>
            </li>
        </a>
        <a href="products_limited.php?category_id=2&subcategory_id=15" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#3#/////////////////////////////////////////////////////////////////-->   
    ...
    <button class="dropdown-btn category_side_head" id="list_endc" style="width: 100%;float: left;padding-left: 0px;"><a href="#" style="color: white;"> Mobile
        <i class="fa fa-caret-down"></i></a>
    </button>
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products_limited.php?category_id=3&subcategory_id=16" style="width: 100%;padding: 0px;padding-top: 74px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=3&subcategory_id=17" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#4#/////////////////////////////////////////////////////////////////-->
    ...
    <button class="dropdown-btn category_side_head" id="list_endd" style="width: 100%;float: left;padding-left: 0px;"><a href="#" style="color: white;"> Fasion
        <i class="fa fa-caret-down"></i></a>
    </button>
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products_limited.php?category_id=4&subcategory_id=18" style="width: 100%;padding: 0px;padding-top: 111px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=4&subcategory_id=19" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=4&subcategory_id=20" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=4&subcategory_id=21" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=4&subcategory_id=22" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=4&subcategory_id=23" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#5#/////////////////////////////////////////////////////////////////-->
    ...
    <button class="dropdown-btn category_side_head" id="list_ende" style="width: 100%;float: left;padding-left: 0px;"><a href="#" style="color: white;"> Home
        <i class="fa fa-caret-down"></i></a>
    </button>
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products_limited.php?category_id=5&subcategory_id=24" style="width: 100%;padding: 0px;padding-top: 148px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=5&subcategory_id=25" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=5&subcategory_id=26" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#6#/////////////////////////////////////////////////////////////////-->
    ...
    <button class="dropdown-btn category_side_head" id="list_endf" style="width: 100%;float: left;padding-left: 0px;"><a href="#" style="color: white;"> Electronics
        <i class="fa fa-caret-down"></i></a>
    </button>
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products_limited.php?category_id=6&subcategory_id=27" style="width: 100%;padding: 0px;padding-top: 185px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=6&subcategory_id=28" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=6&subcategory_id=29" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=6&subcategory_id=30" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=6&subcategory_id=31" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#7#/////////////////////////////////////////////////////////////////-->
    ...
    <button class="dropdown-btn category_side_head" id="list_endg" style="width: 100%;float: left;padding-left: 0px;"><a href="#" style="color: white;"> Toys and Baby
        <i class="fa fa-caret-down"></i></a>
    </button>
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products_limited.php?category_id=7&subcategory_id=32" style="width: 100%;padding: 0px;padding-top: 222px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=7&subcategory_id=33" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=7&subcategory_id=34" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=7&subcategory_id=35" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=7&subcategory_id=36" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=7&subcategory_id=37" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=7&subcategory_id=38" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#8#/////////////////////////////////////////////////////////////////-->
    ...
    <button class="dropdown-btn category_side_head" id="list_endh" style="width: 100%;float: left;padding-left: 0px;"><a href="#" style="color: white;"> Sports
        <i class="fa fa-caret-down"></i></a>
    </button>
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products_limited.php?category_id=8&subcategory_id=39" style="width: 100%;padding: 0px;padding-top: 259px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=8&subcategory_id=40" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=8&subcategory_id=41" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=8&subcategory_id=42" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=8&subcategory_id=43" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=8&subcategory_id=44" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=8&subcategory_id=45" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=8&subcategory_id=46" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=8&subcategory_id=47" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=8&subcategory_id=48" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#9#/////////////////////////////////////////////////////////////////-->
    ...
    <button class="dropdown-btn category_side_head" id="list_endi" style="width: 100%;float: left;padding-left: 0px;"><a href="#" style="color: white;"> Beauty
        <i class="fa fa-caret-down"></i></a>
    </button>
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products_limited.php?category_id=9&subcategory_id=49" style="width: 100%;padding: 0px;padding-top: 296px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=9&subcategory_id=50" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products_limited.php?category_id=9&subcategory_id=51" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
                <span style="font-family: arial;font-weight: 700; "> Hair Care and Styling</span>
            </li>
        </a>
       
        <a href="products_limited.php?category_id=9&subcategory_id=52" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
                <span style="font-family: arial;font-weight: 700; "> Make Up and Nails</span>
            </li>
        </a>

        <a href="products_limited.php?category_id=9&subcategory_id=53" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#10#/////////////////////////////////////////////////////////////////-->
    ...
    <button class="dropdown-btn category_side_head" id="list_endj" style="width: 100%;float: left;padding-left: 0px;"><a href="#" style="color: white;"> Appliances
        <i class="fa fa-caret-down"></i></a>
    </button>
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
...
-->
    ...
    <a class="side_nav_content_header" href="#" style="color: #fe9126"> <i class="fa fa-sm fa-cog" style="color:white "></i> Help & Settings</a>
<?php
if(isset($_SESSION['id'])){                                	
?>	  
  	<a class="side_nav_content_head" href="edit_user_details.php">My Account</a>
	<a class="side_nav_content_head" href="myorders.php">My orders</a>
<?php
}
?>	  
  	<a class="side_nav_content_head" href="about.php">About</a>
  	<a class="side_nav_content_head" href="contact.php">Contact</a>
<?php
if(!isset($_SESSION['id'])){                                	
?>	  	
  	<a class="side_nav_content_head" onclick="closeNav()" href="#myModal" data-toggle="modal" data-dismiss="modal">Sign In</a>
<?php
}else{
?>     	
	<a class="side_nav_content_head" href="logout.php">Log out</a>
<?php
}
?>  	
