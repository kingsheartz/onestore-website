...
<div class="order">
<div class="orhead">
<h2 class="sidebar-title" style="border-left: 5px solid #fff;border-top-left-radius: 10px;text-align: left;padding-bottom: 29px;padding-top: 20px;margin-top: 0px;font-weight:normal;border-bottom:#333;margin-bottom: 0px;border-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px;color:white ">Ordered Product <i style="color: #fffd00" class="fa fa-product-hunt "></i>
<span style="float: right;margin-right: 5px;margin-top: -16px;">
  <button type="button" style="max-width: 180px;min-width:90px;height: 62px;font-weight: bold;border-top-right-radius: 10px;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;;"  id="proceed" name="proceed" class="checkout-button button alt wc-forward back-lg" onclick="location.href='myorders.php'"><i class='fas fa-arrow-circle-left'></i> Back</button>
  <button type="button" style="display:none;max-width: 180px;width:50px;height: 62px;font-weight: bold;border-top-right-radius: 10px;color:#c7c7c7;background-color:#0080ff"  id="proceed" name="proceed" class="checkout-button button alt wc-forward back-sm" onclick="location.href='myorders.php'"><i class='fas fa-arrow-circle-left' style="background-color:#000;padding:6px;border-radius:50%"></i></button>
</span>
</h2>
...
<div onclick="cancel();" onmouseover="$(this).css('cursor','pointer')" style="float:right;border:1px solid rgb(165, 164, 164);color:red;padding-left:10px;padding-right:10px;margin-top:10px;clear:both;border-radius: 3px;" ><i class="fa fa-close"></i><span style="color: #000;"><b> Cancel this order</b></span></div><br>
</div>
<?php
  }
?>
...
<div class="col-sm-4" onclick="location.href='single.php?id=<?=$row['item_description_id']?>'">
  <table>  
    ...
    <div style="width: 100%;text-align: center;color: #333;font-weight:bold;font-size:15px;"><?=$itm_nm?></div></td>
    </tr>
  </table> 
</div>
<div class="col-sm-8">
