        ...
        <div class="container" style="padding: 0px;">
                ...
                <ul style="list-style: none;">
                    ...
                    <a class="left-log">
                        <li class="ad my-account my-account-active" onclick="$('.my-account').removeClass('my-account-active');$('.ad').addClass('my-account-active');$('.account-details').removeClass('account-details-active');$('.pi').addClass(' account-details-active');$('.account-head').removeClass('account-head-active');$('.acc_details').addClass(' account-head-active');">
                            <i  class="fa fa-arrow-right"></i> Account Details</li>
                    </a>
                    ...
                    <a class="left-log">
                        <li class="cep my-account" onclick="$('.my-account').removeClass('my-account-active');$('.cep').addClass('my-account-active');$('.account-details').removeClass('account-details-active');$('.li').addClass(' account-details-active');$('.account-head').removeClass('account-head-active');$('.changeep').addClass(' account-head-active');">
                            <i  class="fa fa-arrow-right"></i> Change Email/Password</li>
                    </a>
                    <hr class="account-li-bottom">
                    ...
                    <a class="left-log">
                        <li class="da my-account" onclick="$('.my-account').removeClass('my-account-active');$('.da').addClass('my-account-active');$('.account-details').removeClass('account-details-active');$('.ada').addClass(' account-details-active');$('.account-head').removeClass('account-head-active');$('.del_add').addClass(' account-head-active');">
                            <i  class="fa fa-arrow-right"></i> Delivery Address</li>
                    </a>
                    <hr class="account-li-bottom">
            ...
            <div class="account-details pi account-details-active" >                
                ...
                <h5 style=""><i class="fa fa-info-circle fa-lg"></i>&nbsp;profile information 
                    ...
                    <p id="nameerror" style="color: red;font-weight: bolder;margin-top:-5px;float:left;padding-bottom:0px;margin-bottom: 0px;text-shadow: 2px 3px 4px grey"></p>
                    </div>
...
<!---------------------------------------------------------------------------------------------------------------------------------------------->
                    <div class="input-group bar-srch input-field" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top:15px;" >  
                        <input type="text" oninput="$(this).removeClass('invalid');" onkeyup="changed_details()" id="first_name" placeholder=""  value="<?=$userrow['first_name']?>"  required=" " style="margin-top: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;padding-right: 1px;" readonly class="validate" pattern="^\S[a-zA-Z]{2,30}$" title="Minimum character '3'.Use alphabets">
                        <label class="form-label" for="first_name">First Name</label>

                        <span id="dis_fn" class="input-group-btn">
                            <button onclick="dis_fn()" onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#0c77cc')" style="color: white;background-color:#0c77cc;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;outline: none;" class="btn btn-default search_btn" type="button"><span class="fa fa-edit"></span></button>
                        </span>

                        <span id="hide_fn" class="input-group-btn" style="display: none;">
                            <button onclick="reset_fn()"  onmouseover="$(this).css('background-color','#bb0000')" onmouseleave="$(this).css('background-color','red')" style="color: white;background-color:red;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;padding-left: 28px;" class="btn btn-default search_btn" type="button"><span class="fa fa-close" style="margin-left: -18px;"></span></button>
                        </span>

                        <span id="hide_fn1" style="display: none;" class="input-group-btn">
                            <button onclick="dis_fn()" onmouseover="$(this).css('background-color','#4f994f')" onmouseleave="$(this).css('background-color','#07C103')" style="color: white;background-color:#07C103;padding-top:10px;padding-bottom: 10px;outline: none;" class="btn btn-default search_btn" type="button"><span class="fa fa-check"></span></button>
                        </span>
                    </div>
  ...
  <!---------------------------------------------------------------------------------------------------------------------------------------------->       
                    <div class="input-group bar-srch input-field" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top:25px;" >  
                        <input pattern="^[a-zA-Z ]{1,20}$" title="Use alphabets" oninput="$(this).removeClass('invalid');" type="text" onkeyup="changed_details()" id="last_name" placeholder="" value="<?=$userrow['last_name']?>"  required=" " style="margin-top: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;" readonly class="validate">
                        <label class="form-label" for="last_name">Last Name</label>
                        <span id="dis_ln" class="input-group-btn">
                            <button onclick="dis_ln()" onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#0c77cc')" style="color: white;background-color:#0c77cc;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px" class="btn btn-default search_btn" type="button"><span class="fa fa-edit"></span></button>
                        </span>

                        <span id="hide_ln" class="input-group-btn" style="display: none;">
                            <button onclick="reset_ln()"  onmouseover="$(this).css('background-color','#bb0000')" onmouseleave="$(this).css('background-color','red')" style="color: white;background-color:red;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;padding-left: 28px;" class="btn btn-default search_btn" type="button"><span class="fa fa-close" style="margin-left: -18px;"></span></button>
                        </span>

                        <span id="hide_ln1" class="input-group-btn" style="display: none;">
                            <button onclick="dis_ln()" onmouseover="$(this).css('background-color','#4f994f')" onmouseleave="$(this).css('background-color','#07C103')" style="color: white;background-color:#07C103;padding-top:10px;padding-bottom: 10px;outline: none;" class="btn btn-default search_btn" type="button"><span class="fa fa-check"></span></button>
                        </span>
                    </div>
<!---------------------------------------------------------------------------------------------------------------------------------------------->
<!---------------------------------------------------------------------------------------------------------------------------------------------->
...
<!---------------------------------------------------------------------------------------------------------------------------------------------->
                    <div class="input-group bar-srch input-field"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top:25px;" >  
                        <input oninput="$(this).removeClass('invalid');" onkeyup="changed_details()" type="tel" id="phone" placeholder="" value="<?=$userrow['phone']?>" required=" " style="margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;" readonly onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" maxlength="10" pattern="^(\d{0}|\d{10})$" title="Phone Number Format (9876543210)- 10 digits">
                        <label class="form-label" for="phone">Phone</label>
                        <span id="dis_ph" class="input-group-btn">
                            <button onclick="dis_ph()" onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#0c77cc')" style="color:white;background-color:#0c77cc;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px" class="btn btn-default search_btn" type="button"><span class="fa fa-edit"></span></button>
                        </span>

                        <span id="hide_ph" class="input-group-btn" style="display: none;">
                            <button onclick="reset_ph()"  onmouseover="$(this).css('background-color','#bb0000')" onmouseleave="$(this).css('background-color','red')" style="color: white;background-color:red;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;padding-left: 28px;" class="btn btn-default search_btn" type="button"><span class="fa fa-close" style="margin-left: -18px;"></span></button>
                        </span>

                        <span id="hide_ph1" class="input-group-btn" style="display: none;">
                            <button onclick="dis_ph()" onmouseover="$(this).css('background-color','#4f994f')" onmouseleave="$(this).css('background-color','#07C103')" style="color: white;background-color:#07C103;padding-top:10px;padding-bottom: 10px;outline: none;" class="btn btn-default search_btn" type="button"><span class="fa fa-check"></span></button>
                        </span>
                    </div>
<!---------------------------------------------------------------------------------------------------------------------------------------------->
<!---------------------------------------------------------------------------------------------------------------------------------------------->
                    ...
                    <ul style="margin-bottom: -20px;">
                        <li style="list-style:none; ">
                            <div id="pin" class="input-group bar-srch input-field"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top: 25px;" > 
                                <input  pattern="^\d{6}$" title="PIN Number Format (654321)- 6 digits" maxlength="6" onkeyup="changed_details()" type="tel" class="locmark" id="regpin"  placeholder="" value="<?=$userrow['pincode']?>" name="pincode" required=" " style="width: 100%;margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;'" readonly onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57">
                                <label class="form-label" for="regpin">Pincode</label>
                                <span id="dis_pin" class="input-group-btn">
                                    <button onclick="dis_pin()" onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#0c77cc')" style="color: white;background-color:#0c77cc;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px" class="btn btn-default search_btn" type="button"><span class="fa fa-edit"></span></button>
                                </span>
                                
                                <span id="hide_pin1" class="input-group-btn" style="display: none;">
                                        <button onclick="user_update_locate()" onmouseover="$(this).css('background-color','#ee8126')" onmouseleave="$(this).css('background-color','#fe9126')" style="color: white;background-color:#fe9126;padding-top:10px;padding-bottom: 10px;outline: none;" class="btn btn-default search_btn" type="button"><span class="fa fa-search"></span></button>
                                </span>

                                <span id="hide_pin" class="input-group-btn" style="display: none;">
                                    <button onclick="reset_pin()"  onmouseover="$(this).css('background-color','#bb0000')" onmouseleave="$(this).css('background-color','red')" style="color: white;background-color:red;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;padding-left: 28px;" class="btn btn-default search_btn" type="button"><span class="fa fa-close" style="margin-left: -18px;"></span></button>
                                </span>
                            </div> 
<!---------------------------------------------------------------------------------------------------------------------------------------------->
<!---------------------------------------------------------------------------------------------------------------------------------------------->
                            ...
                            <div class="input-group bar-srch"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;" > 
                                <select name="po_list" onchange="changed_details()" class="locmark" id="po_list1"  placeholder="PIN" name="pincode" required=" " style="width: 100%;height: 40px;margin: 0px;z-index: 0;border-radius: 3px;border:1px solid #DBDBDB;border-top-right-radius: 0px;border-bottom-right-radius: 0px;">
                                    <option value="<?=$userrow['location']?>" selected="" disabled=""><?=$userrow['location']?></option>
                                </select>    
                                <span id="hide_locate" class="input-group-btn" >
                                        <button onclick="regsetlocation()" onmouseover="$(this).css('background-color','#4f994f')" onmouseleave="$(this).css('background-color','#07C103')" style="color: white;background-color:#07C103;padding-top:10px;padding-bottom: 10px;outline: none;" class="btn btn-default search_btn popuptext pin" type="button"><span class="fa fa-check"></span></button>
                                </span>
                            </div> 
                            </div>  
                        </li><br>                                     
...
<!--ADDRESS-->
                ...
                <div class="form-group input-field" style="text-align: right;width: 100%;position: relative;">
                    <textarea title="Minimal character count is 10" rows="4" oninput="$(this).removeClass('invalid');" onkeyup="changed_details()" id="address" placeholder="" readonly><?=$userrow['address']?></textarea>
                    ...
                    <span onclick="dis_add()" id="hide_add1" class="fa fa-check" style="display:none;position: absolute;right: 0;top: 23px;color: white;background-color:#07C103;padding: 3px;" onmouseover="$(this).css('background-color','#4f994f')" onmouseleave="$(this).css('background-color','#07C103')"></span>  
                </div>    
...
<!--EMAIL-->  
                ...
                <h6 style="margin-top: 0px !important;"><i class="fa fa-info-circle fa-lg"></i>&nbsp;Login information 
                ...
                <div id="error_dis2" style="display: none;margin-bottom: 50px;">
                    <p id="nameerror2" style="color: red;font-weight: bolder;margin-top:-5px;float:left;padding-bottom:0px;margin-bottom: 0px;text-shadow: 2px 3px 4px grey"></p>
                </div>
                    ...
                    <div class="input-group bar-srch input-field"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 25px;margin-top: 45px;" >  
                        <input oninput="$(this).removeClass('invalid');" onkeyup="changed_details()"  type="email" name="email" id="email" value="<?=$userrow['email']?>"  placeholder="" required=" " style="margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;" readonly>
                        <label class="form-label" for="email">Email Address</label>

                        <span id="dis_mail" class="input-group-btn">
                            <button onclick="dis_mail()" onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#0c77cc')" style="color: white;background-color:#0c77cc;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px" class="btn btn-default search_btn" type="button"><span class="fa fa-edit"></span></button>
                        </span>
                        <span id="hide_mail" class="input-group-btn" style="display: none;">
                            <button onclick="reset_mail()"  onmouseover="$(this).css('background-color','#bb0000')" onmouseleave="$(this).css('background-color','red')" style="color: white;background-color:red;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;padding-left: 28px;" class="btn btn-default search_btn" type="button"><span class="fa fa-close" style="margin-left: -18px;"></span></button>
                        </span>
                        <span id="hide_mail1" class="input-group-btn" style="display: none;">
                            <button onclick="dis_mail()" onmouseover="$(this).css('background-color','#4f994f')" onmouseleave="$(this).css('background-color','#07C103')" style="color: white;background-color:#07C103;padding-top:10px;padding-bottom: 10px;outline: none;" class="btn btn-default search_btn" type="button"><span class="fa fa-check"></span></button>
                        </span>
                    </div>
...
<!--PASSWORD--> 
                    ...
                    <div class="input-group bar-srch input-field"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;" >  
                        <input pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must be same as you had already entered" oninput="$(this).removeClass('invalid');" type="password" id="pass3" onkeyup ="changed_details()" value="abcdefghijklmnopqrstuvwxyz" placeholder="" required=" " style="margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;" readonly>
                        <label class="form-label" for="pass3">Current password</label>
                        <span id="dis_pass3" class="input-group-btn click-pass-opt">
                            <button onclick="dis_pass3()" onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#0c77cc')" style="color: white;background-color:#0c77cc;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px" class="btn btn-default search_btn" type="button"><span class="fa fa-edit"></span></button>
                        </span>
                        <span id="hide_pass3_1" class="input-group-btn click-pass-opt" style="display: none;">
                            <button onclick="reset_pass3()"  onmouseover="$(this).css('background-color','#bb0000')" onmouseleave="$(this).css('background-color','red')" style="color: white;background-color:red;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;padding-left: 28px;" class="btn btn-default search_btn" type="button"><span class="fa fa-close" style="margin-left: -18px;"></span></button>
                        </span>
                        <span id="hide_pass3_2" class="input-group-btn click-pass-opt" style="display: none;">
                            <button onclick="dis_pass3()" onmouseover="$(this).css('background-color','#4f994f')" onmouseleave="$(this).css('background-color','#07C103')" style="color: white;background-color:#07C103;padding-top:10px;padding-bottom: 10px;outline: none;" class="btn btn-default search_btn" type="button"><span class="fa fa-check"></span></button>
                        </span>
                    </div>
                    ...
                    <hr class="make_divc">
                        <div class="input-group bar-srch input-field"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 10px;" >  
                            <input pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" oninput="$(this).removeClass('invalid');" onkeyup ="changed_details()"  type="password" id="passfir" value="" placeholder="New password" required=" " style="margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;" readonly>
                            <label class="form-label" for="passfir"></label>
                            <span id="dis_pass1" class="input-group-btn">
                                <button onclick="view()" onmouseover="$(this).css('background-color','#c0c0c0')" onmouseleave="$(this).css('background-color','#f1f2f3')" style="color: #000;background-color:#f1f2f3;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px" class="btn btn-default search_btn" type="button"><span class="fas fa-eye"></span></button>
                            </span>
                            <span id="hide_pass1" class="input-group-btn" style="display: none;">
                                <button onclick="view()" onmouseover="$(this).css('background-color','#c0c0c0')" onmouseleave="$(this).css('background-color','#f1f2f3')" style="color: #000;background-color:#f1f2f3;padding-top:10px;padding-bottom: 10px;outline: none;" class="btn btn-default search_btn" type="button"><span class="fas fa-eye-slash"></span></button>
                            </span>
                        </div>

                        <input pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Entered input must  matches the current password" oninput="$(this).removeClass('invalid');" type="password" onkeyup ="changed_details()" id="passre" placeholder="Re-enter password" required=" " style="margin-bottom: 0px;">
...
<!--EMAIL-->  
    ...
    <h6 style="margin-top: 0px !important;"><i class="fa fa-info-circle fa-lg"></i>&nbsp;Delivery Address
        <span id='succeeded2' style="float: right;background-color: green;border-radius: 5px;color:white">&nbsp;
            <i class="fa fa-check" style="color: orange;text-shadow: 1px 2px 3px grey"></i>
            <i style="text-transform: capitalize;font-size: 12px;text-shadow: 1px 2px 3px grey"> verified &nbsp;</i>
        </span>
    ...
    <div class="shipping_address"  id="stda_div" >
        ...
        <p id="shipping_first_name_field" class="form-row form-row-first validate-required">                                   
            <div class="input-group bar-srch" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;" >
                <label class="" for="shipping_first_name" style="font-weight: normal;text-transform: capitalize;color:#9e9e9e;font-size:12px;">First Name <abbr title="required" class="required" style="color: #c50505">*</abbr>
                </label>
                <input oninput="$(this).removeClass('invalid');" type="text" onkeyup="changed_details()" oninput="$(this).removeClass('invalid')" value="<?=$suserrow['first_name']?>" placeholder="First name" id="shipping_first_name" name="shipping_first_name" class="input-text validate" pattern="^\S[a-zA-Z]{3,30}$" title="Minimum character '3'.Use alphabets" required="" style="border-top-right-radius: 0px;border-bottom-right-radius: 0px;margin-top: 0px;margin-bottom: 0px;" readonly>
                                                    
                <span id="dis_sfn" class="input-group-btn">
                    <button onclick="dis_sfn()" onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#0c77cc')" style="color: white;background-color:#0c77cc;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;outline: none;margin-top: 25px;" class="btn btn-default search_btn" type="button"><span class="fa fa-edit"></span></button>
                </span>

                <span id="hide_sfn" class="input-group-btn" style="display: none;">
                    <button onclick="reset_sfn()"  onmouseover="$(this).css('background-color','#bb0000')" onmouseleave="$(this).css('background-color','red')" style="color: white;background-color:red;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;padding-left: 28px;margin-top: 25px;" class="btn btn-default search_btn" type="button"><span class="fa fa-close" style="margin-left: -18px;"></span></button>
                </span>

                <span id="hide_sfn1" style="display: none;" class="input-group-btn">
                    <button onclick="dis_sfn()" onmouseover="$(this).css('background-color','#4f994f')" onmouseleave="$(this).css('background-color','#07C103')" style="color: white;background-color:#07C103;padding-top:10px;padding-bottom: 10px;outline: none;margin-top: 25px;" class="btn btn-default search_btn" type="button"><span class="fa fa-check"></span></button>
                </span>
            </div>
        </p>
        ...
        <p id="shipping_last_name_field" class="form-row form-row-last validate-required">
            <div class="input-group bar-srch" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;" >
                <label class="" for="shipping_last_name" style="font-weight: normal;text-transform: capitalize;color:#9e9e9e;font-size:12px;">Last Name <abbr title="required" class="required" style="color: #c50505">*</abbr>
                </label>
                <input oninput="$(this).removeClass('invalid');" type="text" onkeyup="changed_details()" oninput="$(this).removeClass('invalid')" value="<?=$suserrow['last_name']?>" placeholder="Last name" id="shipping_last_name" name="shipping_last_name" class="input-text validate" pattern="^[a-zA-Z ]{1,20}$" title="Use alphabets" required="" style="border-top-right-radius: 0px;border-bottom-right-radius: 0px;margin-top: 0px;margin-bottom:0;" readonly>

                <span id="dis_sln" class="input-group-btn">
                    <button onclick="dis_sln()" onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#0c77cc')" style="color: white;background-color:#0c77cc;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;outline: none;margin-top: 25px;" class="btn btn-default search_btn" type="button"><span class="fa fa-edit"></span></button>
                </span>

                <span id="hide_sln" class="input-group-btn" style="display: none;">
                    <button onclick="reset_sln()"  onmouseover="$(this).css('background-color','#bb0000')" onmouseleave="$(this).css('background-color','red')" style="color: white;background-color:red;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;padding-left: 28px;margin-top: 25px;" class="btn btn-default search_btn" type="button"><span class="fa fa-close" style="margin-left: -18px;"></span></button>
                </span>
        ...
        <p id="shipping_phone_number_field" class="form-row form-row-last validate-required">
            <div class="input-group bar-srch" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;" >
                <label class="" for="shipping_phone_number" style="font-weight: normal;text-transform: capitalize;color:#9e9e9e;font-size:12px;">Phone Number<abbr title="required" class="required" style="color: #c50505">*</abbr>
                </label>
                <input oninput="$(this).removeClass('invalid');" type="text" onkeyup="changed_details()" oninput="$(this).removeClass('invalid')" value="<?=$suserrow['phone']?>" placeholder="Phone number" id="shipping_ph_no" maxlength="10" name="shipping_ph_no" class="input-text validate" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57;" pattern="^\d{10}$" title="Phone Number Format (9876543210)- 10 digits" required="" style="border-top-right-radius: 0px;border-bottom-right-radius: 0px;margin-top: 0px;margin-bottom:0;" readonly>

                <span id="dis_sph" class="input-group-btn">
                    <button onclick="dis_sph()" onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#0c77cc')" style="color: white;background-color:#0c77cc;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;outline: none;margin-top: 25px;" class="btn btn-default search_btn" type="button"><span class="fa fa-edit"></span></button>
                </span>

                <span id="hide_sph" class="input-group-btn" style="display: none;">
                    <button onclick="reset_sph()"  onmouseover="$(this).css('background-color','#bb0000')" onmouseleave="$(this).css('background-color','red')" style="color: white;background-color:red;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;padding-left: 28px;margin-top: 25px;" class="btn btn-default search_btn" type="button"><span class="fa fa-close" style="margin-left: -18px;"></span></button>
                </span>
        ...
        <p id="shipping_phone_number2_field" class="form-row form-row-last validate-required">
            <div class="input-group bar-srch" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;" >
                <label class="" for="shipping_ph_no2" style="font-weight: normal;text-transform: capitalize;color:#9e9e9e;font-size:12px;">Alternate phone number<small title="required" class="required" style="color: #c50505"> (Optional)</small>
                </label>
                <input oninput="$(this).removeClass('invalid');" type="text" onkeyup="changed_details()" oninput="$(this).removeClass('invalid')" value="<?=$suserrow['alternative_phone']?>" placeholder="Alternate Phone Number" id="shipping_ph_no2" maxlength="10" name="shipping_ph_no2" class="input-text validate" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57;" pattern="^(\d{0}|\d{10})$" title="Phone Number Format (9876543210)- 10 digits" style="border-top-right-radius: 0px;border-bottom-right-radius: 0px;margin-top: 0px;margin-bottom:0;" readonly>

                <span id="dis_s2ph" class="input-group-btn">
                    <button onclick="dis_s2ph()" onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#0c77cc')" style="color: white;background-color:#0c77cc;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;outline: none;margin-top: 25px;" class="btn btn-default search_btn" type="button"><span class="fa fa-edit"></span></button>
                </span>

                <span id="hide_s2ph" class="input-group-btn" style="display: none;">
                    <button onclick="reset_s2ph()"  onmouseover="$(this).css('background-color','#bb0000')" onmouseleave="$(this).css('background-color','red')" style="color: white;background-color:red;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;padding-left: 28px;margin-top: 25px;" class="btn btn-default search_btn" type="button"><span class="fa fa-close" style="margin-left: -18px;"></span></button>
                </span>
        ...
        <p id="shipping_address_1_field" class="form-row form-row-wide address-field validate-required">
            <div class="input-group bar-srch" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;display: block;" >
                <label class="" for="shipping_address_1" style="font-weight: normal;text-transform: capitalize;color:#9e9e9e;font-size:12px;">Address <abbr title="required" class="required" style="color: #c50505">*</abbr>
                </label>
                <div class="form-group" style="text-align: right;width: 100%;position: relative;">
                <textarea oninput="$(this).removeClass('invalid');" onkeyup="changed_details()" oninput="$(this).removeClass('invalid')" rows="4" value="" title="Minimal character count is 10" placeholder="Street address" id="shipping_address_1" name="shipping_address_1" class="input-text validate" required="margin-bottom:0;" readonly="" style="width: 100%;box-sizing: border-box;display:block"><?=$suserrow['address']?></textarea>

                <span onclick="dis_sadd()" id="dis_sadd" class="fa fa-sm fa-edit" style="position: absolute;right: 0;top: 0;color: white;background-color:#0c77cc;padding: 4px;" onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#0c77cc')"></span>
                <span onclick="reset_sadd()" id="hide_sadd" class="fa fa-sm fa-close" style="display: none;position: absolute;right: 0;top: 0;color: white;background-color:red;padding: 5px;padding-top: 4px;padding-bottom: 4px;" onmouseover="$(this).css('background-color','#bb0000')" onmouseleave="$(this).css('background-color','red')"></span>
                <span onclick="dis_sadd()" id="hide_sadd1" class="fa fa-check" style="display:none;position: absolute;right: 0;top: 23px;color: white;background-color:#07C103;padding: 3px;" onmouseover="$(this).css('background-color','#4f994f')" onmouseleave="$(this).css('background-color','#07C103')"></span> 
                </div>
            </div>
        </p>
        ...
        <p id="shipping_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
            <div class="input-group bar-srch" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;" >
                <label class="" for="shipping_postcode" style="font-weight: normal;text-transform: capitalize;color:#9e9e9e;font-size:12px;">Postcode <abbr title="required" class="required" style="color: #c50505">*</abbr>
                </label>
                <input oninput="$(this).removeClass('invalid');" type="text" onkeyup="changed_details()" oninput="$(this).removeClass('invalid')" value="<?=$suserrow['pincode']?>" placeholder="Postcode / Zip" id="shipping_postcode" maxlength="6" name="shipping_postcode" class="input-text validate" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" pattern="^\d{6}$" title="PIN Number Format (654321)- 6 digits" required="" style="border-top-right-radius: 0px;border-bottom-right-radius: 0px;margin-top: 0px;margin-bottom:0;" readonly> 

                <span id="dis_spin" class="input-group-btn">
                    <button onclick="dis_spin()" onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#0c77cc')" style="color: white;background-color:#0c77cc;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;outline: none;margin-top: 25px;" class="btn btn-default search_btn" type="button"><span class="fa fa-edit"></span></button>
                </span>

                <span id="hide_spin" class="input-group-btn" style="display: none;">
                    <button onclick="reset_spin()"  onmouseover="$(this).css('background-color','#bb0000')" onmouseleave="$(this).css('background-color','red')" style="color: white;background-color:red;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;padding-left: 28px;margin-top: 25px;" class="btn btn-default search_btn" type="button"><span class="fa fa-close" style="margin-left: -18px;"></span></button>
                </span>
...
<!-------------------------------------------------------------------------------------------------------->
                    ...
                    <div class="register-check-box">
                        <div class="check">
                            <label class="checkbox"><input type="checkbox" id="accept" name="checkbox"><i> </i>I accept the terms and conditions</label>
                        </div>
                    </div>
                    <input class="shadow_b real_btn" type="button" onclick="checkupdate()"  value="Update">
                    <button class="shadow_b load_btn" style="display:none" type="button" ><i class="fa fa-refresh fa-spin"></i>&nbsp;Update</button>
                    </div>
                    
                </form>
            </div>
            <div class="register-home">
                <a href="onestore.php"  onmouseover="$(this).css('background-color','#0c66cc')" onmouseleave="$(this).css('background-color','#fe9126')" style="color: white;background-color:#fe9126;">Home</a>
            </div>
         </div>
      </div>  
   </div>  
