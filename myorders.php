...
.col-xs-2,.col-xs-3,.col-xs-4,.col-xs-5,.col-xs-6,.col-xs-8,.col-xs-9,.col-xs-10,.col-xs-11{
  padding: .25px;
}
.col-sm-8{
  padding:0px;
  ...
  <div class="col-sm-12 " style="padding: 0;margin:0;">
    <div class="col-sm-6 col-xs-7 ord_srch">
      <div  class="input-group bar-srch"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 0px;" > 
        <input  type="text" class="" id="order_search"  placeholder="Search" value="" name="" required=" " style="width: 100%;margin: 0px;z-index: 0;border-radius: 3px;border-top-right-radius: 0px;border-bottom-right-radius: 0px;outline: none;">

                                
        <span id="" class="input-group-btn" >
              <button id="ord_srch" onclick="dispsrch()" style="color: white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;padding-top:10px;padding-bottom: 10px;outline: none;border-radius: 0;border-bottom-right-radius: 3px;border-top-right-radius: 3px;" class="btn btn-default search_btn" type="button"><span class="fa fa-search"></span></button>
        </span>
    </div>
    </div>
    ...
    <div class="col-sm-4 col-xs-4 ord_filt">
      <div class="input-group bar-srch" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 0px;" > 
        <select name="ord_filt" class="locmark" id="ord_filt" required=" " style="width: 100%;height: 40px;margin: 0px;z-index: 0;border-radius: 3px;border:1px solid #DBDBDB;border-top-right-radius: 0px;border-bottom-right-radius: 0px;">
        ...
        <span id="hide_filt" class="input-group-btn" >
          <button onclick="disfilter()" onmouseover="$(this).css('background-color','#4f994f')" onmouseleave="$(this).css('background-color','#07C103')" style="color: white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #029400), color-stop(1, #026400)) !important;padding-top:10px;padding-bottom: 10px;outline: none;" class="btn btn-default search_btn popuptext pin" type="button"><span class="fas fa-filter"></span></button>
        </span>
      </div> 
    </div>
</div>
...
<div class="orhead" style="background-color: #ffffff;">
  <h2 class="sidebar-title-a" style="border-left: 5px solid #00869e;border-top-left-radius: 10px;text-align: left;padding-bottom: 24px;padding-top: 20px;margin-top: 0px;font-weight:normal;border-bottom:#333;margin-bottom: 0px;border-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px;color:#00869e;border-bottom-left-radius:0px ">My Orders <i style="color: #ffc400" class="fa fa-shopping-bag"></i></h2>
</div>
</div>
