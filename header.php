...
.std_text,.std_text1,.std_text2,.std_text3{
	text-align:center;
	display:flex;
	align-items:center;
	justify-content:center;
...
<div class="std_text1" style="color:white;font-size:17px;width:100%"><center>Wait a sec...</center></div>
<div class="std_text2" style="color:white;font-size:17px;width:100%"><center>Please wait...</center></div>
<div class="std_text3" style="color:white;font-size:17px;width:100%"><center>Placing order...</center></div>
<!--RESPONSE AWAITING-->
<!--ANIMATION-->
<div class="loader1">
            ...
            <div class="row">
                <div class="col-lg-12" style="padding: 0px">
                    ...
                    <div class="navbar-header">
                        <button class="navbar-toggle" data-target="#mobile_menu" data-toggle="collapse" onclick="myFun(this)">
														...
														<h6>Choose Category</h6>
															...
															<li  id="">
																...
																<div style="width: 100%">
																	...
																	<label for="Personal care">Personal care</label></p>
																	<hr>
...
<!--SIDE NAV BAR-->
<div id="mySidenav" class="sidenav scroll_handle_blue" style="z-index: 99999999;padding-top: 0px;overflow-y: scroll;">
