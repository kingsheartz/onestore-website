...
function check_mul(){
     $.ajax({
              ...
              success: function(data){    //if registration is success
                  if(data.status=='success'){
                      location.href="checkout_mul.php";
                      return;
                    }
            },
              error: function(xmlhttprequest, textstatus, message) { //if it exceeds timeout period
...
<div class="side-arrow" style="position: fixed;bottom: 0px;height:148px;right:198px;z-index: 100;color:rgb(255, 255, 255);background-color: rgba(250, 245, 245, 0);padding:10px;border-top-left-radius: 10px;display: none;justify-content: center;align-items: center;">
...
<i style="display: none;margin-bottom: 0px;margin-left: -2px;" class="fa fa-shopping-cart fa-lg arr-l" onclick="$('.side-ext-r').css('visibility','visible');$('.side-ext-r').css('opacity','1');$('.side-arrow').css('right','198px');$('.arr-l').hide();$('.arr-r').show();"></i>
<i style="font-size: 40px;margin-left: 10px;margin-bottom: 2px;" class="fa fa-angle-right fa-3x arr-r" onclick="$('.side-ext-r').css('visibility','hidden');$('.side-ext-r').css('opacity','0');$('.side-arrow').css('right','0');$('.arr-r').hide();$('.arr-l').show();"></i>
</div>
</div>

<div class="side-ext shadow_l">

        <div class="div_wrapper side-ext-l side-ext-r shadow_l" style="display:flex;padding:0;display: none;bottom:100px;position: fixed;width: 200px;right:0;z-index: 99;"><input type="button" style="height: 50px;font-weight: bold;border-top-left-radius: 10px;background-color: #ff5722;bottom:100px;position: fixed;width: 200px;right:0;" onclick="check_mul()" value="Proceed to buy"  name="proceed" class=" button alt wc-forward side-ext-k shadow_l">
        </div>
        ...
        <div class="side-ext-l side-ext-r shadow_l" style="visibility: visible;opacity: 1;display: none;position: fixed;width: 200px;right:0;bottom:0;z-index: 99;">
            <div class="side-ext-l side-ext-r shadow_l" style="position: fixed;bottom: 50px;right:0;z-index: 99;color:white;background-color: rgb(70, 70, 70);padding:10px;width:200px;"><label class="options" ><span class="val-getbrand">Deselect all</span><input onclick="deselect()" class="deselect" value="" id="mobgetbrand" type="radio" name="mob-radio-getbrand"> <span class="checkmark "></span></label>
            </div>
...
?>                    
        <div class="col-md-9" style="margin:0px;padding: 0px;margin: 0px;">
            <div class="product-content-right nopadding-margin" style="margin:0px;padding: 0px;margin-right: 10px;background-color: white;border-radius: 10px;">

                <h2 class="sidebar-title" style="border-left: 5px solid #ff5722;border-top-left-radius: 10px;text-align: left;padding-bottom: 30px;padding-top: 20px;background-color: white;margin-top: 0px;font-weight:normal;border-bottom:#333;margin-bottom: 0px;border-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; ">Shopping Cart <i style="color: #ff5722" class="fa fa-shopping-cart"></i>

                    <span style="float: right;margin-right: 5px;margin-top: -16px;">
                        <input type="button" style="max-width: 150px;height: 60px;font-weight: bold;border-top-right-radius: 10px;background-color: #ff5722" onclick="go()" value="Proceed to buy" id="proceed" name="proceed" class="checkout-button button alt wc-forward">
                    </span></h2>
                            ...
                            <tr>
                                <td class="product-name" colspan="2" style="padding: 0px;margin-top: 5px;">
                                    <p style="margin:0px;margin-bottom: 20px;font-size:17px;" >
                                        <div style="margin-right:10px;background-color: #02171e;padding-right:20px;padding-left:10px;width: 100%;border-radius: 2px;margin-bottom: -8px;padding-top:8px;padding-bottom:8px;text-align:justify">
                                            <div style="display: flex;">
                                                <a class="pd_name" href="#" style="color: white;font-weight: normal;text-align:justify;"><i class="fa fa-product-hunt" style=""></i> <?=$row2['item_name']?></a>
                                            </div>
                                        </div> 
                                    </p> 
                                </td>
                                        ...
                                        <table style="width: 180px;margin-top: 5px;" class="tbl_s<?=$store_id."i".$item_description_id?>">
                                            <tr>
                                                <td style="padding: 0px;padding-left: 10px;padding-right: 10px;">
                                                    <input id="check_s<?=$store_id."i".$item_description_id?>" class="checktobuy" onclick="addorremove(this)" type="checkbox" name="select_item" value="s-<?=$store_id."_i-".$item_description_id?>">
                                                </td>
                                                ...
                                                <td>
                                                    <div class="product-quantity quantity buttons_added" style="justify-content: center;display: flex;text-align: center;align-items: center;position: relative;margin-right: 0px">
                                                        ...
                                                        <div class="product_img" style="padding: 0px; margin-top: 7px;margin-left: 15px;">        
                                                                ...
                                                                <a href="single.php?id=<?=$row2['item_description_id']?>"><img style="max-width:180px;max-height:180px;" alt="<?=$row2['item_name']?>" class="shop_thumbnail" src="images/<?=$row2['category_id']?>/<?=$row2['sub_category_id']?>/<?=$row2['item_description_id']?>.jpg"></a>
                                                                </p>
                                                        </div>
                                                    ...
                                                    <div class="row" style="margin-left: 0px;float: left;margin-right: 0px;">
                                                        <div class="col-md-6 full-size-cart-store-div" style="padding: 0px;margin-left: 20px;width: 200px;">
                                                            ...
                                                            <p style="z-index: 1;text-align:left;margin-top: 35px;">
                                                                ...
                                                                <span style='font-family: arial;color:#006904;font-weight: bold;text-decoration: none;font-size: 12px'>You Save &#8377; <span id="save_s<?=$store_id."i".$item_description_id?>" style="text-decoration: none;font-weight: bold;color: #006904;padding-left: 0px"><?=$save?></span> (<span style="text-decoration: none;font-weight: bold;color: #006904;padding-left: 0px" id="off_s<?=$store_id."i".$item_description_id?>"><?=$off?></span>%)
                                                                </span>
                                                                         
                                                            </p>
                                                            <p class="product-price" style="z-index: 1;text-align:left;margin-top: 10px;;font-weight: bold;font-size: 2vw">
                                                                <span class="amount">&#8377;<span id="total_s<?=$store_id."i".$item_description_id?>"><?=$total?></span> <i style="color: #303030" class="fa fa-tags">&nbsp;<del style="color: #999;font-weight:normal;font-size: 13px;">&#8377;</del></i><del style="color: #999;font-weight:normal;font-size: 13px;" id="mrp_s<?=$store_id."i".$item_description_id?>" style="text-decoration:"><?=(int)$t_mrp*(int)$row1['quantity']?></del></span> 
                                                            </p>
                                                            <p style="margin-top:10px;">
                                                               
                                                                <select style="outline: none;border:none;background-color:#006904;color: white;padding: 5px;border-radius: 3px;padding-top: 1px;padding-bottom: 1px; "  id="order_s<?=$store_id."i".$item_description_id?>">
                                                                    <option selected="" disabled="" style="background-color: white;font-weight: bold;text-align: center;" value="<?=$row1['order_type']?>"><?=ucwords($row1['order_type'])?></option>
<?php 
...
?>
                                                                    <option style="background-color: white;color:#006904;font-weight: bold;text-align: center; " value="1">Booking</option>
<?php
    }
...
?>
                                                                    ...
                                                                    <option style="background-color: white;color:#006904;font-weight: bold;text-align: center;" value="2">Delivery</option>
<?php
    }
                                                ...
                                                <div  style="margin-top: 40px;">
                                                    ...
                                                    <ul>
                                                        <li><span class="a-list-item">
                                                                <span class="a-size-small a-color-success sc-product-availability"><b style="color:#86001d; ">In stock</b></span>
                                                            </span>
                                                        </li>

                                                        <p><img alt="" src="images/logo/logofill-sm.png" style="max-width:115px" data-a-hires="https://m.media-amazon.com/images/G/31/marketing/fba/fba-badge_18px-2x._CB485942108_.png"></p>
...
?>
                                                            ...
                                                            <li class="sc-product-variation">
                                                                <span class="a-list-item">
                                                                    <small><span class="a-size-small a-text-bold"><b>Description: </b></span>
                            ...
                            <tr style="width: 100%">
                                ...
                                <table width="100%" class="tbl_s<?=$store_id."i".$item_description_id?>">
                                    <tr class="product-quantity quantity buttons_added" style="margin-right: 0px;width: 100%">
                                        <td>
                                            <p class="product-subtotal" style="bottom: 0px;margin-left: 15px;float: left;font-weight: bold;">Price 
                                                <span class="amount">&#8377;<span id="price_s<?=$store_id."i".$item_description_id?>"><?=$row2['price']?></span><span>/-</span> (1 Qty) |</span>
                                            </p>
                                        </td>
                                        <td>
                                            <p ><a id="update_item" style="font-weight: bold;float: left;margin-top: -10px;"  onclick="updateitem(<?=$item_description_id.','.$store_id?>)" value="Update Cart" name="update_cart" >&nbsp;Update&nbsp;</a>
                                            </p>
                                        </td>
                                        <td>
                                            <p class="product-store"><span>|</span><i style="color: #303030;bottom: 0px;margin-top: 2px;margin-left: 5px;" class="fas fa-store">&nbsp;</i> 
...
<!--------------------------------------------------------------------------------------------------------------------------------------------------------->
                                                <div class="btn_sub_q"  style="padding: 0px;margin: 0px;margin-left: 2px;"><button style="background-color: #02171e;-webkit-box-shadow: inset 0px 0px 15px 3px #02171e;box-shadow: inset 0px 0px 15px 3px #02171e;width: 100%;min-width: 30px;height: 40px;font-weight: bold;border-color: #02171e;color: white;font-size: 18px;border-radius: 5px;border-top-right-radius: 0px;border-bottom-right-radius: 0px;" type="button" id="sub_s<?=$store_id."i".$item_description_id?>" onclick="sub_item_all('<?=$store_id?>','<?=$item_description_id?>','<?=$t_mrp?>')">-</button>
                                                </div>


                                                <div style="padding: 0px;margin: 0px;">
                                                    <button id="btn_s<?=$store_id."i".$item_description_id?>" type="button" style="width: 100%;min-width: 50px;height: 40px;font-weight: bold;font-size: 14px;background-color: white;outline: none;border-color:#02171e;padding: 0" onclick="$(this).hide();if($(this).html()<10){$('#sel_s<?=$store_id."i".$item_description_id?>').show();}else{$('#qnty_s<?=$store_id."i".$item_description_id?>').show();}"><?=$row1['quantity']?></button>

                                                    <select id="sel_s<?=$store_id."i".$item_description_id?>"  onchange="select_item_option('<?=$store_id?>','<?=$item_description_id?>','<?=$t_mrp?>');" name="quantity" autocomplete="off" style="width: 100%;min-width: 50px;bottom: 0;box-shadow: none;outline: none;border-color:#aaa;height:40px;display: none;background-color: white">
                                                        <option value="<?=$row1['quantity']?>" id="sel_opt_s<?=$store_id."i".$item_description_id?>" selected disabled><?=$row1['quantity']?></option>
                                                        <option value="0" class="sc-update-quantity-option" data-a-css-class="quantity-option" data-a-html-content="0 (Delete)">0 (Delete)</option>
                                                    ...
                                                    <input type="number" id="qnty_s<?=$store_id."i".$item_description_id?>" size="4"  onchange="total('<?=$store_id?>','<?=$item_description_id?>','<?=$t_mrp?>')" onblur="$(this).hide();$('#sel_s<?=$store_id."i".$item_description_id?>').hide();$('#btn_s<?=$store_id."i".$item_description_id?>').show()" style="text-align: center;display: none;height: 40px;width: 100%;min-width: 50px;outline: none;font-weight: bold" class="input-text qty text" title="Quantity" value="<?=$row1['quantity']?>" min="1" step="1" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57">

                                                </div>  

                                                <div class="btn_add_q"  style="padding: 0px;margin: 0px;"><button style="background-color: #02171e;-webkit-box-shadow: inset 0px 0px 15px 3px #02171e;box-shadow: inset 0px 0px 15px 3px #02171e;width: 100%;min-width: 30px;height: 40px;font-weight: bold;border-color: #02171e;color: white;font-size: 18px;border-radius: 5px;border-top-left-radius: 0px;border-bottom-left-radius: 0px;" id="add_s<?=$store_id."i".$item_description_id?>" onclick="add_item_all('<?=$store_id?>','<?=$item_description_id?>','<?=$t_mrp?>')" type="button">+</button></div>
                                                </div>  
<!--------------------------------------------------------------------------------------------------------------------------------------------------------->

                                        </td>
                                        <td style="padding: 0px;width: 45%">
                                            <button type="button" title="Add to wish list" style="width: 100%;height: 40px;background-color: #f6f6f6;border: 0px solid #999;outline: none;font-weight: bold;-webkit-box-shadow: inset -1px 1px 15px 3px #bbb;box-shadow: inset -1px 1px 15px 3px #ccc;" data-toggle="modal" data-target="#avail_wishlist" onclick="wishlist_check_store_select(<?=$item_description_id?>,<?=$store_id?>)"> Wishlist <i style="color: red" class="fa fa-heart"></i></button>
                                        </td>
                                        <td class="product-remove" style="padding: 0px;width: 45%;">
                                            <button type="button" title="Remove this item" style="width: 100%;height: 40px;border:none;border-color: #fff;color: #fff;background-color: #c50505;outline: none;-webkit-box-shadow: inset -1px 1px 15px 3px #76001d;box-shadow: inset -1px 1px 15px 3px #86001d;" class="remove" onclick="remove_item('<?=$store_id?>','<?=$item_description_id?>')" href="#"><b>Remove </b><i class="fas fa-trash-alt"></i></button> 
                                        </td>
                                    </tr>
                                </table>
                            </tr>
                    ...
                    <div class="cart_totals shadow_all_none" style="width: 100%;margin:0px;padding: 0px;padding-top: 0px;">
                        <div class="row">
                            <div class="col-md-6" style="float:right;">
                                ...
                                <h4 style="padding-right: 10px;text-transform: capitalize;color:#000;float: right;">Subtotals(<span id="total_rm_cnt"><?=$item_cnt?></span> item) <small style="font-weight: bolder;">&#8377;</small><b id="tot_val2"><?=$row['subtotal']?></b></h4>

                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="div-wrapper" style="padding-left: 15px;padding-right: 15px;grid-gap: 0px;padding-top: 20px;">
                                        <div style="padding: 10px;">
                                            <button type="button" style="width: 100%;padding-top:8px;padding-bottom: 8px;border-radius: 2px;font-weight: bold;float: left; background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;" onclick="updatecart()"  name="update_cart" class="btn-primary btn button"><i class="fas fa-upload fa-lg"></i> UPDATE CART</button>
                                        </div>
                                        <div style="padding: 10px;">        
                                                <button type="button" style="width: 100%;padding-top:8px;padding-bottom: 8px;border-radius: 2px;font-weight: bold;float: right;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #ff6f00), color-stop(1, hsl(21, 100%, 50%))) !important;" onclick="go()"  name="proceed" class="checkout-button btn btn-primary button alt wc-forward"><i class="fa fa-check-square-o fa-lg"></i> CHECKOUT</button>
                                        </div>        
                                    </div>
                                </div>
                            </div>
...
#collapse2 ul li.active>a, a[aria-expanded="true"] {
    text-decoration: none;
...
<div class="panel-group col-md-3" id="large_screen" style=" margin-left: 0px;background-color: #fff;border-radius: 3px;padding:0;">
...
?>
        <li class="list-group-itemb" style="display: flex;padding:5px;" onclick="location.href='single.php?id=<?=$row['item_description_id']?>'">
        <div style="width:70px">
            <img class="smimg"  src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg">
        </div>
        <div style="position: relative;float:left;width:100%;padding:20px">      <?=$row['item_name']?>
            <button class="price"><i class="fas fa-rupee-sign"></i> <?=$row['price']?></button>
        </div>
        </li>        
<?php
   }
?>
        <li class="list-group-itemb" style="padding:10px;height:50px;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #00c0ef), color-stop(1, #01728e)) !important;">
        <a href="allitems.php"><button class="vwbt" onmouseover="$(this).css('color','#00c0ef')" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;" onmouseout="$(this).css('color','#fff')">View All</button></a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="panel-group col-md-3" id="large_screen" style=" margin-left: 0px;background-color: #fff;border-radius: 3px;padding:0;">
    <div class="panel panel-default" >
     <a data-toggle="collapse" href="#collapse2" > 
        <div class="panel-heading" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #d606ff), color-stop(1, hsl(283, 99%, 34%))) !important;">
            <h4 class="panel-title">
                Popular Products
            </h4>
        </div>
...
?>
        <li class="list-group-itemb" style="padding:10px;height:50px;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #d606ff), color-stop(1, hsl(283, 99%, 34%))) !important;">
        <a href="diff_views.php?popular=1"><button class="vwbt" onmouseover="$(this).css('color','#f606ff')" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #410041), color-stop(1, #4f0063)) !important;" onmouseout="$(this).css('color','#fff')">View All</button></a>
        </li>
      </ul>
    </div>
  </div>
...
?>
<a href="single.php?id=<?=$row1['item_description_id']?>"><img title="<?=$row1['item_name']?> " alt=" <?=$row1['item_name']?>" class="new_size" src="images/<?=$row1['category_id']?>/<?=$row1['sub_category_id']?>/<?=$row1['item_description_id']?>.jpg"></a>
<?php
}
?>
...
<br>
                <div class="shadow_b">
                    <h4 class="show_cat_list_main tb-padding sidebar-title cart_empty_show_cat" style="border-left: 5px solid <?=$bgcolor[$rancolor2]?>;border-top-left-radius: 10px;text-align: left;padding-bottom: 10px;padding-top: 10px;background-color: white;font-weight:normal;border-bottom:#333;margin-bottom: -5px;margin-top: 13px;border-top-right-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; overflow: hidden;font-size: 18px;"><?=$sub_cat_name2?> <i style="color: #ff5722;" class="fa fa-arrow-right"></i>
                        <span style="float: right;margin-right: 5px;margin-top: -4px;">
                            <button type="button" style="max-width: 150px;height: 30px;font-weight: bold;border-top-right-radius: 10px;background-color: <?=$bgcolor[$rancolor2]?>;padding: 11px auto;font-size: 12px;"  name="proceed" class="checkout-button button alt wc-forward"><a href="products_viewall.php?category_id=<?=$cat_id2?>&subcategory_id=<?=$sub_cat_id2?>" style="color:<?=$c2?>;">View all</a></button>
                        </span>
                    </h4>
                    <hr style="padding: 0;margin:0;">
...
<div class="container" style="width: 100%;background-color: #fff;margin-top: 15px;" >
    ...
    <h4 class="show_cat_list_main tb-padding sidebar-title cart_empty_show_cat" style="border-left: 5px solid <?=$bgcolor[$rancolor1]?>;border-top-left-radius: 10px;text-align: left;padding-bottom: 10px;padding-top: 10px;background-color: white;font-weight:normal;border-bottom:#333;margin-bottom: -5px;margin-top: 13px;border-top-right-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; overflow: hidden;font-size: 18px;">Explore <i style="color: #ff5722;" class="fa fa-arrow-right"></i>
      <span style="float: right;margin-right: 5px;margin-top: -4px;">
...
<button class="left-arrow-btn-all shadow_all_none" onclick="moveleft('difrow')" style="display: none;"><i class="fas fa-chevron-left"></i></button>
<button class="right-arrow-btn-all shadow_all_none" onclick="moveright('difrow')"><i class="fas fa-chevron-right"></i></button>
...
?>
  ...
  <div class="products-all-in-one" title="<?=$row['item_name']?>" onclick="location.href='single.php?id=<?=$row['item_description_id']?>'">
...
<button class="left-arrow-btn-all shadow_all_none" onclick="moveleft('difrow<?=$row['item_description_id']?>')" style="display: none;"><i class="fas fa-chevron-left"></i></button>
<button class="right-arrow-btn-all shadow_all_none" onclick="moveright('difrow<?=$row['item_description_id']?>')"><i class="fas fa-chevron-right"></i></button>
...
?>          <div class="row emp_cart" style="background-color: #fff;margin:0;">
                <div class="product-content-right">
                    <center><img style="justify-content: center;" class="sidebar-title" src="images/logo/cart-empty.png">
                    <h2 class="sidebar-title" style="text-align: center;display: inline-flex;font-weight: 600;">Your Cart is Empty</h2></center>
                </div>
                <div class="element_grid">
                  <div class="shadow_b">
                    <h4 class="show_cat_list_main tb-padding sidebar-title cart_empty_show_cat" style="border-left: 5px solid <?=$bgcolor[$rancolor1]?>;border-top-left-radius: 10px;text-align: left;padding-bottom: 10px;padding-top: 10px;background-color: white;font-weight:normal;border-bottom:#333;margin-bottom: -5px;margin-top: 13px;border-top-right-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; overflow: hidden;font-size: 18px;"><?=$sub_cat_name1?> <i style="color: #ff5722;" class="fa fa-arrow-right"></i>
...
?>
<a href="single.php?id=<?=$row1['item_description_id']?>"><img title=" " alt=" " class="new_size" src="images/<?=$row1['category_id']?>/<?=$row1['sub_category_id']?>/<?=$row1['item_description_id']?>.jpg"></a>
<?php
}
?>
