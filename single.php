...
lastScrollTop = st;
 ...
 <div class="div-wrapper small-btn btn-cart" id="btn-mob" style="width:100%;">
    <div id="atc-mob" type="button" name="submit" class="btn btn-primary btn-lg button btn-cart btn-flat" data-toggle="modal" data-target="#avail_stores" style="width: 100%;justify-content: flex-start;border-radius: 0px;border-color: #fff;">
      <i class="fas fa-cart-plus mr-2"></i>
        Add to Cart
    </div>

    <div class="btn btn-default btn-lg btn-flat btn-buy button" id="btn-buy-mob" type="button" name="submit"  data-toggle="modal" data-target="#avail_stores_buy" style="width: 100%;position: relative;float: left;justify-content: flex-start;border-radius: 0px;">
    <div class="btn btn-default btn-lg btn-flat" type="button" name="submit"  style="font-size: 16px;width: 25px;height:25px;position: relative;justify-content: center;border-radius: 50%;padding:4px;background-color: #fff;"><i style="color: #c50505;display: flex;align-items: center;justify-content: center;margin-left: 50%;" class="fas fa-flash mr-2"></i>
     </div>
    Buy Now
    </div>
</div>
...
<!---------------------------------------------------------------------------------------------------------------->              
              ...
              <div class="col-md-12 div-wrapper product_contain_div" style="margin-top: 20px;padding-right:0px;height:430px;">
<?php 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
                ...
                <div style="margin:0;padding:0;width:100%">
                  <ul class="img-example-left">
                    ...
                    <li>
                      <div class="product-image-thumb active"><img src="images/<?=$row2['category_id']?>/<?=$row2['sub_category_id']?>/<?=$row2['item_description_id']?>.jpg" alt=" " class="product-image img-responsive" alt="Product Image"></div>
                    </li>
<?php
if(!empty($img_cnt_row['img_count'])){
$img_cnt_flag=1;
...
?>
                    <li>
                      <div class="product-image-thumb"><img src="images/<?=$row2['category_id']?>/<?=$row2['sub_category_id']?>/<?=$row2['item_description_id']?>_<?=$img_cnt_flag?>.jpg" alt=" " class="product-image img-responsive" alt="Product Image"></div>
                    </li>
<?php
$img_cnt_flag++;
}
...
?>
              ...
              <div class="col-md-10 col-sm-10 col-xs-10 img-big" style="position: relative;justify-content:center;align-items:center;display:flex;padding-left:0;">
                ...
                <div id="img-zoom-container" class="img-zoom-container" onmouseover="$('.img-zoom-result').css('display','unset');imageZoom('myimage', 'myresult');$('.img-zoom-lens').css('display','unset');$('.zoom-in-adjust').css('height','max-content');"onmouseleave="$('.img-zoom-result').css('display','none');$('.img-zoom-lens').hide();$('.zoom-in-adjust').css('height','max-content');">

                <img id="myimage" src="images/<?=$row2['category_id']?>/<?=$row2['sub_category_id']?>/<?=$row2['item_description_id']?>.jpg" alt=" " class="product-image product-image-view img-responsive myimage">
               </div>
              <div id="img-zoom-conatiner-none" class="img-zoom-conatiner-none" style="display: none;">
                 <img id="example" src="images/<?=$row2['category_id']?>/<?=$row2['sub_category_id']?>/<?=$row2['item_description_id']?>.jpg" alt=" " class="product-image product-image-view img-responsive">
              </div>
            ...
            <div class=" col-md-1 col-sm-1" style="justify-content: right;padding:0px;">
              <div class="btn btn-default btn-lg btn-flat item_wish" type="button" name="submit" class="btn btn-primary btn-lg button" data-toggle="modal" data-target="#avail_stores_wishlist" style="width: 40px;position: relative;justify-content: center;border-radius: 50%;clear:right"><i style="color: #c50505;display: flex;align-items: center;justify-content: center;margin-left: 3px;" class="fas fa-heart fa-lg mr-2"></i>
              </div>

              <div onclick="copylink(<?=$_GET['id']?>,'https://one-store.ml/single.php?id=<?=$_GET['id']?>')" class="btn btn-default btn-lg btn-flat item_share" type="button" name="submit" class="btn btn-primary btn-lg button" data-toggle="modal" data-target="#myModal_share_item" style="width: 40px;position: relative;justify-content: center;border-radius: 50%;align-items: left;justify-content: left;display: flex;"><i style="color: #999898;display: flex;align-items: left;justify-content: left;margin-left: -8px;border-color: #e2e2e2;" class="fas fa-share fa-lg mr-2"></i>
              </div>

              <div id="view-single-img" style="display: flex;position: absolute;bottom: 20px;float:left;border:1px solid #999;padding:10px;padding-top: 13px;background-color: rgba(0,0,0,0.75);" onclick="openModal_single();currentSlide(1)"><i style="color: #fff" class="fa fa-search-plus fa-lg"></i></div>
            </div>
        ...
        <div class="div-wrapper big-btn" style="width: 100%;display: flex;">
          ...
          <div class="btn btn-primary btn-lg btn-flat btn-cart button" id="atc" type="button" name="submit"  data-toggle="modal" data-target="#avail_stores" style="width: 100%;justify-content: flex-start;border-radius: 4px;">
            <i class="fas fa-cart-plus mr-2"></i> Add to Cart
          </div>

          <div class="btn btn-default btn-lg btn-flat btn-buy button" type="button" name="submit"  data-toggle="modal" data-target="#avail_stores_buy" style="width: 100%;position: relative;float: left;justify-content: flex-start;border-radius: 4px;">
          <div class="btn btn-default btn-lg btn-flat" type="button" name="submit"  style="font-size: 16px;width: 25px;height:25px;position: relative;justify-content: center;border-radius: 50%;padding:4px;background-color: #fff;"><i style="color: #c50505;display: flex;align-items: center;justify-content: center;margin-left: 50%;" class="fas fa-flash mr-2"></i>
          </div>
          Buy Now
          </div>
...
if($img_cnt_row['img_count']>3){
?>
                  <div class=" col-md-12 col-sm-12 hidescroll " style="justify-content: right;overflow-x:scroll;width:100%;">
<?php 
}
else{
?>
...
?>                          
              <div class="btn-group btn-group-toggle" data-toggle="buttons" style="z-index:0 !important" onclick="location.href='single.php?id=<?=$rowfeatures_color['item_description_id']?>'">
...
?>             
              <div class="btn-group btn-group-toggle" data-toggle="buttons" onclick="location.href='single.php?id=<?=$rowfeatures_size['item_description_id']?>'">
...
?>  
                ...
                <label class="btn btn-default text-center">
                  ...
                  <span class="text-xl"><?=$rowsize_name['size_name']?></span>
                  <br>
                  <?=$size_abbreviation?>
                </label>
                  ...
                  <div class="col-md-12 agileinfo_single_right">
                    <div class="snipcart-thumb agileinfo_single_right_snipcart">
                      ...
                      <div class="div-wrapper large-btn"  id="btn-pc" style="width: 80%;margin-left: -30px;display: flex;">
                        <div class="btn btn-primary btn-lg btn-flat btn-cart button" id="atc" type="button" name="submit" data-toggle="modal" data-target="#avail_stores" style="max-width: 200px;justify-content: flex-start;border-radius: 4px;">
                          <i class="fas fa-cart-plus mr-2"></i>
                          Add to Cart
                        </div>

                        <div class="btn btn-default btn-lg btn-flat btn-buy button" id="btn-buy" type="button" name="submit"  data-toggle="modal" data-target="#avail_stores_buy" style="max-width: 200px;min-width: 150px;position: relative;float: left;justify-content: flex-start;border-radius: 4px;">
                        <div class="btn btn-default btn-lg btn-flat" type="button" name="submit"  style="font-size: 16px;width: 25px;height:25px;position: relative;justify-content: center;border-radius: 50%;padding:4px;background-color: #fff;"><i style="color: #c50505;display: flex;align-items: center;justify-content: center;margin-left: 50%;" class="fas fa-flash mr-2"></i>
                        </div>
                        Buy Now
                        </div>
...
?>                  
                  <span id="charnow" style="color:rgb(0, 97, 0);padding-left:10px">0</span>/<span style="color:rgb(0, 97, 0)">500</span></label>
                  <div class="form-group input-field" style="width: 100%;margin-top:0;">
                  
                    <textarea maxlength="500" style="width:100%;outline:#0c99cc" title="Maximum character count is 500" rows="4" oninput="$(this).removeClass('invalid');" onkeyup="changed_details();maxchar()" onfocus="dis_add();" onblur="dis_add()" id="reviewinput" placeholder="" ></textarea>
...
?>
  ...
  <section>
    ...
    <div style="height:20px;width:20px;border-radius:50%;background-color: <?=$bgcolor[$rancolor1]?>;display:flex;align-items:center;justify-content:center;color: <?=$c1?>"><?=$firstletter?></div>
    <p><?=$firstnm." ".$lastnm?></p>
    </div>
    <div class="div-wrapper" style="width:max-content">
  <?php
...
/* Individual bars */
.bar-a {background-color: #04AA6D;}
.bar-b {background-color: #2196F3;}
.bar-c {background-color: #00bcd4;}
.bar-d {background-color: #ff9800;}
.bar-e {background-color: #f44336;}
...
<div class="col-md-12 col-xs-12" style="padding:0;"><div class="container" style="padding:0;width:100%;">
  ...
  ?>
    <h4 class="show_cat_list_main tb-padding sidebar-title cart_empty_show_cat" style="border-left: 5px solid <?=$bgcolor[$rancolor1]?>;border-top-left-radius: 10px;text-align: left;padding-bottom: 10px;padding-top: 10px;background-color: white;font-weight:normal;border-bottom:#333;margin-bottom: -5px;margin-top: 13px;border-top-right-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; overflow: hidden;font-size: 18px;">Explore <i style="color: #ff5722;" class="fa fa-arrow-right"></i>
      <span style="float: right;margin-right: 5px;margin-top: -4px;">
        <button type="button" style="max-width: 150px;height: 30px;font-weight: bold;border-top-right-radius: 10px;background-color: <?=$bgcolor[$rancolor1]?>;padding: 11px auto;font-size: 12px;"  name="proceed" class="checkout-button button alt wc-forward"><a href="products_viewall.php?category_id=<?=$cat_id?>&subcategory_id=<?=$subcat_id?>" style="color:<?=$c2?>;">View all</a></button>
      </span>
    </h4>
...
if($isready!=0 && is_null($isready)==false){
  ...
  ?>
    <h4 class="show_cat_list_main tb-padding sidebar-title cart_empty_show_cat" style="border-left: 5px solid <?=$bgcolor[$rancolor2]?>;border-top-left-radius: 10px;text-align: left;padding-bottom: 10px;padding-top: 10px;background-color: white;font-weight:normal;border-bottom:#333;margin-bottom: -5px;margin-top: 13px;border-top-right-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; overflow: hidden;font-size: 18px;">Explore <i style="color: #ff5722;" class="fa fa-arrow-right"></i>
      <span style="float: right;margin-right: 5px;margin-top: -4px;">
        <button type="button" style="max-width: 150px;height: 30px;font-weight: bold;border-top-right-radius: 10px;background-color: <?=$bgcolor[$rancolor2]?>;padding: 11px auto;font-size: 12px;"  name="proceed" class="checkout-button button alt wc-forward"><a href="diff_views.php?recent=1" style="color:<?=$c2?>;">View all</a></button>
      </span>
    </h4>
  <div class="difcat " style="border-radius: 5px;">
  <span class="difhed">
...
<button class="left-arrow-btn-all shadow_all_none" onclick="moveleft('difrow1<?=$row['item_description_id']?>')" style="display: none;"><i class="fas fa-chevron-left"></i></button>
<button class="right-arrow-btn-all shadow_all_none" onclick="moveright('difrow1<?=$row['item_description_id']?>')"><i class="fas fa-chevron-right"></i></button>
...
function buynow_place_order_select(){
        ...
        if(flag==0){
          ...
          $.ajax({
              ...
              success: function(data){    //if registration is success
                   if(data.status=='success'){
                      location.href="checkoutsingle.php?store_id="+id+"&item_description_id="+item_description_id+"";
                      return;
                  }
                  else if(data.status=='error'){
                      swal({
