...
require_once "pdo.php";
  ...
  $user_id=$_GET['id'];
    ...
    $activate_link = 'https://one-store.ml/extras/OS/pages/FRL/OTP-v2.html';
...
/*
                ...
                $message .= '<p><center>&#169; 2020 <a href="https://one-store.ml/">OneStore</a>. All rights reserved </center></p>';
                $message .= '</body></html>';
*/
