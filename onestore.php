...
.single-promo:hover p{color: #fff !important;}
 </style>
<?php
...
<div style="display:none;position: fixed;bottom:-500px;width:100%;z-index:999;padding-left:5px;padding-right:5px;justify-content:center" class="cookiesetting">
<center>
<div style="padding:10px;border-radius:5px;background-color: rgba(0,0,0,0.85);max-width: max-content;text-align: left;">
    ...
    <p style="color:white;text-align: justify;">By clicking "Accept all cookies", you agree Stack Exchange can store cookies on your device and disclose information in accordance with our <a href="https://www.cookiesandyou.com/about-cookies/" target="_blank" style="color: white;">Cookie Policy</a>. </p>

     <button type="button" class="btn btn btn-primary" style="font-size:14px" onclick="$('.cookiesetting').hide();setcookie(1);" data-dismiss="modal">Accept all cookies</button>
     <button type="button" class="btn btn btn-success small-cookie-accept" onclick="$('#cookiemodal').modal('show');" style="font-size:14px" data-dismiss="modal">Customize settings</button>
</div>
</center>
</div>
<?php
...
<div class="element_grid" style="background-color: #fff;">
    <div class="scrollmenu cat_item_scroll hidescroll" style="width: 100%;">
        <div class="div-wrapper " style="margin-bottom: 10px;">
            ...
            <div class="cat-img">
                <a href="products_limited.php?category_id=1"><img title=" " alt=" " class="cat_new_size" src="images/caticon/care.png"></a>
                <div class="cat-title">
                    <a href="products_limited.php?category_id=1">Personal care</a>
                </div>
            </div>
            
            <div class="cat-img">
                <a href="products_limited.php?category_id=2"><img title=" " alt=" " class="cat_new_size" src="images/caticon/grocery.png"></a>
                <div class="cat-title">
                    <a href="products_limited.php?category_id=2">Grocery</a>
                </div>
            </div>

            <div class="cat-img">
                <a href="products_limited.php?category_id=3"><img title=" " alt=" " class="cat_new_size" src="images/caticon/mobile.png"></a>
                <div class="cat-title">
                    <a href="products_limited.php?category_id=3">Mobile</a>
                </div>
            </div>

            <div class="cat-img">
                <a href="products_limited.php?category_id=4"><img title=" " alt=" " class="cat_new_size" src="images/caticon/fasion.png"></a>
                <div class="cat-title">
                    <a href="products_limited.php?category_id=4">Fasion</a>
                </div>
            </div>

            <div class="cat-img">
                <a href="products_limited.php?category_id=5"><img title=" " alt=" " class="cat_new_size" src="images/caticon/home.png"></a>
                <div class="cat-title">
                    <a href="products_limited.php?category_id=5">Home</a>
                </div>
            </div>

            <div class="cat-img">
                <a href="products_limited.php?category_id=6"><img title=" " alt=" " class="cat_new_size" src="images/caticon/electronics.png"></a>
                <div class="cat-title">
                    <a href="products_limited.php?category_id=6">Electronics</a>
                </div>
            </div>

            <div class="cat-img">
                <a href="products_limited.php?category_id=10"><img title=" " alt=" " class="cat_new_size" src="images/caticon/appliances.png"></a>
                <div class="cat-title">
                    <a href="products_limited.php?category_id=10">Appliances</a>
                </div>
            </div>

            <div class="cat-img">
                <a href="products_limited.php?category_id=7"><img title=" " alt=" " class="cat_new_size" src="images/caticon/toys&baby.png"></a>
                <div class="cat-title">
                    <a href="products_limited.php?category_id=7">Toys&Baby</a>
                </div>
            </div>

            <div class="cat-img">
                <a href="products_limited.php?category_id=8"><img title=" " alt=" " class="cat_new_size" src="images/caticon/sports.png"></a>
                <div class="cat-title">
                    <a href="products_limited.php?category_id=8">Sports</a>
                </div>
            </div>

            <div class="cat-img">
                <a href="products_limited.php?category_id=9"><img title=" " alt=" " class="cat_new_size" src="images/caticon/beauty.png"></a>
                <div class="cat-title">
                    <a href="products_limited.php?category_id=9">Beauty</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="element_grid" style="margin: 0px;padding: 0px;border-radius: 10px;margin-top: -20px;">
    <div>
        ...
        <div class="scrollmenu bl_item_scroll  <?=$color[$rancolor1]?>" style="background-color: #fff;border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;"> 
...
?>
<a class="img_trans" href="single.php?id=<?=$row1['item_description_id']?>"><img title="<?=$row1['item_name']?>" alt=" <?=$row1['item_name']?>" class="new_size" src="images/<?=$row1['category_id']?>/<?=$row1['sub_category_id']?>/<?=$row1['item_description_id']?>.jpg" style="max-height: 180px;max-width: 180px;image-rendering: auto;margin-left: auto;margin-right: auto;"></a>
<?php
}
?>
...
<div class="element_grid" style="margin: 0px;padding: 0px;">
    <div style="margin: 0px;padding: 0px;">
        <h4 class="show_cat_list_main tb-padding sidebar-title" style="border-left: 5px solid <?=$bgcolor[$rancolor2]?>;border-top-left-radius: 5px;text-align: left;padding-bottom: 10px;padding-top: 10px;background-color: white;font-weight:normal;border-bottom:#333;margin-bottom: -5px;margin-top: 13px;border-top-right-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; overflow: hidden;font-size: 18px;"><?=$sub_cat_name2?> <i style="color: #ff5722;" class="fa fa-arrow-right"></i>
            <span style="float: right;margin-right: 5px;margin-top: -4px;">
        ...
        <div class="scrollmenu mui_item_scroll <?=$color[$rancolor2]?>" style="background-color: #fff;border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;">
...
?>
<a class="img_trans" href="single.php?id=<?=$row1['item_description_id']?>"><img title="<?=$row1['item_name']?>" alt=" <?=$row1['item_name']?>" class="new_size" src="images/<?=$row1['category_id']?>/<?=$row1['sub_category_id']?>/<?=$row1['item_description_id']?>.jpg" style="max-height: 180px;width: auto;max-width: 180px;image-rendering: auto;margin-left: auto;margin-right: auto;"></a>
<?php
}
?>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
         <a href="products_limited.php?category_id=1"> <img class="first-slide" src="images/b4.jpg" alt="First slide"></a>

        </div>
        <div class="item">
         <a href="products_limited.php?category_id=5&sub_category_id=24"> <img class="second-slide " src="images/b1.jpg" alt="Second slide"></a>

        </div>
        <div class="item">
          <a href="products_limited.php?category_id=2"><img class="second-slide " src="images/b2.gif" alt="Second slide"></a>
        </div>
      </div>

    </div><!-- /.carousel --><div class="clearfix"> </div><hr class="make_div"><hr class="make_div">
...
continue;}
  ...
  <button onclick="location.href='viewsubcat.php?category_id=<?=$ct?>'">View All</button></span></span>
  <div class="difrow hidescroll" id="difrow<?=$ct?>" onscroll="scrolllisten('difrow<?=$ct?>');" >
<button class="left-arrow-btn-all shadow_all_none" onclick="moveleft('difrow<?=$ct?>')" style="display: none;"><i class="fas fa-chevron-left"></i></button>
<button class="right-arrow-btn-all shadow_all_none" onclick="moveright('difrow<?=$ct?>')"><i class="fas fa-chevron-right"></i></button>
...
?>
<style>
    .cn1 .slick-dots li button:before{color:<?=$bgcolor[$rancolor[0]]?>;}
    .cn2 .slick-dots li button:before{color:<?=$bgcolor[$rancolor[1]]?>;}
    .cn3 .slick-dots li button:before{color:<?=$bgcolor[$rancolor[2]]?>;}
    .cn4 .slick-dots li button:before{color:<?=$bgcolor[$rancolor[3]]?>;}
        ...
        <div class="cat-news" style="padding: 0px;margin: 0px;width: 100%;margin-top:10px">
            <div class="container" style="padding: 0px;margin: 0px;width: 100%">
                <div class="row" style="padding: 0px;margin: 0px;width: 100%">
                    <div class="col-md-12 " style="border-right: 5px solid <?=$bgcolor[$rancolor[0]]?>;border-left:5px solid <?=$bgcolor[$rancolor[0]]?>;color:#000;border-radius: 5px;background-color: #fff"> 
...
?>
                            ...
                            <div class="col-lg-3" title="<?=$row1['item_name']?>" onclick="location.href='single.php?id=<?=$row1['item_description_id']?>'">
                                <div class="cn-img">
                                   <a href="single.php?id=<?=$row1['item_description_id']?>"><img title="<?=$row1['item_name']?>" alt=" <?=$row1['item_name']?>" class="new_size" src="images/<?=$row1['category_id']?>/<?=$row1['sub_category_id']?>/<?=$row1['item_description_id']?>.jpg" style="height: 150px;max-width: 150px;image-rendering: auto;margin-left: auto;margin-right: auto;"></a>
                                    <div class="cn-title">
                                        <a href="single.php?id=<?=$row1['item_description_id']?>"><?=$row1['item_name']?></a>
                                    </div>
                                </div>
                            </div>
<?php
...
?>
                    ...
                    </div><hr class="make_div"><hr class="make_div">

                     <div class="col-md-12 " style="border-right: 5px solid <?=$bgcolor[$rancolor[1]]?>;border-left:5px solid <?=$bgcolor[$rancolor[1]]?>;color:#000;border-radius: 5px;background-color: #fff"> 
...
?>                            
        ...
        <!-- Category News End-->
<hr class="make_div"><hr class="make_div">
        <!-- Category News Start-->
        ...
        <div class="cat-news" style="padding: 0px;margin: 0px;width: 100%">
            <div class="container" style="padding: 0px;margin: 0px;width: 100%">
                <div class="row" style="padding: 0px;margin: 0px;width: 100%">
                    <div class="col-md-12 " style="border-right: 5px solid <?=$bgcolor[$rancolor[2]]?>;border-left:5px solid <?=$bgcolor[$rancolor[2]]?>;color:#000;border-radius: 5px;background-color: #fff"> 
...
?>                             
                    ...
                    </div><hr class="make_div"></div><hr class="make_div">                   
                    <div class="col-md-12 " style="border-right: 5px solid <?=$bgcolor[$rancolor[3]]?>;border-left:5px solid <?=$bgcolor[$rancolor[3]]?>;color:#000;border-radius: 5px;background-color: #fff"> 
...
?>                              
                            <div class="col-lg-3" title="<?=$row1['item_name']?>" onclick="location.href='single.php?id=<?=$row1['item_description_id']?>'">
                                <div class="cn-img">
                                   <a href="single.php?id=<?=$row1['item_description_id']?>"><img title="<?=$row1['item_name']?>" alt=" <?=$row1['item_name']?>" class="new_size" src="images/<?=$row1['category_id']?>/<?=$row1['sub_category_id']?>/<?=$row1['item_description_id']?>.jpg" style="height:150px; max-width: 150px;image-rendering: auto;margin-left: auto;margin-right: auto;"></a>
                                    <div class="cn-title">
                                        <a href="single.php?id=<?=$row1['item_description_id']?>" style="color:black"><?=$row1['item_name']?></a>
                                    </div>
                                </div>
                            </div>
<?php
...
<!--banner-bottom-->
				<div class="ban-bottom-w3l">
					...
					<div class="col-md-6 ban-bottom3">
							<div class="ban-top">
								<img src="images/p2.jpg" class="img-responsive" alt="" onclick="location.href='products_limited.php?category_id=6&subcategory_id=30'"/>
							</div>
							<div class="ban-img">
								<div class=" ban-bottom1">
									<div class="ban-top">
										<img src="images/p1.jpg" class="img-responsive" alt="" onclick="location.href='products_limited.php?category_id=4&subcategory_id=20'"/>
									</div>
								</div>
								<div class="ban-bottom2">
									<div class="ban-top">
										<img src="images/p3.jpg" class="img-responsive" alt="" onclick="location.href='products_limited.php?category_id=6&subcategory_id=28'"/>
									</div>
								</div>
						...
						<div class="col-md-6 ban-bottom">
							<div class="ban-top">
								<img src="images/p4.jpg" class="img-responsive" alt="" onclick="location.href='products_limited.php?category_id=6&subcategory_id=27'"/>
							</div>
						</div>
...
/*COLOR PICKER*/
  ...
  ?>
    <h4 class="show_cat_list_main tb-padding sidebar-title cart_empty_show_cat" style="border-left: 5px solid <?=$bgcolor[$rancolor1]?>;border-top-left-radius: 10px;text-align: left;padding-bottom: 10px;padding-top: 10px;background-color: white;font-weight:normal;border-bottom:#333;margin-bottom: -5px;margin-top: 13px;border-top-right-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; overflow: hidden;font-size: 18px;">Rate this <i style="color: #ff5722;" class="fa fa-arrow-right"></i>
      <span style="float: right;margin-right: 5px;margin-top: -4px;">
        <button type="button" style="max-width: 150px;height: 30px;font-weight: bold;border-top-right-radius: 10px;background-color: <?=$bgcolor[$rancolor1]?>;padding: 11px auto;font-size: 12px;"  name="proceed" class="checkout-button button alt wc-forward"><a href="diff_views.php?prev=1" style="color:<?=$c2?>;">View all</a></button>
      </span>
    </h4>
  <div class="difcat " style="border-radius: 5px;">
  <span class="difhed">
  </span>
  <div class="difrow hidescroll" id="difrow<?=$prerow['item_description_id']?>" onscroll="scrolllisten('difrow<?=$prerow['item_description_id']?>');" >
<button class="left-arrow-btn-all shadow_all_none" onclick="moveleft('difrow<?=$prerow['item_description_id']?>')" style="display: none;"><i class="fas fa-chevron-left"></i></button>
<button class="right-arrow-btn-all shadow_all_none" onclick="moveright('difrow<?=$prerow['item_description_id']?>')"><i class="fas fa-chevron-right"></i></button>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="single-promo promo1" onclick="location.href='terms&conditions.php?return=1'">
                        <i class="fa fa-refresh"></i>
                        <p>Return policy</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="single-promo promo2" onclick="location.href='terms&conditions.php?shipping=1'">
                        <i class="fa fa-truck"></i>
                        <p>Free shipping</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="single-promo promo3" onclick="location.href='terms&conditions.php?payment=1'">
                        <i class="fa fa-lock"></i>
                        <p>Secure payments</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="single-promo promo4" onclick="location.href='allitems.php'"> 
...
?>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img style="height:180px;max-width:90px;width:auto" src="images/<?=$ph['category_id']."/".$ph['sub_category_id']."/".$ph['item_description_id']?>.jpg" alt="<?=$ph['item_name']?>">
                                    <div class="product-hover">
                                        <a href="single.php?id=<?=$ph['item_description_id']?>" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                </div>
                                ...
                                <div class="product-carousel-price">
                                    <ins><i class="fa fa-inr"></i><?=$ph['price']?></ins> <del><i class="fa fa-inr"></i><?=$ph['mrp']?></del>
                                </div> 
                            </div>
<?php
}
									...
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="single.php?id=<?=$norow['item_description_id']?>"><img title=" " style="max-width:70px;max-height:100px" alt=" " src="images/<?=$norow['category_id']."/".$norow['sub_category_id']."/".$norow['item_description_id']?>.jpg"></a>
												<p><?=$norow['item_name']?></p>
												<div class="stars">
<?php
...
?>	
													...
													<h4><i class="fa fa-inr"></i><?=$norow['price']?> <span><i class="fa fa-inr"></i><?=$norow['mrp']?></span></h4>
											</div>
										</div>
									</figure>
								</div>
...
?>         
        <div class="box">
          <img src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg" style="max-width:100%" alt="">
          <div class="link_box">
            <a href="products_viewall.php?category_id=8&subcategory_id=39">
              View
            </a>
          </div>
        </div>
...
?>  
        ...
        <div class="box">
          <img src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg" style="max-width:100%" alt="">
          <div class="link_box">
            <a href="products_viewall.php?category_id=8&subcategory_id=45">
              View
            </a>
          </div>
        </div>
...
?>  
        ...
        <div class="box">
          <img src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg" style="max-width:100%" alt="">
          <div class="link_box">
            <a href="products_viewall.php?category_id=8&subcategory_id=40">
              View
            </a>
          </div>
        </div>
...
?>  
        ...
        <div class="box">
          ...
          <div class="link_box">
            <h5>
            <a href="products_viewall.php?category_id=4&subcategory_id=23">
              View
            </a>
          </div>
        </div>
...
?>  
        ...
        <div class="box">
          <img src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg" style="max-width:100%" alt="">
          <div class="link_box">
            <a href="products_viewall.php?category_id=4&subcategory_id=21">
              View
            </a>
          </div>
        </div>
...
?>  
        ...
        <div class="box">
          <img src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg" style="max-width:100%" alt="">
          <div class="link_box">
            <a href="products_viewall.php?category_id=4&subcategory_id=18">
              View
            </a>
          </div>
        </div>
...
?>  
        ...
        <div class="box">
          <img src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg" style="max-width:100%" alt="">
          <div class="link_box">
            <a href="products_viewall.php?category_id=7&subcategory_id=35">
              View
            </a>
          </div>
        </div>
...
?>  
        ...
        <div class="box">
          <img src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg" style="max-width:100%" alt="">
          <div class="link_box">
            <a href="products_viewall.php?category_id=7&subcategory_id=36">
              View
            </a>
          </div>
        </div>
...
?>  
        ...
        <div class="box">
          <img src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg" style="max-width:100%" alt="">
          <div class="link_box">
            <a href="products_viewall.php?category_id=7&subcategory_id=32">
              View
            </a>
          </div>
        </div>
...
.in1:hover .fill,.in2:hover .fill,.in3:hover .fill {
  bottom: 0;
  opacity: 0.9;
}
...
<h3>Emerging fashions</h3>
  ...
  <div class="row">
    <div class="col-xs-6">
      ...
      <div class="fill">
        <a href="products_limited.php?category_id=4&subcategory_id=20">
              View
        </a>
      </div>
      </div>
    ...
    <div class="col-xs-6">
      ...
      <div class="fill">
        <a href="products_limited.php?category_id=4&subcategory_id=23">
              View
        </a>
      </div>
      </div>
    ...
    <div class="col-xs-6">
      ...
      <div class="fill">
        <a href="products_limited.php?category_id=4&subcategory_id=18">
              View
        </a>
      </div>
      </div>
    ...
    <div class="col-xs-6">
      ...
      <div class="fill">
        <a href="products_limited.php?category_id=4&subcategory_id=21">
              View
        </a>
      </div>
      </div>
...
<h3>Make More Beauty</h3>
  ...
  <div class="row">
    <div class="col-xs-6">
      ...
      <div class="fill">
        <a href="products_limited.php?category_id=4&subcategory_id=22">
              View
        </a>
      </div>
      </div>
    ...
    <div class="col-xs-6">
      ...
      <div class="fill">
        <a href="products_limited.php?category_id=1&subcategory_id=5">
              View
        </a>
      </div>
      </div>
    ...
    <div class="col-xs-6">
      ...
      <div class="fill">
        <a href="products_limited.php?category_id=1&subcategory_id=1">
              View
        </a>
      </div>
      </div>
    ...
    <div class="col-xs-6">
      ...
      <div class="fill">
        <a href="products_limited.php?category_id=1&subcategory_id=4">
              View
        </a>
      </div>
      </div>
...
<h3>Make Your Home More Beautiful</h3>
  ...
  <div class="row">
    <div class="col-xs-6">
      ...
      <div class="fill">
        <a href="products_limited.php?category_id=5&subcategory_id=25">
              View
        </a>
      </div>
      </div>
    ...
    <div class="col-xs-6">
      ...
      <div class="fill">
        <a href="products_limited.php?category_id=5&subcategory_id=24">
              View
        </a>
      </div>
      </div>
    ...
    <div class="col-xs-6">
      ...
      <div class="fill">
        <a href="products_limited.php?category_id=2&subcategory_id=9">
              View
        </a>
      </div>
      </div>
    ...
    <div class="col-xs-6">
      ...
      <div class="fill">
        <a href="products_limited.php?category_id=5&subcategory_id=26">
              View
        </a>
      </div>
      </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="diff_views.php?topseller=1" class="wid-view-more">View All</a>
...
?>
                        ...
                        <div class="single-wid-product">
                            <a class="product-thumb" href="single.php?id=<?=$row['item_description_id']?>"><img style="max-width:100px;width:auto;height:auto" src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg" alt="<?=$item_name?>" ></a>
...
?>
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="diff_views.php?recent=1" class="wid-view-more">View All</a>
<?php
...
?>
                        ...
                        <div class="single-wid-product">
                            <a class="product-thumb" href="single.php?id=<?=$row['item_description_id']?>"><img src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg" style="max-width:100px;width:auto;height:auto" alt="<?=$item_name?>" ></a>
                            <h2><a href="single.php?id=<?=$row['item_description_id']?>"><?=$item_name?></a></h2>
...
?>    
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="diff_views.php?popular=1" class="wid-view-more">View All</a>
<?php
...
?>
                        ...
                        <div class="single-wid-product">
                            <a class="product-thumb" href="single.php?id=<?=$row['item_description_id']?>"><img style="max-width:100px;width:auto;height:autoo" src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg" alt="<?=$item_name?>" ></a>
                            <h2><a href="single.php?id=<?=$row['item_description_id']?>"><?=$item_name?></a></h2>
...
?> 
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="allitems.php?topnew=1" class="wid-view-more">View All</a>
<?php
