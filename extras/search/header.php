				...
				<div class="row">
					<div class="col-md-2 col-lg-2 col-sm-3 col-3">
						<div class="w3ls_logo_products_left">
							<h1><a href="index.php"><img src="images/logo/logo.svg" height="50px"
										style="margin-left: 0px;"></a></h1>
						</div>
					</div>
							...
							<ul style="float: right;">
								...
								<li class="cartlg">
									<form action="cart.php" method="post" class="last">
										<input type="hidden" name="cmd" value="_cart">
										<input type="hidden" name="display" value="1">
										<button class="w3view-cart" type="button" onclick="cart()" name="submit"
											value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button>
									</form>
								</li>
							</ul>
						</div>
							...
							<div class="row">
								<div class="multi-gd-img">
									<ul class="multi-column-dropdown">
										<h6>All Groceries</h6>
										<li><a
												href="products.php?category=Grocery and Gourmet Foods & subcategory=Cereal and Muesli">Dals
												& Pulses</a></li>
										<li><a
												href="products.php?category=Grocery and Gourmet Foods & subcategory=Coffee, Tea and Beverages">Coffee,
												Tea and Beverages</a></li>
										<li><a
												href="products.php?category=Grocery and Gourmet Foods & subcategory=Snack Foods">Snack
												Foods</a></li>
							...
							<div class="row">
								<div class="multi-gd-img">
									<ul class="multi-column-dropdown">
										...
										<li><a href="products.php?category=House hold & subcategory=kitchen">Kitchen</a>
										</li>
										<li><a
												href="products.php?category=House hold & subcategory=kitchen">Kitchenware</a>
										</li>
									</ul>
								</div>
