			...
			<div class="categories">
				...
				<ul class="cate">
					...
					<ul>
						...
						<li><a
								href="products.php?category=Grocery and Gourmet Foods & subcategory=Coffee, Tea and Beverages"><i
					...
					<ul>
						<li><a href="products.php?category=House hold & subcategory=kitchen"><i
									class="fa fa-arrow-right" aria-hidden="true"></i>Kitchen</a> </li>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.php?id=<?= $row['item_id'] ?>"><img title=" " alt=" "
													class="img_size"
