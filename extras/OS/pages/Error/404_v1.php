              ...
              <section class="content" style="margin-bottom: -20px">
                <div class="error-page">
                  <div class="error-content">
                    <h3><i style="color: #FFCC00" class="fas fa-exclamation-triangle text-warning"></i> Oops! Page not
                      found.</h3>
                    <!--
      <br>
  ...
  <div id="wrap">
    ...
    <div id="main-content" style="color: #335B67">
      ...
      <p>Check the URL you entered for any mistakes and try again. Alternatively, search
        for whatever is missing or take a look around the rest of our site. Go to <a href="../../../../onestore.php"
          style="color:#007BFF;;font-weight: bold;">Home Page</a>or try to <a style="color:#007BFF;font-weight: bold;"
          href="../../../../login.php">Logging in</a> .</p>
