              ...
              <section class="content" style="margin-bottom: -20px">
                <div class="error-page">
                  <div class="error-content">
                    <h3><i style="color: #FFCC00;position: relative;" class="text-warning"></i><i class="fa fa-remove"
                        style="  color: red!important;"></i> Oops! No Internet Connection.</h3>
                    <!--
      <br>
...
-->
  ...
  <div id="wrap">
    ...
    <div id="main-content" style="color: #335B67">
      ...
      <p>Please try again when you are connected to the internet. Go to <a href="../../../../onestore.php"
