        ...
        <div class="card-body">
          ...
          <form action="#" name="Verify" method="post">
            <div class="input-group mb-3 input-field">
              <input type="tel" id="otp" class="form-control validate" placeholder="OTP" maxlength="6"
                onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"
                pattern="\d{6}" title="OTP Number Format (4321)- 6 digits" required="">
            ...
            <div class="row">
              <div class="col-12">
                <div class="div-wrapper" style="display: flex;align-items: flex-end;justify-content: flex-end;">
                  <button type="button"
                    style="padding:5px;border-radius: .25rem;padding-left: 9px;padding-right: 9px;background-color: #02171e !important;border-top-right-radius:0px;border-bottom-right-radius:0px;"
                    onclick="location.href='forgot-password-v2.html'">
                    <i class="fa fa fa-arrow-left" style="color: #fff;"></i>
                  </button>
                  <button type="button" style="border-top-left-radius:0px;border-bottom-left-radius:0px;" id="otpbtn"
                    onclick="otpcheck()" class="btn btn-primary btn-block real_btn">Verify</button>
                  <button type="button" style="display:none;border-top-left-radius:0px;border-bottom-left-radius:0px;"
                    class="btn btn-primary btn-block load_btn"><i
                      class="fa fa-refresh fa-spin"></i>&nbsp;Verify</button>
                </div>
              </div>
              <!-- /.col -->
            </div>
          ...
          <p class="mt-3 mb-1">
            ...
            <a href="login-v2.html" style="float:right"><span id="expiry_caption">retry in </span><span
                id="expiry"></span></a>
          </p>
        </div>
        <!-- /.login-card-body -->
