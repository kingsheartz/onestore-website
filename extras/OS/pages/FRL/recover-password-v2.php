        ...
        <div class="card-body">
          ...
          <form action="#">
            <div class="input-group mb-3 input-field">
              ...
              <input type="password" id="pass1" class="form-control password_fields validate"
                pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
                required=" " oninput="$(this).removeClass('invalid');" placeholder="Password">
            ...
            <div class="input-group mb-3 input-field">
              <input type="password" id="pass2" class="form-control password_fields validate"
                pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
                required=" " oninput="$(this).removeClass('invalid');" placeholder="Confirm Password">
              <div class="input-group-append">
                <div class="input-group-text">
                  <span class="fas fa-lock"></span>
                </div>
            ...
            <div class="row">
              <div class="col-12">
                <button type="button" onclick="recover()" class="btn btn-primary btn-block real_btn">Change
                  password</button>
                <button type="button" style="display:none;" class="btn btn-primary btn-block load_btn"><i
                    class="fa fa-refresh fa-spin"></i>&nbsp;Change password</button>
