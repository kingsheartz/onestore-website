...
<div id="avail_stores_wishlist" tabindex="-1" role="dialog" aria-labelledby="store_title" class="modal fade modal-xl hidescroll" style="height: 90%;">
	<div class="modal-dialog modal-xl" style="height: 90%;">
		<div class="modal-content" style="height: 90%;" style="border-bottom-left-radius: 10px">
			<div class="modal-overlay" id="modal-overlay" >
				<div class="modal-header shadow_b" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #007ab7), color-stop(1, #01728e)) !important;)) !important;color: white">
					...
					<button type="button" class="close" data-dismiss="modal" style="outline: none;background-color: white;opacity: unset;color: red;margin-top: 0px;font-size: 2.3em;border-radius: 5px;padding-left:5px;padding-right: 5px; ">&times;</button>
			 		...
			 		<div class="modal-guts scroll_handle_orange" style="border-bottom-left-radius: 10px">
						<div class="model-body " style="overflow-x: scroll;margin-top: 50px;background-color: white"><br>
			 				<table  id="wishlist_store" cellspacing="50px" cellpadding="20px" width="100%" class="single_product_info" border="5px" style="overflow-x: scroll;border: 5px ;border-radius: 10px;">
							 <tbody>
			 					<tr style="border-left:white;border-right:white;border-top:white;border-left:none;border:0px;border-top: none;border-right: none;">
			 						<td colspan="9">
			 							<button  type="button" onclick="sortTable(3)" style="float: left;color: white;background-color: #F08200;border-radius: 5px;border:#ffffff" name="button">Sort by Distance</button>
                    ...
                    <div class="px-3">
                        <h4 class="m-sing">
							...
							<ul id="wishlist_item_detailed_features" style="padding-left:10px">
								<li style="font-weight:normal;font-size: 14px;">Item remaing : <span style="text-decoration: none;font-weight:normal;font-family:arial" id="dis_qnty2"></span> only</li>
								<li style="font-weight: normal;font-size: 14px;">Availability : <span style="text-decoration: none;font-weight:normal;" id="dis_avail2"></span></li>
								<li style="font-weight:normal;font-size: 14px;" >Status : <span style="text-decoration: none;font-weight:normal;"  id="dis_sts2"></span></li>
								<li style="font-weight:normal;font-size: 14px;">Address : <span style="text-decoration: none;font-weight:normal;" id="dis_add2"></span></li>
...
color: white;border-radius:7px;outline: none;" onclick="wishlist_check_store_select()" class="element_cart" type="button" data-dismiss="modal" data-toggle="modal" data-target="#wishlist_avail"> SELECT STORE <i class="fa fa-arrow-right"></i></i></button>
                      </div>
                  </div>
			</div>
				<div class="modal-footer" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #007ab7), color-stop(1, #01728e)) !important;">
...
<div id="wishlist_avail" tabindex="-1" role="dialog" aria-labelledby="store_title" class="modal fade modal-xl hidescroll" style="height: 90%;">
	<div class="modal-dialog modal-xl" style="height: 90%;">
		<div class="modal-content" style="height: 90%;" style="border-bottom-left-radius: 10px">
			<div class="modal-overlay" id="modal-overlay" >
