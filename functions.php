...
*/
//K
require_once __DIR__.'/mail/contactform/vendor/autoload.php';
require_once __DIR__.'/mail/contactform/functions.php';
require_once __DIR__.'/mail/contactform/config.php';
//K
	...
	if (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
		...
		if($row){
			...
			//EMAIL SENDING//
				...
				$activate_link = 'https://one-store.ml/functions.php?emailverified=1&email='.$_POST['email'].'&code='.$uniqid;
...
<table style="width:100%!important"> 
   <tbody>
    <tr style="" width="834px" height="60" background="https://one-store.ml/images/logo/log2.jpg" align="center"> 
     <td> 
            ...
            <tr> 
             <td style="width:35%;text-align:left"> 
              <a style="color:#027cd8;text-decoration:none;outline:none;color:#ffffff;font-size:13px" href="https://www.one-store.ml" rel="noreferrer" target="_blank" data-saferedirecturl=""> 
               <img border="0"  src="https://one-store.ml/images/logo/logo.png" alt="OneStore.ml" style="border:none" class="CToWUd"> 
              </a> 
             </td>
                        ...
                        <table style="background-color: "> 
                          <tbody>
                            <tr>
                             ...
                             <td style="width:80%;text-align:center;font-family:Arial;color: #fff"> &#169; 2020 <a style="color:#027cd8;text-decoration:none;outline:none;font-weight:bold" href="https://one-store.ml/">OneStore</a>. All rights reserved  </td> 
  ...
  if (preg_match('/^[a-zA-Z0-9]+$/', $_POST['first_name']) == 0) {
    ...
    if($current_mail!=$email){
      ...
      //EMAIL SENDING//
        ...
        $activate_link = 'https://one-store.ml/functions.php?emailupdateverified=1&emailcurrent='.$row['email'].'&emailnew='.$_POST['email'].'&code='.$uniqid.'&id='.$user_id;
        $cancel='https://one-store.ml/functions.php?emailupdateverified=0&emailcurrent='.$row['email'].'&emailnew='.$_POST['email'].'&code='.$uniqid;
	...
	if ($stmt = $pdo->prepare('SELECT * FROM users WHERE email = :email AND activation_code = :activation_code')) {
		...
		if ($row) {
			...
			if ($stmt = $pdo->prepare('UPDATE users SET activation_code = :new_code WHERE email = :email AND activation_code = :activation_code')) {
				...
				$activate_link = 'https://one-store.ml';
...
*/
        ...
        $mail->AltBody = 'HTML messaging not supported'; // If html emails is not supported by the receiver, show this body
			...
			//EMAIL SENDING//
				...
				header("location:registered.php?verified=yes");
				
				//echo '<center><h3 style="display:flex;justify-content:center;">Your account is now activated! You can now <a href="../OneStore/login.php"> login </a>!</h3><center>';
			}
		} else {
    ...
    if ($row) {
      ...
      if ($stmt = $pdo->prepare('UPDATE users SET activation_code = :new_code WHERE email = :email AND activation_code = :activation_code')) {
          ...
          $stmt->execute(array(
            ...
            ':email'=>$_GET['emailcurrent'],
            ':activation_code'=>$_GET['code']));
          header("location:edit_user_details.php?changed=no");
      }
    } 
    else{
...
*/
      ...
      //EMAIL SENDING//
        ...
        header("location:edit_user_details.php?changed=yes");
		...
		if($row){
          ...
          $_SESSION['forgot_pass_email']=$emailget;
			...
			//EMAIL SENDING//
				...
				$activate_link = 'https://one-store.ml/extras/OS/pages/FRL/OTP-v2.php?otp='.$otp;
				$message = '
...
$activate_link = 'https://one-store.ml/myorders.php?id='.$user_id;
...
$message1 = '<table style="width:100%!important"> 
   <tbody>
    <tr background="https://one-store.ml/images/logo/log2.jpg" width="834px" height="60"> 
     <td> 
      <table width="100%" cellspacing="0" cellpadding="0" height="60" style="width:600px!important;text-align:center;margin:0 auto"> 
       <tbody>
        <tr> 
            ...
            <tr> 
             <td align="left"> 
              <table width="120" border="0" cellpadding="0" cellspacing="0" align="left" style="margin-bottom: 15px;"> 
               <tbody>
                <tr> 
                 <td valign="middle" width="120" align="center"> <a style="color:#027cd8;text-decoration:none;outline:none;color:#fff;font-size:13px" href="https://one-store.ml/single.php?id='.$store_array[$l]['item_description_id'][$m].'" rel="noreferrer" target="_blank" data-saferedirecturl=""> <img border="0" src="https://one-store.ml/images/'.$store_array[$l]['item_category_id'][$m].'/'.$store_array[$l]['item_sub_category_id'][$m].'/'.$store_array[$l]['item_description_id'][$m].'.jpg" alt="'.$store_array[$l]['item_name'][$m].'" style="border:none;max-width:125px;max-height:125px;margin-top:20px" class="CToWUd"> </a> </td> 
                </tr> 
               </tbody>
              </table> 
              <table width="455" border="0" cellpadding="0" cellspacing="0" align="right"> 
               <tbody>
                <tr> 
                 ...
                 <p style="margin-bottom:13px;margin-top:20px"> <a href="https://one-store.ml/" style="font-family:Arial;font-size:14.5px;font-weight:bold;font-style:normal;font-stretch:normal;line-height:1.43;color:#15c;text-decoration:none!important;word-spacing:0.2em" rel="noreferrer" target="_blank" data-saferedirecturl=""> '.$store_array[$l]['item_name'][$m].'</a> </p>
                ...
                <tr> 
                 <td align="left" valign="top" style="color:#2c2c2c;line-height:20px;font-weight:300;background-color:transparent"> 
                  <table> 
                   <tbody>
                    <tr>
                    <td style="width:40%;text-align:left;padding-top:5px"> <a style="text-decoration:none;outline:none;color:#ffffff;font-size:13px" href="https://www.one-store.ml"><img  border="0" src="https://www.one-store.ml/images/logo/logo.png" alt="OneStore.ml" style="border:none;width: 150px;" class="CToWUd"> </a> </td> 
                     <td style="width:55%;text-align:left;font-family:Arial"> &#169; 2020 <a style="color:#027cd8;text-decoration:none;outline:none;font-weight:bold" href="https://one-store.ml/">OneStore</a>. All rights reserved  </td>
                     <td style="width:10%;text-align:right"> <a style="text-decoration:none;outline:none;color:#ffffff;font-size:13px" href="" rel="noreferrer" target="_blank" data-saferedirecturl=""> <img border="0" height="24" src="https://ci6.googleusercontent.com/proxy/3QE9kvI6a_sNZY1yz9h1e9UTtBEe6bvUPfsokYVFhigLrmrCJxcv1_CZk0b5cJWyTHa1prcEfHSGUl1QMcg36fPaTs0H7MVxDk0pgC8ujoEedjfg26Rdff_eNArN9_s=s0-d-e1-ft#http://img6a.flixcart.com/www/promos/new/20160910-183744-google-play-min.png" alt="Flipkart.com" style="border:none;margin-top:10px" class="CToWUd"> </a> </td> 
...
/*
  			require $_SERVER['DOCUMENT_ROOT'] . '/mail/Exception.php';
				...
				$mail->addAddress($email,$first_name ); // to email and name
				$mail->Subject = $subject;
				$mail->msgHTML($message1);//(file_get_contents('ordermailtouser.php'),'https://one-store.ml/' ); //$mail->msgHTML(file_get_contents('contents.html'), __DIR__); //Read an HTML message body from an external file, convert referenced images to embedded,
				$mail->AltBody = 'HTML messaging not supported'; // If html emails is not supported by the receiver, show this body
				// $mail->addAttachment('images/phpmailer_mini.png'); //Attach an image file
*/
...
$activate_link = 'https://one-store.ml/Store%20admin/index.php?id='.$user_id;				
...
$message2 = '<table style="width:100%!important"> 
   <tbody>
    <tr background="https://www.one-store.ml/images/logo/log2.jpg" width="834px" height="60"> 
     <td> 
      <table width="100%" cellspacing="0" cellpadding="0" height="60" style="width:600px!important;text-align:center;margin:0 auto"> 
       <tbody>
        <tr> 
            ...
            <tr> 
             <td align="left"> 
              <table width="120" border="0" cellpadding="0" cellspacing="0" align="left" style="margin-bottom: 15px;"> 
               <tbody>
                <tr> 
                 <td valign="middle" width="120" align="center"> <a style="color:#027cd8;text-decoration:none;outline:none;color:#fff;font-size:13px" href="single.php?id='.$store_array[$l]['item_description_id'][$m].'" rel="noreferrer" target="_blank" data-saferedirecturl=""> <img border="0" src="https://www.one-store.ml/images/'.$store_array[$l]['item_category_id'][$m].'/'.$store_array[$l]['item_sub_category_id'][$m].'/'.$store_array[$l]['item_description_id'][$m].'.jpg" alt="'.$store_array[$l]['item_name'][$m].'" style="border:none;max-width:125px;max-height:125px;margin-top:20px" class="CToWUd"> </a> </td> 
                </tr> 
               </tbody>
              </table> 
              <table width="455" border="0" cellpadding="0" cellspacing="0" align="right"> 
...
/*
        ...
        $mail = new PHPMailer;
				...
				$mail->Subject = $subject;
				$mail->msgHTML($message2);//(file_get_contents('ordermailtouser.php'),'https://one-store.ml/' ); //$mail->msgHTML(file_get_contents('contents.html'), __DIR__); //Read an HTML message body from an external file, convert referenced images to embedded,
				$mail->AltBody = 'HTML messaging not supported'; // If html emails is not supported by the receiver, show this body
				// $mail->addAttachment('images/phpmailer_mini.png'); //Attach an image file
...
$dynamic_content.="</div>";
          ...
          $dynamic_content.="<div class='d-flex align-items-center justify-content-between pt-3' style='margin-bottom: 5px;padding-left:0px !important'>
                                ...
                                <!--VIEW ITEM-->    
                                    <div class='btn-pdt_pg btn-primary-pdt_pg' onclick='location.href=\"single.php?id=".$row['item_description_id']."\"' alt='".$item_name."' style='padding: 5px;padding-top:2px;padding-bottom:2px;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #0b8a00), color-stop(1, #006d12)) !important;'>View <i class='fas fa-eye '></i>
                                    </div>
                                </div>
                                <!--ADD TO CART-->
            ...
            <tr> 
             <td align="left"> 
              <table width="120" border="0" cellpadding="0" cellspacing="0" align="left" style="margin-bottom: 15px;"> 
               <tbody>
                <tr> 
                 <td valign="middle" width="120" align="center"> <a style="color:#027cd8;text-decoration:none;outline:none;color:#fff;font-size:13px" href="https://one-store.ml/single.php?id='.$idid.'" rel="noreferrer" target="_blank" data-saferedirecturl=""> <img border="0" src="https://one-store.ml/images/'.$row['category_id'].'/'.$row['sub_category_id'].'/'.$row['item_description_id'].'.jpg" alt="'.$row['item_name'].'" style="border:none;max-width:125px;max-height:125px;margin-top:20px" class="CToWUd"> </a> </td> 
                </tr> 
               </tbody>
              </table> 
              <table width="455" border="0" cellpadding="0" cellspacing="0" align="right"> 
               <tbody>
                <tr> 
                 ...
                 <p style="margin-bottom:13px;margin-top:20px"> <a href="https://one-store.ml/" style="font-family:Arial;font-size:14.5px;font-weight:bold;font-style:normal;font-stretch:normal;line-height:1.43;color:#15c;text-decoration:none!important;word-spacing:0.2em" rel="noreferrer" target="_blank" data-saferedirecturl=""> '.$row['item_name'].'</a> </p>
...
$activate_link = 'https://one-store.ml/Store%20admin/index.php?id='.$row['store_id'];				
            ...
            <tr> 
             <td align="left"> 
              <table width="120" border="0" cellpadding="0" cellspacing="0" align="left" style="margin-bottom: 15px;"> 
               <tbody>
                <tr> 
                 <td valign="middle" width="120" align="center"> <a style="color:#027cd8;text-decoration:none;outline:none;color:#fff;font-size:13px" href="single.php?id='.$idid.'" rel="noreferrer" target="_blank" data-saferedirecturl=""> <img border="0" src="https://www.one-store.ml/images/'.$row['category_id'].'/'.$row['sub_category_id'].'/'.$idid.'.jpg" alt="'.$row['item_name'].'" style="border:none;max-width:125px;max-height:125px;margin-top:20px" class="CToWUd"> </a> </td> 
                </tr> 
               </tbody>
              </table> 
              <table width="455" border="0" cellpadding="0" cellspacing="0" align="right"> 
