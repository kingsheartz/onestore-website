...
<img id="imr<?=$row['item_description_id']?>"src="../images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg"  >
 ...
 <button type="button" style=" position: absolute;
   top: 75%;
    ...
    border: 1px solid #d4d4d4;" name="lfarr"class="left-arrow" onclick="moveleft('imsrc<?=$row['item_description_id']?>')"><i class="fas fa-chevron-right"></i></button>
<button type="button" style=" position: absolute;
   top: 75%;
    left: 0;
    z-index: 1;
    ...
    border: 1px solid #d4d4d4;"name="rfarr"class="right-arrow" onclick="moveright('imsrc<?=$row['item_description_id']?>')" style="display: none;"><i class="fas fa-chevron-left"></i></button>
