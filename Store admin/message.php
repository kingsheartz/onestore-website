...
#myNavbar2>.connect:focus, #myNavbar2>.connect:hover , #myNavbar2>.connect:active{
...
#myNavbar2>.connect:focus i, #myNavbar2>.connect:hover i{
...
.dark main header,.dark main footer{
  background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #aaaaad), color-stop(1, #676767)) !important;
}
.dark #myNavbar2>.connect:focus,.dark #myNavbar2>.connect:hover,.dark #myNavbar2>.connect:active {
    text-decoration: none;
    background-color: transparent;
    border-left: 4px solid #FF9600;
    border-right: 4px solid #FF9600;
}
.dark #myNavbar2>.connect:focus i,.dark #myNavbar2>.connect:hover i {
    color: #ff9800;
}
.dark .uppernum3{
  background: #0020ff;
}
.dark div#chat-head,.dark h4,.dark .conimg,.dark .conimg i,
.dark span,.dark span i,.dark h6,.dark button i,.dark main .triangle,.dark main .triangle1,
.dark .spdat,.dark .spdat i,.dark pre{
  background: transparent;
}
.spdat{
  color: white;
...
"></i></span><h6 style="color:white;">CONTACTS</h6></div>
    ...
    <?php
        ...
        $row1=$statement1->fetch(PDO::FETCH_ASSOC);
             ...
             <div id="<?=$row['username']?>"class="connect" onclick="getfile('<?=$row['username']?>')">
              ...
              <span class="conimg"><i id="<?=$row['username']?><?=$cn?>" class="fa fa-user-circle-o"></i> <span class="uppernum3"><?=$row1['COUNT(*)']?></span></span>
              <h6>
...
<span class="conimg" ><i class="fa fa-user-circle-o" style="color:white;"></i></span><h4><?=$_SESSION['name']?></h4>
...
if($date[0]!=$ct){
  ...
  ?><div class="clear-fix"></div><br><br><div class="date"><?=$ct?></div><br><br><div class="clear-fix"></div><?php
...
if($i==0){
  ...
  <pre><?php echo trim($row['msg']); ?></pre></div> 
