...
<input type="checkbox" id="<?=$row['list_id']?>" onclick="updatelement(<?=$row['list_id']?>,'<?=$row['title']?>')"></span>
...
<li class="list-group-item" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #00c0ef), color-stop(1, #01728e)) !important;"><div id="myDIV" class="header1">
