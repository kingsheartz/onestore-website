...
$row=$stmt->fetch(PDO::FETCH_ASSOC);
  ?>
                  ...
                  <div class="table1">
<h4 style="margin-top: 30px;margin-bottom:50px;border-bottom:  1px solid#E3E3E3;padding:10px;"><i class="fas fa-clipboard-check" style="font-size: 24px;padding-right: 12px" aria-hidden="true"></i>Selled Products </h4>
...
<h2>Total Income:<span id="sumid"><?=$row['sum(new_orders.sub_total)']?></span></h2></center>
<br><br>
