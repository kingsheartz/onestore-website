...
<!-- login -->
    ...
    <div style="background-color: rgba(0,0,0,0.55);width: 100%;height: 100%;padding-top: 30px;padding-bottom: 30px;">
		<div class="container">
				...
				<form name="login_form">
					...
					<input type="email" name="email" id="email" placeholder="Email Address" required=" " >
                        ...
                        <div class="input-group bar-srch"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top: 15px;" >  
                            ...
                            <input  type="password" id="passfir" value="" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" class="password_fields" required=" " style="margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;'">
			...
			<p><a href="registered.php">Register Here</a> (Or) go back to <a href="index.html">Home<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></p>
		</div>
    </div>   
	</div>
<!-- //login -->
