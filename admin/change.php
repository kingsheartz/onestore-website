        ...
        <div class="proupda ">
          <div class="newupdation">
            <span style="font-size: 16px;
                        ...
                        justify-content: center;
                        display: flex;">
              <h4 style="text-overflow: ellipsis;width: 400px;white-space: nowrap;overflow: hidden;">
                <?= $itna ?>
              </h4>
            </span><br>
            <form id="itemdesc">
              <div class="col-sm-12 imgdis" style="padding-top: 100px;position: relative;">
                ...
                ?>
                <button name="update_data" style="font-weight: bold;float: right;background: #1336ff;margin-right: 12px;color: white;padding: 10px;border: none;border-radius: 5px;position: absolute;right: 0;top: 10px;" onclick="showupda('itemdesc',1)">
                ...
                <div class="col-sm-12">
                  <div class="imgdis">
                    <form id="<?= $row['item_description_id'] ?>" method="post" name="<?= $row['item_description_id'] ?>">
                      ...
                      <div class="imdeta col-sm-7">
                        ...
                        <label class="checkbox">
                          <input
                            ...
                            name="check1" id="<?= $row['item_description_id'] ?>check1"
                            value="size">
                          <span>Size</span>
                          <?php
                          if ($row['size'] != 0) {
                        ...
                        <label class="checkbox">
                          <input
                            ...
                            name="check1"
                            id="<?= $row['item_description_id'] ?>check2"
                            value="color">
                          <span>Color</span>
                          <?php
                          if ($row['color'] != 0) {
                        ...
                        <label class="checkbox">
                          <input
                            ...
                            name="check1"
                            id="<?= $row['item_description_id'] ?>check3"
                            value="weight">
                          <span>Weight</span>
                          <?php
                          if ($row['weight'] != 0) {
                          ...
                          ?>
                            ...
                            <div class="form-group">
                              <input
                                ...
                                id="<?= $row['item_description_id'] ?>w1"
                                onkeyup="conca(<?= $row['item_description_id'] ?>)"
                                value="<?= $we3[0] ?>">
                              <select
                                class="form-control"
                        ...
                        <label class="checkbox">
                          <input
                            ...
                            name="check1" id="<?= $row['item_description_id'] ?>check4"
                            value="flavour">
                          <span>Flavour</span>
                          <?php
                          if ($row['flavour'] != 0) {
                        ...
                        <label class="checkbox">
                          ...
                          ?>
                            <div class="form-group">
                              <select
                                id="<?= $row['item_description_id'] ?>processor"
                        ...
                        <label class="checkbox">
                          <input
                            ...
                            name="check1"
                            id="<?= $row['item_description_id'] ?>check6"
                            value="display">
                          <span>Display</span>
                          <?php
                          if ($row['display'] != 0) {
                          ...
                          ?>
                            <div class="form-group">
                              <select
                                id="<?= $row['item_description_id'] ?>disp"
                                placeholder="display"
                                class="form-control"
                                style="display:none;width: 100%"
                                name="display">
                        ...
                        <label class="checkbox">
                          <input
                            ...
                            name="check1"
                            id="<?= $row['item_description_id'] ?>check7"
                            value="battery">
                          <span>Battery</span>
                          <?php
                          if ($row['battery'] != 0) {
                          ...
                          ?>
                            <div class="form-group">
                              <select
                                id="<?= $row['item_description_id'] ?>battery"
                                placeholder="battery"
                                class="form-control"
                                style="display:none;width: 100%"
                                name="battery">
                        ...
                        <label class="checkbox">
                          <input
                            ...
                            id="<?= $row['item_description_id'] ?>check8"
                            name="check1"
                          ...
                          ?>
                            <div class="form-group">
                              <select
                                id="<?= $row['item_description_id'] ?>internal_storage"
                                placeholder="internal_storage"
                                class="form-control"
                                style="display:none;width: 100%"
                        ...
                        <label class="checkbox">
                          <input
                            ...
                            name="check1"
                            id="<?= $row['item_description_id'] ?>check9"
                            value="brand">
                          <span>Brand</span>
                          <?php
                          if ($row['brand'] != 0) {
                          ...
                          ?>
                            <div class="form-group">
                              <select
                                id="<?= $row['item_description_id'] ?>brand"
                                placeholder="brand"
                                class="form-control"
                                style="display:none;width: 100%"
                                name="brand">
                        ...
                        <label class="checkbox">
                          <input
                            ...
                            name="check1"
                            id="<?= $row['item_description_id'] ?>check10"
                            value="material">
                          <span>Material</span>
                          <?php
                          if ($row['material'] != 0) {
                          ...
                          ?>
                            <div class="form-group">
                              <select
                                id="<?= $row['item_description_id'] ?>material"
                      ...
                      <div class="col-sm-12 subb" style="position: absolute;bottom: 100px;left: 0;padding: 0;">
                        <input type="hidden" name="check_id" value="<?= $row['item_description_id'] ?>">
                        <button
                          name="update_data"
                          style="font-weight: bold;float: right;background: green;margin-right: 12px;"
                        ...
                        <button
                          name="remove_data"
                          style="font-weight: bold;float: right;background: red;margin-right: 5px;"
                          onclick="showupda(<?= $row['item_description_id'] ?>,0)">
