...
from item where (added_date) in (
    ...
    from item
          ...
          <a href="categories.php" class="text-under" style=" color:white;   text-decoration: none;" ><span >More info</span><span><img src="images/arrow-right-circle.svg"></span></a>
        ...
        <div class="col-sm-3 cart" >
         ...
         <div class="new-text "> 
          ...
          <a href="products.php" class="text-under" style=" color:white;   text-decoration: none;" ><span >More info</span><span><img src="images/arrow-right-circle.svg"></span></a>
     ...
     <div class="col-sm-3 cart" >
         ...
         <div class="new-text "> 
          ...
          <a href="new_item.php" class="text-under" style=" color:white;   text-decoration: none;" ><span >More info</span><span><img src="images/arrow-right-circle.svg"></span></a>
       ...
       <div class="col-sm-3 cart" >
        ...
        <div class="new-text " > 
         ...
         <a href="neworders.php" class="text-under" style=" color:white;   text-decoration: none;"> <span >More info</span><span><b><img src="images/arrow-right-circle.svg"></b></span></a>
  ...
  <div class="col-lg-5 col-sm-3" style="height: 500px;
    ...
    border-top: 4px solid #2D720B;">
      ...
      <h4 style="border-bottom: 1px solid #D6D6D6;padding-bottom: 20px;padding-left: 20px;margin-bottom: 20px;"><i class="fa fa-pie-chart" style="padding-right: 20px"></i>Average Day</h4>
...
<img class="smimg"  src="../images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg">
  ...
  </div><div style="position: relative;float:left;width:100%;padding:20px">      <?=$row['item_name']?>

      <button class="price"style="background:<?=$colors[array_rand($colors)]?>;"><i class="fas fa-rupee-sign"></i> <?=$row['price']?></button>
...
data.addRows(result);
  ...
  // Optional; add a title and set the width and height of the chart
    ...
    var options = {backgroundColor: 'transparent',color:'none',position:'center',
