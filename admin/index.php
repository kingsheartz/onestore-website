...
<body>
  <div class="wrapper">
    ...
    <div class="row">
        ...
        <div class="well">
          <div class="well-box">
            <div class="well-text ">
              ...
              $catn = $cat->rowCount();
              //no of products
              $pro = $pdo->query("select * from item");
              $product = $pro->rowCount();
              //new item
              $new = $pdo->query("select  item_id from item where (added_date) in (select max(added_date) as date from item) ");
              $new_it = $new->rowCount();
              //new orders
              $stmt = $pdo->query(
          ...
          <div class="new-text ">
            <a href="categories.php" class="text-under" style=" color:white;   text-decoration: none;">
              <span>More info</span>
              <span><img src="images/arrow-right-circle.svg"></span>
            </a>
          </div>
        </div>
      </div>
      <div class="col-sm-3 cart">
        <div class="well" style="background-color: #00a65a">
          ...
          <div class="new-text ">
            <a href="products.php" class="text-under" style=" color:white;   text-decoration: none;">
              <span>More info</span>
              <span><img src="images/arrow-right-circle.svg"></span>
            </a>
          </div>
      ...
      <div class="col-sm-3 cart">
        <div class="well" style="background-color: #f39c12">
          ...
          <div class="new-text ">
            <a href="new_item.php" class="text-under" style=" color:white;   text-decoration: none;">
              <span>More info</span>
              <span><img src="images/arrow-right-circle.svg"></span>
            </a>
          </div>
      ...
      <div class="col-sm-3 cart">
        <div class="well" style="background-color: #dd4b39">
          ...
          <div class="new-text ">
            <a href="neworders.php" class="text-under" style=" color:white;   text-decoration: none;">
              <span>More info</span>
              <span><b><img src="images/arrow-right-circle.svg"></b></span>
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-5 col-sm-3" style="height: 500px;margin-top: 50px;background: #FFFFFF;padding: 0;border-top: 4px solid #2D720B;">
        <h4 style="border-bottom: 1px solid #D6D6D6;padding-bottom: 20px;padding-left: 20px;margin-bottom: 20px;">
      ...
      <div id="calendar-div" class="col-lg-5 col-sm-3" style="padding: 0;margin-top: 50px;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #00a65a), color-stop(1, #00ca6d)) !important;border-top: none;position: relative;height: 500px;   ">
        <h4 style="border-bottom: 1px solid #D6D6D6;padding-bottom: 20px;padding-left: 20px;background: #fff;margin: 0;padding-top: 10px;border-top: 4px solid #2d720b;">
          <i class="fas fa-calendar" style="padding-right: 20px"></i>Calendar
        </h4>
        <?php
          ...
          <div class="panel panel-default">
            ...
            <div id="collapse2" class="panel-collapse collapse in">
              <ul class="list-group">
                <?php
                $stmt = $pdo->query(
                  "select * from item join item_description on item_description.item_id=item.item_id where item.added_date in (select max(added_date) as date from item) LIMIT 4"
                );
                  ...
                  <li class="list-group-item" style="display: flex;">
                    ...
                    <div style="position: relative;float:left;width:100%;padding:20px"> <?= $row['item_name'] ?>
                      <button class="price" style="background:<?= $colors[array_rand($colors)] ?>;">
                        ...
                        ?>
                <li class="list-group-item" style="padding:10px;height:50px;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #00c0ef), color-stop(1, #01728e)) !important;">
