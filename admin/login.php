...
<div class="row justify-content-center">
  <div class="card col-sm-5 ">
    <form method="post" name="logfrm" id="logfrm">
      <div class="card-head">
        <i class="fas fa-user-cog" style="font-size: 40px;margin-right: 12px;float:left;color: #00bcd4;"></i> ADMIN PANEL
      </div>
      <span id="errorms">
        <?php
      ...
      <div class="card-body">
        ...
        <div class="grp">
          ...
          <i class="fas fa-info-circle" id="usin" style="display:none;position: absolute;color: red;font-size: 24px;right: 10px;"></i>
          <i class="fas fa-user-tie" id="usin2" style="position: absolute;color: #6d6d6d;font-size: 24px;right: 10px;"></i>
        </div>
        <br>
        <label> PASSWORD</label><br>
        <div class="grp">
          <input name="pass" onkeyup="change()" type="password" id="pass">
          <i class="fas fa-info-circle" id="psin" style="display:none;position: absolute;color: red;font-size: 24px;right: 10px;"></i>
          <i class="fas fa-user-lock" id="psin2" style="position: absolute;color: #6d6d6d;font-size: 24px;right: 10px;"></i>
        </div><br>
      </div>
      <div class="card-footer">
        <button type="submit" onclick="check()" class="Login">
          <span class="arrow"><i style="margin-right:12px;" class="fas fa-arrow-left"></i></span> Log In
        </button>
      </div>
    </form>
  </div>
