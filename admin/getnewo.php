...
if ($method == 'GET') {
  ...
  $query = "SELECT *  FROM new_orders
            ...
            WHERE new_ordered_products.delivery_status='pending' AND
            item.item_name LIKE :item_name AND
            new_orders.order_date LIKE :order_date AND
            store.store_name LIKE :store_name AND
            new_ordered_products.delivery_status LIKE :delivery_status AND
