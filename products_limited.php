...
function check_store_select(){
        ...
        if(flag==0){
              ...
              success: function(data){    //if registration is success
                  if(data.status=='success'){
                    ...
                    if(qnty!=0){
                      ...
                      .then((willSubmit) => {
                          if(willSubmit) {  
                              location.href="single.php?id="+item_description_id+"";
                              return;
                          }
                          else{
                              return ;
          ...
          //location.href="cart.php?store="+id+"&item=<?//=$row['item_id']?>";
        }
}
...
?>
                <div class="product-content-right">
                    ...
                    <h2 class="sidebar-title" style="text-align: center;color:#2d70ff;display: inline-flex;font-weight: 600;">No result found</h2></center>
                </div>

                <center style="margin-bottom:0px;margin-top: 50px;"><h4>Can't find requested product ?<a href="onestore.php"> Try again!</a></h4></center>
<?php
...
?>       
        <div class="ml-auto d-flex align-items-center views "> <span class="btn-pdt_pg text-success grid_view_mul gridview"> <span class="fas fa-th px-md-2 px-1"></span><span>Grid view</span> </span> 

<?php
if(isset($_GET['item'])){
?>
        <span class="btn-pdt_pg list_view_mul listview" onclick="location.href='products.php?item=<?=$_GET['item']?>'"> &nbsp; <span class="fas fa-list-ul"></span><span class="px-md-2 px-1">List view</span></span> 
<?php
}
else if (isset($_GET['category_id']) && isset($_GET['subcategory_id']) ) {
?> 
        <span class="btn-pdt_pg list_view_mul listview" onclick="location.href='products.php?category_id=<?=$_GET['category_id']?> & subcategory_id=<?=$_GET['subcategory_id']?>'"> &nbsp; <span class="fas fa-list-ul"></span><span class="px-md-2 px-1">List view</span></span> 

<?php
}
else if (isset($_GET['category_id'])){  
?>
        <span class="btn-pdt_pg list_view_mul listview" onclick="location.href='products.php?category_id=<?=$_GET['category_id']?>'"> &nbsp; <span class="fas fa-list-ul"></span><span class="px-md-2 px-1">List view</span></span> 
...
?>
        ...
        <span class="green-label px-md-2 px-1"><?=$result_cnt?></span> <span class="text-muted">Products</span> </div>
    </div>
    </div>
    <hr class="make_divb">
...
<!--FILTER-->    
    ...
    <div class="text-muted filter-label" style="padding-left: 15px;color:#ddd !important;font-size:20px;"><b>Filters</b></div>
    ...
    <!--FILTER TICKES-->    
         ...
         <div id="filter-tag" class="form-inline filter-tag d-flex align-items-center my-2 checkbox bg-light border mx-lg-2 filter-ticket" style="display:none !important;float: left;margin:0px;max-width:max-content;padding-top: 3px;padding-bottom:3px;">
  ...
  <hr  style="margin-top: 0px;margin-bottom: -10px;">
    <div class="filters" style="margin-right:0px;"> <button style="display: block;border-color:#002b41;outline:#0c99cc;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;margin-bottom:0px;height:40px;border-radius:5px" class="btn-pdt_pg btn-success" type="button" data-toggle="collapse" data-target="#mobile-filter" aria-expanded="false" aria-controls="mobile-filter"><span class="px-1 fas fa-list"></span><span class="px-1 fas fa-filter fa-lg"></span></button> 
    </div>
    <div style="clear: both;"></div>
    <div id="mobile-filter" class="collapse">
         <div class="d-lg-flex align-items-lg-center pt-2 small-sort-select" style="padding-bottom: 5px;margin-top: -15px;">
            ...
            <div class="checkbox bg-light border " style="display: flex;align-items: center;justify-content: center;padding-left: 10px !important;width:100% !important;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;border-radius: 5px;"> 
                                ...
                                <select id="mobsortall"  class="frm-field required sect" style="font-family: 'Poppins', sans-serif;height: 22px;font-size: 13px;display: flex;padding:0;border: none;width:100%;background-color: transparent;background-color: transparent;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;outline:none;color:white" onchange="sortandfilter('getsort','sort')">
...
?>
        ...
        <div class="py-3 side-nav-filters-head">
                <h5 data-toggle="collapse" data-target="#cat-filter-mob" aria-expanded="false" aria-controls="cat-filter-mob"  class="font-weight-bold side-nav-filters" style="width: 100%;color:white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #01222b)) !important;" onclick="if($('.cat-right').css('display')=='none'){$('.cat-right').show();$('.cat-down').hide();}else{$('.cat-right').hide();$('.cat-down').show();}">Categories<i class="fa fa-angle-down cat-right" style="float: right;padding-right:5px"></i><i class="fa fa-angle-up cat-down" style="float: right;display: none;padding-right:5px;border-bottom:none;"></i></h5>
...
$getsubcatqnty="SELECT count(item_description.item_description_id) as qntycnt  from item 
            ...
            where category.category_id=1 AND sub_category.sub_category_id IN (".$getcat_row['sub_category_id'].")
...
?>
                    ...
                    <li onclick="sortandfilter('getcat-<?=$getcat_row['sub_category_id']?>','category')" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category cat-font  getcat-<?=$getcat_row['sub_category_id']?>" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;color:#ddd "> <label class="options" style="display:flex;justify-content:center;align-items:center;margin-top:3px;"><span class="val-getcat-<?=$getcat_row['sub_category_id']?>"><?=$getcat_row['sub_category_name']?></span><input value="<?=$getcat_row['sub_category_name']?>" id="mobgetcat-<?=$getcat_row['sub_category_id']?>" type="radio" disabled name="mob-radio-getcat-<?=$getcat_row['sub_category_id']?>"> <span class="checkmark"></span> </label><span class="badge badge-primary badge-pill"><?=$getsubcatqnty_row['qntycnt']?></span> </li>
...
?>
            ...
            <div class="py-3 side-nav-filters-head">
                <h5 data-toggle="collapse" data-target="#brand-filter-mob" aria-expanded="false" aria-controls="brand-filter-mob"  class="font-weight-bold side-nav-filters" style="width: 100%;color:white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #01222b)) !important;" onclick="if($('.brand-right').css('display')=='none'){$('.brand-right').show();$('.brand-down').hide();}else{$('.brand-right').hide();$('.brand-down').show();}"> Brands<i class="fa fa-angle-down brand-right" style="float: right;padding-right:5px"></i><i class="fa fa-angle-up brand-down" style="float: right;display: none;padding-right:5px"></i></h5>
                <form class="brand collapse" id="brand-filter-mob"  style="">
<?php
while($getbrand_row=$brandstmt->fetch(PDO::FETCH_ASSOC)){
?>
                    <li onclick="sortandfilter('getbrand-<?=$getbrand_row['brand_id']?>','brand')" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category brand-font  getbrand-<?=$getbrand_row['brand_id']?>" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;color:#ddd "> <label class="options" style="display:flex;justify-content:center;align-items:center;margin-top:3px;"><span class="val-getbrand-<?=$getbrand_row['brand_id']?>"><?=$getbrand_row['brand_name']?></span><input value="<?=$getbrand_row['brand_id']?>" id="mobgetbrand-<?=$getbrand_row['brand_id']?>" type="radio" disabled name="mob-radio-getbrand-<?=$getbrand_row['brand_id']?>"> <span class="checkmark"></span> </label></li>
<?php
}
?> 
                </form>
...
?>
            ...
            <div class="py-3 side-nav-filters-head">
                <h5 data-toggle="collapse" data-target="#rating-filter-mob" aria-expanded="false" aria-controls="rating-filter-mob"  class="font-weight-bold side-nav-filters" style="width: 100%;color:white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #01222b)) !important;"onclick="if($('.rating-right').css('display')=='none'){$('.rating-right').show();$('.rating-down').hide();}else{$('.rating-right').hide();$('.rating-down').show();}">Rating <i class="fa fa-angle-down rating-right" style="float: right;padding-right:5px"></i><i class="fa fa-angle-up rating-down" style="float: right;display: none;padding-right:5px"></i></h5>
...
?>
            <div class="py-3 side-nav-filters-head">
                <h5 data-toggle="collapse" data-target="#mob-pricing-filter" aria-expanded="false" aria-controls="mob-pricing-filter"  class="font-weight-bold side-nav-filters" style="width: 100%;color:white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #01222b)) !important;"onclick="if($('.pricing-right').css('display')=='none'){$('.pricing-right').show();$('.pricing-down').hide();}else{$('.pricing-right').hide();$('.pricing-down').show();}">Price <i class="fa fa-angle-down pricing-right" style="float: right;padding-right:5px"></i><i class="fa fa-angle-up pricing-down" style="float: right;display: none;padding-right:5px"></i></h5>

                <form class=" pricing collapse range-field my-5" id="mob-pricing-filter"  style="margin:5px !important">
                    <div class="div-wrapper">
                    <label><h2 style="margin:0px;"><span class="badge blue lighten-2 mb-4">Minimum</span></h2>
...
?> 
                    ...
                    <label><h2 style="margin:0px;"><span class="badge blue lighten-2 mb-4">Maximum</span></h2>
...
<!--DEFAULT FILTERS-->
             <div class=" align-items-lg-center pt-2" style="padding-bottom: 0px;margin-top:15px !important">
                ...
                <div class="form-inline d-flex align-items-center my-2 checkbox bg-light border mx-lg-2" style="display: flex;align-items: center;justify-content: center;padding-left: 10px !important;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;"> 
                                    ...
                                    <select id="sortall"  class="frm-field required sect" style="font-family: 'Poppins', sans-serif;height: 22px;font-size: 13px;display: flex;padding:0;border: none;width:100%;background-color: transparent;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;outline:none;color:white" onchange="sortandfilter('getsort','sort')">
                                    <option value="default"><i class="fa fa-arrow-right" aria-hidden="true"></i>Default sorting</option>
                                    <option value="high"><i class="fa fa-arrow-right" aria-hidden="true"></i>Price high to low</option> 
                                    <option value="low"><i class="fa fa-arrow-right" aria-hidden="true"></i>Price low to high</option>					
                                    <option value="view"><i class="fa fa-arrow-right" aria-hidden="true"></i>Sort by popularity</option>							
...
?>
            ...
            <div class="py-3 side-nav-filters-head">
                <h5 data-toggle="collapse" data-target="#cat-filter" aria-expanded="false" aria-controls="cat-filter"  class="font-weight-bold side-nav-filters" style="width: 100%;color:black;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #eee), color-stop(1, #fff)) !important;" onclick="if($('.cat-right').css('display')=='none'){$('.cat-right').show();$('.cat-down').hide();}else{$('.cat-right').hide();$('.cat-down').show();}">Categories<i class="fa fa-angle-down cat-right" style="float: right;padding-right:5px"></i><i class="fa fa-angle-up cat-down" style="float: right;display: none;padding-right:5px"></i></h5>
...
?>
                   <li onclick="sortandfilter('getcat-<?=$getcat_row['sub_category_id']?>','category')" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category cat-font  getcat-<?=$getcat_row['sub_category_id']?>" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #fff), color-stop(1, #fff)) !important;color:#000 "> <label style="display:flex;justify-content:center;align-items:center;margin-top:3px;" class="options"><span class="val-getcat-<?=$getcat_row['sub_category_id']?>"><?=$getcat_row['sub_category_name']?></span><input value="<?=$getcat_row['sub_category_name']?>" id="getcat-<?=$getcat_row['sub_category_id']?>" type="radio" disabled name="radio-getcat-<?=$getcat_row['sub_category_id']?>"> <span class="checkmark"></span> </label><span class="badge badge-primary badge-pill"><?=$getsubcatqnty_row['qntycnt']?></span> </li>
<?php
}
?>
...
?>
            ...
            <div class="py-3 side-nav-filters-head">
                <h5 data-toggle="collapse" data-target="#brand-filter" aria-expanded="false" aria-controls="brand-filter"  class="font-weight-bold side-nav-filters" style="width: 100%;color:#000;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #eee), color-stop(1, #fff)) !important;" onclick="if($('.brand-right').css('display')=='none'){$('.brand-right').show();$('.brand-down').hide();}else{$('.brand-right').hide();$('.brand-down').show();}">Brands <i class="fa fa-angle-down brand-right" style="float: right;padding-right:5px"></i><i class="fa fa-angle-up brand-down" style="float: right;display: none;padding-right:5px"></i></h5>
...
?>          
                    <li onclick="sortandfilter('getbrand-<?=$getbrand_row['brand_id']?>','brand')" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category brand-font  getbrand-<?=$getbrand_row['brand_id']?>" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #fff), color-stop(1, #fff)) !important;color:#000 "> <label class="options" style="display:flex;justify-content:center;align-items:center;margin-top:3px;"><span class="val-getbrand-<?=$getbrand_row['brand_id']?>"><?=$getbrand_row['brand_name']?></span><input value="<?=$getbrand_row['brand_id']?>" id="getbrand-<?=$getbrand_row['brand_id']?>" type="radio" disabled name="radio-getbrand-<?=$getbrand_row['brand_id']?>" > <span class="checkmark"></span> </label></li>
...
?>
            ...
            <div class="py-3 side-nav-filters-head">
                <h5 data-toggle="collapse" data-target="#rating-filter" aria-expanded="false" aria-controls="rating-filter"  class="font-weight-bold side-nav-filters" style="width: 100%;color:#000;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #eee), color-stop(1, #fff)) !important;"onclick="if($('.rating-right').css('display')=='none'){$('.rating-right').show();$('.rating-down').hide();}else{$('.rating-right').hide();$('.rating-down').show();}">Rating <i class="fa fa-angle-down rating-right" style="float: right;padding-right:5px"></i><i class="fa fa-angle-up rating-down" style="float: right;display: none;padding-right:5px"></i></h5>
            ...
            <div class="py-3 side-nav-filters-head">
                <h5 data-toggle="collapse" data-target="#pricing-filter" aria-expanded="false" aria-controls="pricing-filter"  class="font-weight-bold side-nav-filters" style="width: 100%;color:#000;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #eee), color-stop(1, #fff)) !important;"onclick="if($('.pricing-right').css('display')=='none'){$('.pricing-right').show();$('.pricing-down').hide();}else{$('.pricing-right').hide();$('.pricing-down').show();}">Price <i class="fa fa-angle-down pricing-right" style="float: right;padding-right:5px"></i><i class="fa fa-angle-up pricing-down" style="float: right;display: none;padding-right:5px"></i></h5>

                <form class=" pricing collapse range-field my-5" id="pricing-filter"  style="margin:0px !important;background-color: white;">
                    <div class="div-wrapper">
                    <label style="margin:5px !important;"><h2 style="margin:0px;"><span class="badge blue lighten-2 mb-4">Minimum</span></h2>
...
?>                        
                    ...
                    <label style="margin:5px !important;"><h2 style="margin:0px;"><span class="badge blue lighten-2 mb-4">Maximum</span></h2>
