...
<!--- products --->
	<div class="products" style="padding: 0px">
			...
			if (isset($_GET['popular'])){
			 ...
			 ?>	<h3 style="text-transform:capitalize;font-weight:bold;text-align:center"><?=$head?></h3><h4></h4></div>
...
?>        	
				...
				<div style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;" class="agile_top_brands_grids">
...
?>
  ...
  justify-content: center;height: 200px;width:100%;background: white;text-align: center;">	<a class="img-cont" href="single.php?id=<?=$row['item_description_id']?>"><img title=" " alt=" " class="img_size" src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg"></a>		
											</div>
<?php
...
?>
											<p style="margin:auto;display:block;margin:0;margin-top:5px;overflow:hidden" class="name_size"><?=$item_name?></p>
												<h4 style="color:green;margin:auto;display:block;margin:0">&#8377;<?=$row['price']?> <span>&#8377;<?=$row['mrp']?></span></h4>
											</div>
...
?>
											<p style="margin:auto;display:block;margin:0;margin-top:5px;overflow:hidden" class="name_size"><?=$item_name?></p>
												<h4 style="color:green;margin:auto;display:block;margin:0">&#8377;<?=$row['price']?> </h4>
											</div>
...
<li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
    <a id="prev" href="<?php if($pageno <= 1){ echo '#'; }
		else {  $_GET['pageno'] =$pageno - 1;
 ...
 ?>      
	...
	?>
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
            <a id="next" href="<?php if($pageno >= $total_pages){ echo '#'; } else { 
				$_GET['pageno'] =$pageno + 1;
				echo  $_SERVER['SCRIPT_NAME'] . '?' . http_build_query($_GET); } ?>">Next</a>
        </li>
