			...
			<div class="w3_footer_grids">
				<div class="col-md-3 col-sm-6 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:onestoreforallyourneeds@gmail.com">onestore</a></li>
...
?>						
		...
		<div class="footer-copy">
			<div class="container">
				<p>© 2020 OneStore. All rights reserved |  <a id="me" onmouseover="$('#me').css('color','#0c99cc')" onmouseleave="$('#me').css('color','#fe9126')" href="www.one-store.com">KinGsHearTz</a></p>
			</div>
		</div>
	...
	<div class="footer-botm">
		<div class="container">
			<div class="w3layouts-foot">
				<ul>
					<li><a href="https://www.facebook.com/falconsinfoworld/" target="_blank" class="w3_agile_facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
					<li><a href="https://www.instagram.com/_k_i_n_g_s_h_e_a_r_t_z/" target="_blank" class="w3_agile_instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
					<li><a href="https://twitter.com/GovindA20531879" target="_blank" class="w3_agile_twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
					<li><a href="#" data-toggle="modal" data-target="#myModal_share_apk" onclick="copyapklink()" class="w3_agile_android" style=><i class="fa fa-android" aria-hidden="true"></i></a></li>
				</ul>
			</div>
...
<div class="div-wrapper holder" style="margin-bottom: 30px">
      ...
      <img src="images/<?=$row2['category_id']?>/<?=$row2['sub_category_id']?>/<?=$row2['item_description_id']?>.jpg">
    </div>
...
?>
    ...
    <div class="mySlides-single">
      ...
      <img src="images/<?=$row2['category_id']?>/<?=$row2['sub_category_id']?>/<?=$row2['item_description_id']?>_<?=$img_cnt_flag?>.jpg">
    </div>
...
<div class="div-wrapper sub-images" style="display: flex;">    
    ...
    <div class="column-single">
      <img class="demo-single cursor-single img-responsive product-image" src="images/<?=$row2['category_id']?>/<?=$row2['sub_category_id']?>/<?=$row2['item_description_id']?>.jpg"  onclick="currentSlide(1)" alt="<?=$row2['item_name']?>">
    </div>
...
?>
    ...
    <div class="column-single"> 
      <img class="demo-single cursor-single img-responsive product-image" src="images/<?=$row2['category_id']?>/<?=$row2['sub_category_id']?>/<?=$row2['item_description_id']?>_<?=$img_cnt_flag?>.jpg" onclick="currentSlide(<?=$img_cnt_flag+1?>)" alt="<?=$row2['item_name']?>_<?=$img_cnt_flag?>">
    </div>
    ...
    <div class="modal-dialog" style="width: 70%;height: 70%;">
      ...
      <div class="modal-content" style="width: 70%,height:70%;background-color:white;">
        <div class="modal-header" style="padding: 0px;min-height: 0px;border:0px;">
          <button type="button" style="font-size: 2.2em;margin-right: -20px;margin-top: -20px;opacity: unset;outline: none;color: white" class="close" data-dismiss="modal"><img src="images/close.png" alt="close" ></button>
        </div>
        <div class="modal-body" style="padding:0px;height: 100%;">
		 ...
		 <div class="col-md-12" style="padding: 0px;height: 100%;background-color: white">
		 	 <div class="col-md-6 hidden-xs no-padding" style="padding:0px;height: 70%"><img class="img-responsive" style="padding: 0px;padding-top: 0px;height: 400px;position: relative;" src="images/logo/store.jpg">
		 	 </div>
		 	 <div class="col-md-6">
		 		<div class="form-group" >
		 		<br>
					<img  src="images/logo/logost.svg" height="50px" ><i style="font-size: 1.6em;font-weight: bolder;font-family: sans-serif;font-style: normal;"> Log in</i><br>
					...
					<p class="capson_warning" style="display: none;float:left;color: #d9534f"><i class="fa fa-warning"></i> &nbsp;WARNING! Caps lock is ON.</p>
					 <div  id="passdiv" style="display: block;background-color: white">
		 				<div class="form-group">
							<input type="password" class="form-control  md-brdr password_fields" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required=" " placeholder="Enter  Password" name="password" id="pwd" required>
						</div>
					</div>

						 <div class="col-md-12">
						 <a href="#" data-toggle="modal" data-dismiss="modal" style="color: black">
						 	<button type="button" onclick="forgottenpass()" style="background-color: transparent;border: none;" class="frgt-pswrd">Forgot Password?</button>
						 </a>
						 	<br><br><br>
						 <button onclick="signin()" type="button" class="btn btn-primary btn-full mgbtm15 real_btn">LOGIN</button>
						 <button  type="button" style="display:none" class="btn btn-primary btn-full mgbtm15 load_btn"><i class="fa fa-refresh fa-spin"></i> LOGIN</button>

						   <a href="registered.php"> <button type="button" class="btn btn-danger btn-full mgbtm15" onclick="signup()">Sign Up</button></a><br><br>
...
<div id="avail_stores" tabindex="-1" role="dialog" aria-labelledby="store_title" class="modal fade modal-xl hidescroll" style="height: 90%;">
					...
					<button type="button" class="close" data-dismiss="modal" style="outline: none;background-color: white;opacity: unset;color: red;margin-top: 0px;font-size: 2.3em;border-radius: 5px;padding-left:5px;padding-right: 5px; ">&times;</button>
			 		...
			 		<div class="modal-guts scroll_handle_orange" style="border-bottom-left-radius: 10px">
						<div class="model-body " style="overflow-x: scroll;margin-top: 50px;background-color: white"><br>
			 				<table  id="store" cellspacing="50px" cellpadding="20px" width="100%" class="single_product_info" border="5px" style="overflow-x: scroll;border: 5px ;border-radius: 10px;">
<?php
...
?>							 
			 					<tr style="border-left:white;border-right:white;border-top:white;border-left:none;border:0px;border-top: none;border-right: none;">
			 						<td colspan="9">
			 							<button  type="button" onclick="sortTable(3)" style="float: left;color: white;background-color: #F08200;border-radius: 5px;border:#ffffff" name="button">Sort by Distance</button>
			 							<button  type="button" onclick="sortTable(2)" style="float: left;color: white;background-color: #F08200;margin-left:3px;border-radius: 5px;border:#ffffff" name="button">Sort by Price</button>
			 						</td>
								 </tr>
						 	 
							 	<tr style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;color: white"><th style="border: none;text-align:center" class="view_avail_stores">Select</th>
									...
									<th style="border: none;text-align:center" class="view_avail_stores">Direction </th></tr>
	<?php
	  $k=0;
	...
	?>
								<tr>
									<td style="padding: 0px;margin: 0px;"><!--<i style="color:#00BD16;display: none;" id="tick<?//=$row['store_id']?>" class="fa fa-check-circle ticking"></i>-->
										<input type="checkbox" id="check<?=$row['store_id']?>" name="select" class="sel_store" onclick="pricing(<?=$row['store_id']?>)" value="<?=$row['store_id']?>">
										<button id="btn<?=$row['store_id']?>" style="display: none;height: 45px;width:100%;border-color: white;background-color:#006904;color: white;border-radius:7px;outline: none; " class="element_cart real_btn<?=$row['store_id']?>"><i class="fa fa-check"></i> <i class="fas fa-store" ></i></button>
										<button style="display: none;height: 45px;width:100%;border-color: white;background-color:#006904;color: white;border-radius:7px;outline: none; " class="element_cart load_btn<?=$row['store_id']?>"><i class="fa fa-refresh fa-spin"></i> <i class="fas fa-store" ></i></button>
									</td>
									...
									<td>
										<form action="https://maps.google.com/maps" method="get" target="_blank">
											...
											<button type="submit" style="color: white;background-color: #337ab7;border-radius: 50px;width: 20px; outline: none;"><i class="fas fa-paper-plane" style="display: flex; justify-content: center;"></i></button>
										</form>
									</td>
				...
				<div class="m-sing" id="per"  style="background-color: #f2f2f2;color:black;padding-top: 7px;padding-bottom: 7px;">
                    <div class="px-3">
                        <h4 class="m-sing">
                            ...
                            <span style='font-family: arial;color:#07C103;font-weight: bold;text-decoration: none;font-size: 15px;'>You Save &#8377; <span id="save" style="text-decoration: none;font-weight: bold;color: #07C103;padding-left: 0px"></span> (<span style="text-decoration: none;font-weight: bold;color: #07C103;padding-left: 0px" id="off"></span>%)</span>
                            <br><br>
...
?>
						  ...
						  <button style="height: 45px;width:100%;border-color: white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;color: white;border-radius:7px;outline: none; " onclick="check_store_select()"><i class="fa fa-cart-plus"></i>&nbsp;ADD TO CART</button>
                      </div>
                  </div>
			</div>
				<div class="modal-footer" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #007ab7), color-stop(1, #01728e)) !important;">
					<button type="button" class="btn btn-default" data-dismiss="modal" style="outline: none;font-size: 1.2em;">Close <i style="color: red" class="fa fa-times-circle"></i></button>
				</div>
			</div>	
		</div>
	</div>
			...
			<div class="modal-overlay" id="modal-overlay" >
				<div class="modal-header shadow_b" style="background-color: #337ab7;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #007ab7), color-stop(1, #01728e)) !important;color: white">
					...
					<button type="button" class="close" data-dismiss="modal" style="outline: none;background-color: white;opacity: unset;color: red;margin-top: 0px;font-size: 2.3em;border-radius: 5px;padding-left:5px;padding-right: 5px; ">&times;</button>
			 		...
			 		<div class="modal-guts scroll_handle_orange" style="border-bottom-left-radius: 10px">
						<div class="model-body " style="overflow-x: scroll;margin-top: 50px;background-color: white"><br>
			 				<table  id="store_wishlist" cellspacing="50px" cellpadding="20px" width="100%" class="single_product_info" border="5px" style="overflow-x: scroll;border: 5px ;border-radius: 10px;">
<?php
$rows=$result->rowCount();
if(!is_null($rows) && $rows>0){
?>								 
	...
	?>
								<tr>
									<td style="padding: 0px;margin: 0px;"><!--<i style="color:#00BD16;display: none;" id="tick<?//=$row['store_id']?>" class="fa fa-check-circle ticking"></i>-->
										<input type="checkbox" id="wishlist_check<?=$row['store_id']?>" name="select" class="sel_store2" onclick="wishlist_pricing(<?=$row['store_id']?>)" value="<?=$row['store_id']?>">
										<button id="wishlist_btn<?=$row['store_id']?>" style="display: none;height: 45px;width:100%;border-color: white;background-color:#006904;color: white;border-radius:7px;outline: none; "  class="element_cart2" type="button"><i class="fa fa-check"></i> <i class="fas fa-store" ></i></button>
									</td>
									<td style="background-color: white" class="view_avail_stores"><?=$row['store_name']?></td>
									<td style="background-color: white" class="view_avail_stores">₹<?=$row['price']?></td>
									<!--<td id="Q<?=$store_id?>"><?//=$row['quantity']?></td>-->
				...
				<div class="m-sing" id="per2"  style="background-color: #f2f2f2;color:black;padding-top: 7px;padding-bottom: 7px;;">
                    <div class="px-3">
                        <h4 class="m-sing">
                            ...
                            <span style='font-family: arial;color:#07C103;font-weight: bold;text-decoration: none;font-size:15px'>You Save &#8377; <span id="save2" style="text-decoration: none;font-weight: bold;color: #07C103;padding-left: 0px"></span> (<span style="text-decoration: none;font-weight: bold;color: #07C103;padding-left: 0px" id="off2"></span>%)</span>
                            <br><br>
                            <li style="font-weight:normal;font-size: 14px;">Item remaing : <span style="text-decoration: none;font-weight:normal;font-size: 14px;font-family:arial" id="dis_qnty2"></span> only</li>
                            <li style="font-weight: normal;font-size: 14px;">Availability : <span style="text-decoration: none;font-weight:normal;font-size: 14px;" id="dis_avail2"></span></li>
                            <li style="font-weight:normal;font-size: 14px;" >Status : <span style="text-decoration: none;font-weight:normal;font-size: 14px;"  id="dis_sts2"></span></li>
                            <li style="font-weight:normal;font-size: 14px;">Address : <span style="text-decoration: none;font-weight:normal;font-size: 14px;" id="dis_add2"></span></li>
...
?>
						  ...
						  <button class="wishlist_btn" style="height: 45px;width:100%;border-color: white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;color: white;border-radius:7px;outline: none;" onclick="wishlist_check_store_select()" class="element_cart" type="button" data-dismiss="modal" data-toggle="modal" data-target="#avail_wishlist"> SELECT STORE <i class="fa fa-arrow-right"></i></i></button>
                      </div>
                  </div>
			</div>
...
<div id="avail_wishlist" tabindex="-1" role="dialog" aria-labelledby="store_title" class="modal fade modal-xl hidescroll" style="height: 90%;">
	<div class="modal-dialog modal-xl" style="height: 90%;">
		<div class="modal-content" style="height: 90%;" style="border-bottom-left-radius: 10px">
			<div class="modal-overlay" id="modal-overlay" >
				<div class="modal-header shadow_b" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;color: white">
					...
					<button type="button" class="close" data-dismiss="modal" style="outline: none;background-color: white;opacity: unset;color: red;margin-top: 0px;font-size: 2.3em;border-radius: 5px;padding-left:5px;padding-right: 5px; ">&times;</button>
			 		...
			 		<div class="modal-guts scroll_handle_orange" style="border-bottom-left-radius: 10px">
						<div class="model-body " style="overflow-x: scroll;margin-top: 50px;background-color: white"><br>
			 				<table  id="list_wishlist" cellspacing="50px" cellpadding="20px" width="100%" class="single_product_info" border="5px" style="overflow-x: scroll;border: 5px ;border-radius: 10px;">
<?php
$rows=$result->rowCount();
if(!is_null($rows) && $rows>0){
?>							 	 
							 	<tr style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;color: white"><th style="border: none;" class="view_avail_stores">Select</th>
									...
									<th style="border: none;" class="view_avail_stores">Created on </th></tr>
	<?php
	...
	?>
								<tr>
									<td style="padding: 0px;margin: 0px;">
										<button id="list_btn<?=$row['wishlist_id']?>" style="height: 45px;width:100%;border-color: white;background-color:#006904;color: white;border-radius:7px;outline: none;display:unset; " onclick="wishlist_check_list_select(<?=$row['wishlist_id']?>)">Add <i class="fa fa-heart" ></i></button>
									</td>
									...
									<!--<td id="Q<?=$store_id?>"><?//=$row['quantity']?></td>-->
									<td style="background-color: white" id="wish_cnt_<?=$row['wishlist_id']?>" class="view_avail_stores"><?=$row_wish1['item_count']?></td>
<?php
...
?>
				...
				<button type="button" class="btn btn-default" data-dismiss="modal" data-toggle="modal" data-target="#avail_stores_wishlist" style="outline: none;font-size: 1.2em;float:left;background-color:#22374e"><i style="color: #fff" class="fa fa-arrow-left fa-lg"></i></button>
					<button type="button" class="btn btn-default" data-dismiss="modal" style="outline: none;font-size: 1.2em;">Close <i style="color: red" class="fa fa-times-circle"></i></button>
				</div>
			</div>	
		</div>
			...
			<div class="modal-overlay" id="modal-overlay" >
				<div class="modal-header shadow_b" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #007ab7), color-stop(1, #01728e)) !important;color: white">
					...
					<button type="button" class="close" data-dismiss="modal" style="outline: none;background-color: white;opacity: unset;color: red;margin-top: 0px;font-size: 2.3em;border-radius: 5px;padding-left:5px;padding-right: 5px; ">&times;</button>
			 		...
			 		<div class="modal-guts scroll_handle_orange" style="border-bottom-left-radius: 10px">
						<div class="model-body " style="overflow-x: scroll;margin-top: 50px;background-color: white"><br>
			 				<table  id="store_buynow" cellspacing="50px" cellpadding="20px" width="100%" class="single_product_info" border="5px" style="overflow-x: scroll;border: 5px ;border-radius: 10px;">
<?php
$rows=$result->rowCount();
if(!is_null($rows) && $rows>0){
?>								 
	...
	?>
								<tr>
									<td style="padding: 0px;margin: 0px;"><!--<i style="color:#00BD16;display: none;" id="tick<?//=$row['store_id']?>" class="fa fa-check-circle ticking"></i>-->
										<input type="checkbox" id="buynow_check<?=$row['store_id']?>" name="select" class="sel_store3" onclick="buynow_pricing(<?=$row['store_id']?>)" value="<?=$row['store_id']?>">
										<button id="buynow_btn<?=$row['store_id']?>" style="display: none;height: 45px;width:100%;border-color: white;background-color:#006904;color: white;border-radius:7px;outline: none; "  class="element_cart3" type="button"><i class="fa fa-check"></i> <i class="fas fa-store"></i></button>
									</td>
									<td style="background-color: white" class="view_avail_stores"><?=$row['store_name']?></td>
									<td style="background-color: white" class="view_avail_stores">₹<?=$row['price']?></td>
									<!--<td id="Q<?=$store_id?>"><?//=$row['quantity']?></td>-->
				...
				<div class="m-sing" id="per3"  style="background-color: #f2f2f2;color:black;padding-top: 7px;padding-bottom: 7px;">
                    <div class="px-3">
                        <h4 class="m-sing">
                            ...
                            <span style='font-family: arial;color:#07C103;font-weight: bold;text-decoration: none;font-size: 15px;'>You Save &#8377; <span id="save3" style="text-decoration: none;font-weight: bold;color: #07C103;padding-left: 0px"></span> (<span style="text-decoration: none;font-weight: bold;color: #07C103;padding-left: 0px" id="off3"></span>%)</span>
                            <br><br>
                            <li style="font-weight:normal;font-size: 14px;">Item remaing : <span style="text-decoration: none;font-weight:normal;font-family:arial" id="dis_qnty3"></span> only</li>
                            <li style="font-weight: normal;font-size: 14px;">Availability : <span style="text-decoration: none;font-weight:normal;" id="dis_avail3"></span></li>
                            <li style="font-weight:normal;font-size: 14px;" >Status : <span style="text-decoration: none;font-weight:normal;"  id="dis_sts3"></span></li>
                            <li style="font-weight:normal;font-size: 14px;">Address : <span style="text-decoration: none;font-weight:normal;" id="dis_add3"></span></li>
...
?>
						  ...
						  <button class="buynow_btn" style="height: 45px;width:100%;border-color: white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;color: white;border-radius:7px;outline: none;" onclick="buynow_place_order_select()" class="element_cart" type="button" data-dismiss="modal" data-toggle="modal" data-target="#avail_buynow"> PLACE ORDER &nbsp;<i class="fa fa-shopping-bag"></i></i></button>
                      </div>
                  </div>
			</div>
				<div class="modal-footer" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #007ab7), color-stop(1, #01728e)) !important;">
      ...
      <div class="modal-content">
        <div class="modal-header item_share_header" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #004114), color-stop(1, #309700)) !important;">
          ...
          <h4 class="modal-title">
          	...
          	<span style="color: #fff"> Share Apk <i class="fa fa-android"></i></span></h4>
        </div>
        <div class="modal-body">
        	<center>
        		<div style="background-color: rgba(255,255,255);padding: 10px;display: inline-block;border-radius: 50%;margin-top: 0px;border:3px solid #018a2a;height:100px;width">
					...
					<tr>						
						<td>
							<div  class="input-group bar-srch"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 0px;" > 
								<input readonly="true" type="text" class="" id="input_apk_link"  placeholder="URL to share" value="https://one-store.ml/extras/APK/RELEASE/OneStore_version_high.apk" name="" required=" " style="width: 100%;margin: 0px;z-index: 0;border-radius: 3px;border-top-right-radius: 0px;border-bottom-right-radius: 0px;outline-color: #e59700;">
														
								<span id="" class="input-group-btn" >
										<button id="copy_wl" onclick="apkclipboard()"  style="color: white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #004114), color-stop(1, #309700)) !important;padding-top:10px;padding-bottom: 10px;outline: none;border-radius: 0;border-bottom-right-radius: 3px;border-top-right-radius: 3px;" class="btn btn-default search_btn" type="button"><span class="fas fa-copy"></span></button>
								</span>
							</div>
						</td>
					</tr>
									...
									<table style="width: 100%;">
										<tr style="overflow-x: scroll;">
											<td class="social-share " style="text-align: left;" >
												<div onclick="$('.apk').removeClass('selected');$(this).addClass('selected');copyapklink(1)" class="apk" style="margin-left:20px;width: 30px;height: 30px;background-color: #1da1f2;border-radius:3px;display: flex;align-items: center;justify-content: center;">
													<i class="fa fa-mobile fa-lg" style="color: white;"></i>
												</div>	
												<p><i class="fa fa-arrow-up" style="color:#348f00"></i> Android 9</p>
											</td>
											<td class="social-share " style="text-align: left;">
												<div onclick="$('.apk').removeClass('selected');$(this).addClass('selected');copyapklink(2)" class="apk" style="margin-left:20px;width: 30px;height: 30px;background-color: #0077af;border-radius:3px;display: flex;align-items: center;justify-content: center;">
													<i class="fa fa-mobile fa-lg" style="color: white;"></i>
												</div>	
...
if(n==1){
	var link="https://one-store.ml/extras/APK/RELEASE/OneStore_version_high.apk";
}
else if(n==2){
	var link="https://one-store.ml/extras/APK/RELEASE/OneStore_version_low.apk";
}
else{
	var link="https://one-store.ml/extras/APK/RELEASE/OneStore_version_low.apk";
}
    ...
    <div class="modal-dialog modal-m" style="background-color: white;border-radius: 7px;">
      ...
      <div class="modal-content">
        <div class="modal-header item_share_header" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #004114), color-stop(1, #309700)) !important;">
          ...
          <h4 class="modal-title">
          	<span class="fa fa-info-circle fa-lg" style="color: #fff;"></span>
          	<span style="color: #fff"> Share this item </span></h4>
        </div>
        <div class="modal-body">
        	<center>
            ...
            <form action="#" method="post" enctype="multipart/form-data">
				<table style="background-color: #fff;width: 100%" class="create_wishlist_table">
					...
					<tr>						
						<td>
							<div  class="input-group bar-srch"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 0px;" > 
								<input readonly="true" type="text" class="" id="input_link"  placeholder="URL to share" value="" name="" required=" " style="width: 100%;margin: 0px;z-index: 0;border-radius: 3px;border-top-right-radius: 0px;border-bottom-right-radius: 0px;outline-color: #e59700;">
														
								<span id="" class="input-group-btn" >
										<button id="copy_wl" onclick="clipboard()"  style="color: white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #004114), color-stop(1, #309700)) !important;padding-top:10px;padding-bottom: 10px;outline: none;border-radius: 0;border-bottom-right-radius: 3px;border-top-right-radius: 3px;" class="btn btn-default search_btn" type="button"><span class="fas fa-copy"></span></button>
								</span>
							</div>
						</td>
					</tr>
...
///////////WHATSAPP///////////
  ...
  var wa_content='<div style="margin:auto;width: 30px;height: 30px;background-color: darkgreen;border-radius:3px;display: flex;align-items: center;justify-content: center;"><a target="_blank" data-action="share/whatsapp/share" href="https://api.whatsapp.com/send?text=See this product :- https://one-store.ml/single.php?id='+code[1]+'"><i class="fa fa-whatsapp fa-lg" style="color: white;"></i></a></div><p>Whatsapp</p>';
