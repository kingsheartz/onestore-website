...
#sidebar ul li ul li a:hover {
    ...
    font-size: 1.5em;"><img class="img-responsive" src="images/logo\logo-high.png"></p><p style="text-decoration: none;
    ...
    -webkit-font-smoothing: antialiased"></i> Online</p>
      ...
      <li id="selledproductsphp"><a href="selledproducts.php"><span class="icons"><img src="images/check-all.svg"></span> <span class="nav_text">Completed Orders</span><span style="float: right;"><i class="fa fa-angle-right"></i></span></a></li>
       ...
       <span class="nav_text"> Add Features</span><span style="float: right;"><i id="featic" class="fa fa-angle-right"></i></span></a>
    ...
    <li id="updatepassphp"><a href="updatepass.php"><span class="icons"><img src="images/key-fill.svg"></span><span class="nav_text">Password</span><span style="float: right;"><i class="fa fa-angle-right"></i></span></a></li>
         ...
         <span style="float: right;"><i class="fa fa-angle-right"></i></span></a></li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <button class="btn btn-dark d-inline-block d-lg-none ml-auto  visible-xs" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    padding-right: 8px;"></i>Home</a>
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="request.php">
                                    ...
                                    <i class="fa fa-bell" style="font-size: 20px; color:coral;  "></i><span class="uppernum"><?=$row['COUNT(*)']?></span>Requests</a>
