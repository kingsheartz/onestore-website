...
"></i></span><h6 style="color:white;font-size:16px">CONTACTS</h6></div>
    ...
    <?php
            ...
            while($row=$query->fetch(PDO::FETCH_ASSOC)){
             ...
             <div id="<?=$row['username']?>"class="connect" onclick="getfile('<?=$row['username']?>')">
              ...
              <span class="conimg"><i id="<?=$row['username']?><?=$cn?>" class="fa fa-user-circle-o"></i> <span class="uppernum3"><?php
