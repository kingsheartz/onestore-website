...
<?php
if (isset($_POST['pr_id'])||isset($_POST['im_url'])||isset($_POST['name'])||
...
<input name="price" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"style="    width: 100%;
    height: 40px;
    border-radius: 5px;
...
<img id="imr<?=$row['item_description_id']?>" src="../images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg"  >
 ...
 <input type="hidden" name="imfinm" value="../images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg">
 ...
 <button type="button" name="lfarr"class="left-arrow" onclick="moveleft('imsrc<?=$row['item_description_id']?>')"><i class="fas fa-chevron-right"></i></button>
<button type="button"name="rfarr"class="right-arrow" onclick="moveright('imsrc<?=$row['item_description_id']?>')" style="display: none;"><i class="fas fa-chevron-left"></i></button>
...
<?php
  ...
  ?>
<div class="form-group">
  <select id="<?=$row['item_description_id']?>size" class="form-control" style="display:none;width: 100%"name="size" >
...
<div class="form-group">
   ...
   <option style="background:<?=$row1['color_name']?>" value="<?=$row1['color_id']?>"><?=$row1['color_name']?></option>
    <?php
     $cat=$pdo->query("select * from color");           

      while($row2=$cat->fetch(PDO::FETCH_ASSOC)){
    ?>
<option style="background:<?=$row2['color_name']?>" value="<?=$row2['color_id']?>"><?=$row2['color_name']?></option>
<?php
...
<?php
  ...
  ?>
  <div class="form-group">
   <select id="<?=$row['item_description_id']?>color" placeholder="color"class="form-control" style="display:none;width: 100%"name="color">
   <option value="">Select...</option>
    <?php
     $cat=$pdo->query("select * from color");           
...
<div class="form-group">
        <input   type="number" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"class="form-control" style="width:70%;border-right:none;
        float:left;" id="<?=$row['item_description_id']?>w1" onkeyup="conca(<?=$row['item_description_id']?>)" value="<?=$we3[0]?>">
        <select class="form-control" style="width:30%;float:left;color: white;background: #0B7383" id="<?=$row['item_description_id']?>w2" onchange="conca(<?=$row['item_description_id']?>)">
...
<?php
  ...
  <div class="form-group" >
        ...
        <select class="form-control" style="display:none;width:30%;float:left;color: white;background: #0B7383" id="<?=$row['item_description_id']?>w2" onchange="conca(<?=$row['item_description_id']?>)">
        <option value="kg">kg</option>
                <option value="g">g</option>
        <option value="lt">lt</option>
        <option value="ml">ml</option>
...
<label class="checkbox">
  <input type="checkbox" class="form-control-check" 
  onclick="$('#<?=$row['item_description_id']?>flavour').toggle();$('#<?=$row['item_description_id']?>flavour1').toggle()" name="check1" id="<?=$row['item_description_id']?>check4" value="flavour"><span>Flavour</span>
  <?php
if ($row['flavour']!=0) {
...
<?php
  ...
  ?>
  <div class="form-group">
   <select id="<?=$row['item_description_id']?>flavour"  class="form-control" style="display:none;width: 100%"name="flavour">
      <option value="">Select...</option>
     <?php
     $cat=$pdo->query("select * from flavour");           
...
<label class="checkbox">
  <input type="checkbox" class="form-control-check" 
  onclick="$('#<?=$row['item_description_id']?>processor').toggle();$('#<?=$row['item_description_id']?>processor1').toggle()" name="check1" id="<?=$row['item_description_id']?>check5" value="processor"><span>Processor</span>
  <?php
if ($row['processor']!=0) {
...
<?php
  ...
  ?>
  <div class="form-group">
   <select id="<?=$row['item_description_id']?>processor" placeholder="processor"class="form-control" style="display:none;width: 100%"name="processor">
      <option value="">Select...</option>
   <?php
     $cat=$pdo->query("select * from processor");           
...
<?php
  ...
  ?>
  <div class="form-group">
   <select id="<?=$row['item_description_id']?>disp" placeholder="display"class="form-control" style="display:none;width: 100%"name="display">
      <option value="">Select...</option>
    <?php
     $cat=$pdo->query("select * from display");           
...
<label class="checkbox">
  ...
  name="check1" id="<?=$row['item_description_id']?>check7" 
  value="battery"><span>Battery</span>
  <?php
if ($row['battery']!=0) {
...
<?php
  ...
  ?>
  <div class="form-group">
   <select id="<?=$row['item_description_id']?>battery" placeholder="battery"class="form-control" style="display:none;width: 100%"name="battery">
      <option value="">Select...</option>
   <?php
     $cat=$pdo->query("select * from battery");           
...
<label class="checkbox">
  <input type="checkbox" class="form-control-check"
   onclick="$('#<?=$row['item_description_id']?>internal_storage').toggle();$('#<?=$row['item_description_id']?>internal_storage1').toggle()"
     id="<?=$row['item_description_id']?>check8"name="check1" value="internal_storage"><span>Internal storage</span>
     <?php
...
<div class="form-group">
   <select id="<?=$row['item_description_id']?>internal_storage" class="form-control" name="internal_storage">
   <option value="<?=$row1['internal_storage_id']?>"><?=$row1['internal_storage_name']?></option>
    <?php
     $cat=$pdo->query("select * from internal_storage");           

      while($row2=$cat->fetch(PDO::FETCH_ASSOC)){
    ?>
<option value="<?=$row2['internal_storage_id']?>"><?=$row2['internal_storage_name']?></option>
<?php
...
<?php
  ...
  ?>
  <div class="form-group">
   <select id="<?=$row['item_description_id']?>internal_storage" placeholder="internal_storage"class="form-control" style="display:none;width: 100%"name="internal_storage">
      <option value="">Select...</option>
   <?php
     $cat=$pdo->query("select * from internal_storage");           
...
<div class="form-group">
  <span id="<?=$row['item_description_id']?>brand" class="floating-label" id="<?=$row['item_description_id']?>brand1">Brand</span>
...
<?php
  ...
  ?>
  <div class="form-group">
   <select id="<?=$row['item_description_id']?>brand" placeholder="brand"class="form-control" style="display:none;width: 100%"name="brand" >
      <option value="">Select...</option>
   <?php
     $cat=$pdo->query("select * from brand where category_id=".$row['category_id']);           
...
<label class="checkbox">
  ...
  onclick="$('#<?=$row['item_description_id']?>material').toggle();$('#<?=$row['item_description_id']?>material1').toggle()"
   name="check1" id="<?=$row['item_description_id']?>check10"value="material"><span>Material</span>
...
<?php
  ...
  ?>
  <div class="form-group">
   <select id="<?=$row['item_description_id']?>material" placeholder="material"class="form-control" style="display:none;width: 100%"name="material">
      <option value="">Select...</option>
   <?php
     $cat=$pdo->query("select * from material");           
...
<button  name="update_data" style="font-weight: bold;
    float: right;
    background: green;
    margin-right: 12px;" onclick="showupda(<?=$row['item_description_id']?>,1)" ><i class="fas fa-pen-alt" style="margin-right: 20px;float: left;font-size: 24px" ></i>Update</button>
<button  name="remove_data" style="font-weight: bold;
    float: right;
    background: red;
    margin-right: 5px;" onclick="showupda(<?=$row['item_description_id']?>,0)"><i class="fas fa-trash" style="margin-right: 20px;float: left;font-size: 24px"></i>Remove</button>
</div>
