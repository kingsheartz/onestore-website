...
for ($i=1; $i <= 9; $i++) { 
  ...
  if (!isset($_POST['size'.$i])||!isset($_POST['color'.$i])||!isset($_POST['weight'.$i])||!isset($_POST['flavour'.$i])||!isset($_POST['processor'.$i])||!isset($_POST['display'.$i])||!isset($_POST['battery'.$i])||!isset($_POST['internal_storage'.$i])||!isset($_POST['brand'.$i])||!isset($_POST['material'.$i]))continue;
