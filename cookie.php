...
<!-- Modal -->
<div class="modal fade" id="cookiemodal" tabindex="-1" data-keyboard="false" data-backdrop="static" role="dialog" aria-labelledby="myModalLabel" style="height:max-content">
  <div class="modal-dialog modal-lg mod_th" role="document" style="background-color:white;border-radius:5px;height:max-content">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" style="margin-top:5px" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">�</span></button>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn btn-primary" style="font-size:14px" onclick="setcookie(2)" data-dismiss="modal">Confirm my choices</button>
