         ...
         <td align="center" valign="top" bgcolor="#fff"> 
          ...
          <table border="0" cellpadding="0" cellspacing="0" style="width:640px;max-width:640px;padding-right:20px;padding-left:20px;background-color:#fff;padding-top:5px;padding-bottom: 15px;"> 
           <tbody>
            ...
            <table width="640">
                <tr>
                    <td><p style="font-family:Arial;font-size:12px;text-align:left;color:#212121;padding-left:15px;padding-top:0px;padding-bottom:2px;line-height:19px;padding-right:10px;text-align: justify;"> Note: The activation code / button will be de-activate once it is clicked and once activated your account , it won't be required anymore .Thanks for your support and also for being a member of our family .</p>
                </td>
                </tr>
            </table>
