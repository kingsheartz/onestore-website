        ...
        <tr> 
         <td> 
          <table style="width:640px;max-width:640px;padding-right:20px;padding-left:20px"> 
           <tbody>
            <tr> 
             <td style="width:40%;text-align:left;padding-top:5px"> <a style="text-decoration:none;outline:none;color:#ffffff;font-size:13px" href="https://www.one-store.ml"><img  border="0" src="../../images/logo/logo-high.png" alt="OneStore.ml" style="border:none;width: 150px;" class="CToWUd"> </a> </td> 
            ...
            <tr> 
             <td align="left"> 
              ...
              <table width="230" border="0" cellpadding="0" cellspacing="0" align="right"> 
               <tbody>
                <tr> 
                 <td valign="top"> <p style="font-family:Arial;color:#747474;font-size:11px;font-weight:normal;text-align:right;font-style:normal;line-height:1.1;font-stretch:normal;margin-top:7px;padding-top:0px;color:#878787">User ID <span style="font-weight:bold;color:#000">onestore<?=$user_id?></span> </p> <p style="font-family:Arial;font-size:11px;color:#878787;line-height:1.22;text-align:right;padding-top:0px">Order ID <span style="font-weight:bold;color:#000">OD<?=$order_id?></span> </p> </td> 
                </tr> 
               </tbody>
              </table> </td> 
            </tr> 
...
$message .= '<div style="background-color:#02171e;width: 100%"><img style="width: 250px; " src="https://one-store.ml/images/logo/logo-high.png"></div><br>';
...
$message .=  '<div class="product_img" style="padding: 0px;padding-left:5px;"><p class="product-thumbnail" style="text-align:right;">
        <a href="https://one-store.ml/single.php?id='.$store_array[$l]['item_id'][$m].'">
          <img width="100" height="100" alt="poster_1_up" class="shop_thumbnail" src="https://one-store.ml/images/'.$store_array[$l]['item_category_id'][$m].'/'.$store_array[$l]['item_sub_category_id'][$m].'/'.$store_array[$l]['item_id'][$m].'.jpg"></a></p></div></div></td></div></tr></div></div></div></center></table>';
...
$message .= '<div style="padding-left: 5px;padding-right: 5px"><p>Please click the following button to check your orders</p><br>
        ...
        <p><center>&#169; 2020 <a style="color:0c99cc;text-decoration:none" href="https://one-store.ml/">OneStore</a>. All rights reserved </center></p></div>';
$message .= '</div><br></body></html>';
        ...
        $mail->msgHTML($message);//(file_get_contents('ordermailtouser.php'),'https://one-store.ml/' ); //$mail->msgHTML(file_get_contents('contents.html'), __DIR__); //Read an HTML message body from an external file, convert referenced images to embedded,
