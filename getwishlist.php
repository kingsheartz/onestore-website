...
?>
	...
	<tr class="wltr" onclick="location.href='wishlist_public.php?wishlist_id=<?=$row['wishlist_id']?>'">
<?php
...
?>
			<td><h4 title="<?=$row['first_name']?>"><?=$listownername?></h4></td>
			<td><h4 title="<?=$row['list_name']?>"><?=$listname?></h4></td>
...
?>
<tr class="wltr"><td style="padding:10px" colspan="4">No Matches Found</td></tr>
<?php
	}
}
