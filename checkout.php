...
?>
					<tr class="rem1">
						...
						<td class="invert-image" style=" "><a href="single.php?id=<?=$row['item_description_id']?>"><img src="images\<?=$row['category_id']?>\<?=$row['sub_category_id']?>\<?=$row['item_description_id']?>.jpg" alt=" " class="img-responsive" /></a></td>
                        <td class="invert">
...
?>
                                    ...
                                    <li><i style="font-weight: bolder;font-family:sans-serif; ;color: black;font-style: unset;">Total <i>-</i> </i><span style="font-weight: bolder;font-family:sans-serif; ;color: black;">&#8377;<?=$total_amt?></span></li><hr>
                                    </div><br>
                                ...
                                <div id="customer_details" class="col2-set" style="margin:6px;padding: 0px;width: 100%">
                                    ...
                                    <div class="col-sm-5" >
                                        ...
                                        <div id="payment">
                                            ...
                                            <div class="form-row place-order" style="width: 100%">
                                                 <button class="load_btn place_order" data-value="Place order" style="display:none;width: 100%;font-weight:bold" name="woocommerce_checkout_place_order" type="button" ><i class="fa fa-refresh fa-spin"></i>&nbsp;PLACE ORDER</button>
											</div>
                                            <div class="clear"></div>
                                        </div>
                                    </div>
...
.then((willSubmit) => {
    if (willSubmit.dismiss) {
        ...
        $.ajax({
            ...
            data: {"placeorder":1,"user":1,"user_id":uid,"order_notes":order_notes,"pdt_cnt":pdt_cnt,"total_amt":total_amt},  //form data
            type: "post",   //post data
