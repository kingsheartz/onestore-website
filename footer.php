        ...
        <div class="modal-body" style="padding:0px;height: 100%;">
		 ...
		 <div class="col-md-12" style="padding: 0px;height: 100%;background-color: white">
		 	 ...
		 	 <div class="col-md-6">
		 		...
		 		<br>
					<img  src="images/logo/logost.svg" height="50px" ><i style="font-size: 1.6em;font-weight: 800;font-family: 'Open Sans', sans-serif;font-style: normal;"> Log in</i><br>
					...
					<input type="hidden" id="valchg">
					 ...
					 <div  id="passdiv" style="display: block;background-color: white">
		 				<div class="form-group">
							<input type="password" class="form-control  md-brdr password_fields" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Enter  Password" name="password" id="pwd" required>
						</div>
					</div>
...
?>							 
							 	...
							 	<tr style="background-color: #22374e;color: white"><th style="border: none;" class="view_avail_stores">Select</th>
									...
									<th style="border: none;" class="view_avail_stores">Direction </th></tr>
	<?php
	...
	?>
								<tr>
									<td style="padding: 0px;margin: 0px;"><!--<i style="color:#00BD16;display: none;" id="tick<?//=$row['store_id']?>" class="fa fa-check-circle ticking"></i>-->
										...
										<button id="btn<?=$row['store_id']?>" style="display: none;height: 45px;width:100%;border-color: white;background-color:#006904;color: white;border-radius:7px;outline: none; " class="element_cart"><i class="fa fa-check"></i> <i class="fas fa-store" ></i></button>
									</td>
...
?>
						  ...
						  <button style="height: 45px;width:100%;border-color: white;background-color:#006904;color: white;border-radius:7px;outline: none; " onclick="check_store_select()"><i class="fa fa-cart-plus"></i>&nbsp;ADD TO CART</button>
                      </div>
                  </div>
			</div>
	...
	?>
								<tr>
									<td style="padding: 0px;margin: 0px;">
										<button class="real_btn" id="list_btn<?=$row['wishlist_id']?>" style="display:none;height: 45px;width:100%;border-color: white;background-color:#006904;color: white;border-radius:7px;outline: none;" onclick="wishlist_check_list_select(<?=$row['wishlist_id']?>)">Add <i class="fa fa-heart" ></i></button>

										<button class="load_btn" style="height: 45px;width:100%;border-color: white;background-color:#006904;color: white;border-radius:7px;outline: none;" ><i class="fa fa-refresh fa-spin"></i> <i class="fa fa-heart" ></i></button>
