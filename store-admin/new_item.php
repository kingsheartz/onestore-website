...
.modal-footer {
 ...
 <h4 style="margin-top: 30px;margin-bottom:50px;border-bottom:  1px solid#E3E3E3;padding:10px;"><i class="fas fa-boxes" style="font-size: 24px;padding-right: 12px"aria-hidden="true"></i>New Products</h4>
