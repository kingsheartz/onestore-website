  ...
  <div class="wrapper">
    ...
    <div class="col-sm-6" style="background: white;">
      <h4 style="margin-top: 30px;margin-bottom:50px;border-bottom:  1px solid#E3E3E3;padding:10px;">
        <i class="fas fa-user-edit" style="font-size: 24px;padding-right: 12px" aria-hidden="true"></i>Update Status
      </h4>
      <div id="imgf">
        <?php
      ...
      <form method="post" id="chfrm">
        ...
        <button style="width: 100%;margin-left: 0;padding: 5px;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #4caf50), color-stop(1, #07c103)) !important;border: none;border-radius: 5px;color: white;" onclick="showupda()">Change</button>
        <br><br><br>
      </form>
      <?php
      require "foot.php";
