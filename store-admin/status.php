...
//------------------------------------------------------------------------------------
 ...
 <h4 style="margin-top: 30px;margin-bottom:50px;border-bottom:  1px solid#E3E3E3;padding:10px;"><i class="fas fa-user-edit" style="font-size: 24px;padding-right: 12px" aria-hidden="true"></i>Update Status</h4>
 <div id="imgf"><?php
...
<select class="form-control" required="" id="status"name="status">
  ...
  <div class="form-group" class="store-opening-hours" id="store-opening-hours">
        <div class="input-class store-opening-hours" style="background-color: #ededed;border:1px solid #999;border-color:#ccc;border-radius: 5px">
            <input type="text" title="opening hour" name="hours" id="opening_hours" style="background-color: #fff;border-color: #fff" class="form-control store-opening-hours" placeholder="Opening hours" autocomplete="false" required="" readonly=""  onfocus="$('.hadiv').css('display','block');if(this.value==''){this.value='12:00AM to 11:59PM';$('#in1').val('12');;$('#in2').val('00');$('#in4').val('11');$('#in5').val('59')}">
<!--select boxes for hours-->
            <div class="hadiv store-opening-hours" id="hadiv" style="display: none;margin-top: 12px;padding-left: 5px;width: 100% " focusout="this.hide();$('#opening_hours').show()">
                <div class="hrdiv store-opening-hours" style="width: auto;">
                    ...
                    <input type="number" onblur="validtime()" class="form-control1" id="in1" placeholder="HH" name="" min="1" max="12" style="padding: 0;margin: 0;text-align: center;">
                    <span class="dot" style="margin-top: 6px;font-weight: bolder;padding: 2px;">:</span>

                    <input type="number" onblur="validtime()" class="form-control1" id="in2" placeholder="MM"  name="" min="00" max="59" style="padding: 0;margin: 0;text-align: center;">
                ...
                <div class="dot" style="width: 5%;text-align: center;">to</div>
                    <div class="hrdiv" style="width: auto;padding-bottom: 10px;">
                        <i class="fa fa-clock-o" class="form-control1" style="position: relative;margin-top: 2px;"></i>
                        <input type="number" onblur="validtime()" id="in4"class="form-control1" placeholder="HH" name="" min="1" max="12" style="padding: 0;margin: 0;text-align: center;">
                        <span class="dot" style="margin-top: 6px;font-weight: bolder;padding: 2px;">:</span>

                        <input type="number" onblur="validtime()" id="in5"class="form-control1" placeholder="MM" name="" min="00" max="59" style="padding: 0;margin: 0;text-align: center;">
                ...
                <button onclick="conca();" onmouseover="$(this).css('background-color','#4f994f')" onmouseleave="$(this).css('background-color','#07C103')" style="color: white;background-color:#07C103;outline: none;margin-top: 0px;padding: 0px;padding-left: 2px;padding-right:2px;max-width: 30px;position: absolute;border:2px solid white" class="form-control1" type="button">
