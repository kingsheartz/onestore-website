  ...
  <!-- Sidebar Holder -->
    ...
    -webkit-font-smoothing: antialiased"></i> Online</p>
      ...
      <li id="viewphp"><a href="view.php">
        ...
        <li id="statusphp"><a href="status.php"><span class="icons"><img src="images/file-arrow-up.svg"></span><span class="nav_text" style="color:white">Update status</span><span style="float: right;"><i class="fa fa-angle-right"></i></span></a>
        </li>
...
?>
    ...
    padding-right: 8px;"></i>Home</a>
                            ...
                            <li class="nav-item">
                                 <a class="nav-link" href="neworders.php"><i class="fas fa-cart-plus" style="font-size: 20px;color: #ff9931;"></i>
    ...
    padding-right: 8px;"></i><span class="uppernum1"><?=$row1['COUNT(*)']?></span>Chat</a>
                            ...
                            <li class="nav-item">
                             <a class="nav-link" href="../logout.php"><i class="fa fa-power-off" style="font-size: 20px;color: #ff9931;
