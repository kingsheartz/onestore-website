...
<nav id="sidebar">
  ...
  <ul class="list-unstyled components">
    ...
    <li id="statusphp">
      <a href="status.php">
        <span class="icons"><img src="images/file-arrow-up.svg"></span>
        <span class="nav_text" style="color:white">Update status</span>
        <span style="float: right;"><i class="fa fa-angle-right"></i></span>
      </a>
    </li>
    <li id="chatphp">
      <a href="message.php">
        <span class="icons"><i class="fa fa-comments fa-2x"></i></span>
        ...
        <ul class="nav navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link" href="index.php">
              <i class="fa fa-home" style="font-size: 20px;color: #ff9931;padding-right: 8px;"></i>Home
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="neworders.php">
              <i class="fas fa-cart-plus" style="font-size: 20px;color: #ff9931;"></i>
              <span class="uppernum"><?= $stmtn ?></span>Orders
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="message.php">
              <i class="fa fa-comments" style="font-size: 20px;color: #ff9931;padding-right: 8px;"></i>
              <span class="uppernum1"><?= $row1['COUNT(*)'] ?></span>Chat
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../user/Account/logout.php">
              <i class="fa fa-power-off" style="font-size: 20px;color: #ff9931;padding-right: 8px;"></i>Log Out
            </a>
          </li>
        </ul>
      </div>
