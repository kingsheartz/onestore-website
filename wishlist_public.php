                                ...
                                <td class="product-name" colspan="2" style="padding: 0px;margin-top: 5px;">
                                    <p style="margin:0px;margin-bottom: 20px;font-size:17px;" >
                                        <div style="margin-left: 0px;background-color: #02171e;padding-left: 15px;padding-right:15px;width: 100%;border-radius: 2px;margin-bottom: -8px;padding-top:8px;padding-bottom:8px;text-align:justify">
                                            ...
                                            <a href="#" style="color: white;font-weight: normal;text-align:justify;font-size:17px;"><i class="fa fa-product-hunt" style=""></i> <?=$row2['item_name']?></a>
                                        </div> 
                                    </p>  
                                </td>
                            </tr>
...
<!--------------------------------------------------------------------------------------------------------------------------------------------------------->
                                                ...
                                                <div style="padding: 0px;margin: 0px;">
                                                    <button id="btn_s<?=$store_id."i".$item_description_id?>" type="button" style="width: 100%;min-width: 50px;height: 40px;font-weight: bold;font-size: 14px;background-color: white;outline: none;border-color:#02171e;padding: 0" onclick="$(this).hide();if($(this).html()<10){$('#sel_s<?=$store_id."i".$item_description_id?>').show();}else{$('#qnty_s<?=$store_id."i".$item_description_id?>').show();}">1</button>
...
<!--------------------------------------------------------------------------------------------------------------------------------------------------------->
                                        ...
                                        <td style="padding: 0px;width: 45%">
                                            <button type="button" onclick="updatecart(<?=$item_description_id?>,<?=$store_id?>)" title="Add to wish list" style="width: 100%;height: 40px;background-color: #f6f6f6;border: 0px solid #999;outline: none;font-weight: bold;-webkit-box-shadow: inset -1px 1px 15px 3px #bbb;box-shadow: inset -1px 1px 15px 3px #ccc;"><i class="fa fa trash"></i> Add to Cart <i style="color: #ff5722" class="fa fa-shopping-cart fa-lg"></i></button>
                                        </td>
                                        <td class="product-remove" style="padding: 0px;width: 45%;">
                                            <button type="button" title="Buy this item" style="width: 100%;height: 40px;border:none;border-color: #fff;color: #fff;background-color: #c50505;outline: none;-webkit-box-shadow: inset -1px 1px 15px 3px #76001d;box-shadow: inset -1px 1px 15px 3px #86001d;" class="remove" onclick="location.href='checkoutsingle.php?store_id=<?=$store_id?>&item_description_id=<?=$item_description_id?>';" href="#"><b>Buy Now </b><i class="fas fa-flash"></i></button> 
                                        </td>
                                    </tr>
                                </table>
                            </tr>
...
?>          <div class="row emp_cart">
                <div class="product-content-right">
                    ...
                    <h2 class="sidebar-title" style="text-align: center;display: inline-flex;font-weight: 600;color:#c50505">This Wish List is Empty</h2>
                </div>
                                                    ...
                                                    <figure >
                                                        <div class="snipcart-item block" style="height: 330px">
                                                            <div class="snipcart-thumb" style="height: 320px">
                                                                <a href="single.php?id=<?=$rw['item_id']?>"><img title=" " alt=" " style="height: 100px;" class="new_size" src="images/<?=$rw['category_id']?>/<?=$rw['sub_category_id']?>/<?=$rw['item_description_id']?>.jpg"></a>
