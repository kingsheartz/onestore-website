...
button[type="submit"]{
		width:45%;
    background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #2196f3), color-stop(1, #1497ff)) !important;    color: white;
   color: white;
    border: none;
    padding: 5px;
    border-radius: 5px;
...
<label class="addte"  >Features</label><br>
  <div class="col-sm-12">
 <button type="button" name="nw" id="addpos" ><i style="font-size: 24px;float:left"  class="fa fa-plus-circle"></i>Add</button><br><br>
...
<label class="addte" >Product details</label><br>
  ...
  <span class="floating-label">Product Name</span>
   ...
   <input type="text" required="" class="form-control" id="item"  style="width: 100%"name="item_name" ></div>
  <div class="form-group">
...
<div class="form-group">
  ...
  <div class="form-group">
   ...
   <input type="number"  required="" class="form-control" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"style="width: 100%"name="item_price" ></div>
<div class="form-group" >
    <span class="floating-label">Product Description</span>

  <textarea  required="" class="form-control" style="white-space: pre-line;width:100%;height:200px;" id="address" name="description"></textarea>
</div>
