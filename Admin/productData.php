...
<div class="immodal">
 <form id="<?=$row['item_description_id']?>"  method="post" name="<?=$row['item_description_id']?>">
  ...
  <div class="price"> 
   <span ><i class="fas fa-rupee"></i> <?=$row['price']?></span></div>
...
<img id="imr<?=$row['item_description_id']?>"src="../images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg"  >
 ...
 <button type="button" style=" position: absolute;
   top: 75%;
    ...
    border: none;" name="lfarr"class="left-arrow" onclick="moveleft('imsrc<?=$row['item_description_id']?>')"><i class="fas fa-chevron-right"></i></button>
<button type="button" style=" position: absolute;
   top: 75%;
    left: 0;
    z-index: 1;
    height: 40px;
    background: transparent;
    border: none;"name="rfarr"class="right-arrow" onclick="moveright('imsrc<?=$row['item_description_id']?>')" style="display: none;"><i class="fas fa-chevron-left"></i></button>
