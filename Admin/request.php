...
<h4 style="margin-top: 30px;margin-bottom:50px;border-bottom:  1px solid#E3E3E3;padding:10px;"><i class="fas fa-file-contract" style="font-size: 24px;padding-right: 12px"aria-hidden="true"></i>Permssion for Stores</h4>
