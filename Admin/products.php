...
.modal-footer {
    background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #000000), color-stop(1, #7221f3)) !important;
            ...
            <div class="table1">
 <h4 style="margin-top: 30px;margin-bottom:50px;border-bottom:  1px solid#E3E3E3;padding:10px;"><i class="fas fa-boxes" style="font-size: 24px;padding-right: 12px"aria-hidden="true"></i> Products</h4>
...
class="image" align="middle" src="../images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg"></div>
...
<button class="left-arrow" onclick="moveleft('2difrow<?=$ct?>')"><i class="fas fa-chevron-right"></i></button>
<button class="right-arrow" onclick="moveright('2difrow<?=$ct?>')" style="display: none;"><i class="fas fa-chevron-left"></i></button>
