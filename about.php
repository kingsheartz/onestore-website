		...
		<div class="container">
			...
			<div class="about-agileinfo w3layouts">
				<div class="col-md-8 about-wthree-grids grid-top">
					...
					<p>It goes back in time when we made our simple beginning in the year 2021.OneStore online shopping system which further contains several other entities describing the entire system. Also provides the 24×7 service, that is customers can surf the website, place orders anytime they wish to. The delivery system works according to the shops opening and closing time.</p>
					<p>The pandemic has put people and economies under immense pressure. Nobody could have foreseen the disruption that came upon the world last year and continues to impact every single thing we do even today. It pushed boundaries and realigned priorities. It created daunting challenges especially for small businesses . Many of them have gone through personal loss and hardship in their lives in recent months. We at OneStore recognize the immense responsibility that we have as a company during such challenging times – to our customers as by partnering small scale companies to launch their products in good manner and also helps to reach people. </p>
					<p>OneStore  helps customers  to purchase commodities as per requirement during this covid-19 circumstances. The major Objective of "OneStore" is that by enabling device location , we could know where to find our requirements at nearest location, also we can either order it to home or purchase from those particular shop by visiting over there. We could also know whether the shops are open or not.</p>	
	...
	<div style="background-color: rgba(0,0,0,0.55);"> 
		<div class="container">
			<div class="about-slid-info"> 
				...
				<p style="text-align:justify">Technology is growing day to day for saving our time and giving extraordinary features and specifications to us. We also thinks in the same way to provide the same result to you. We believe in providing you a best user friendly atmosphere is our success. We are trying hard time-to-time in achieving that .</p>
			</div>
		</div>
	</div>
	</div>
			...
			<div class="team-agileitsinfo">
				...
				<div class="col-md-3 about-team-grids">
					...
					<div class="social-icons caption"> 
						<ul>
							<li><a href="https://www.facebook.com/As.Govind" target="_blank" class="fa fa-facebook facebook"> </a></li>
							<li><a href="https://wa.me/[918113990368]?text=Hai%2C%20There!" data-action="share/whatsapp/share" target="_blank" class="fa fa-whatsapp" style="font-size:15px"> </a></li>
							<li><a href="mailto:govind.das279@gmail.com" target="_blank" class="fa fa-envelope mail"> </a></li> 
						</ul>
						<div class="clearfix"> </div>  
					</div>
				</div>
