              ...
              <div class="shipping_address" id="stda_div">
                ...
                <div class="input-group bar-srch" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;display: block;">
                  ...
                  <div class="form-group" style="text-align: right;width: 100%;position: relative;">
                    <textarea oninput="$(this).removeClass('invalid');" onkeyup="changed_details()"
                      oninput="$(this).removeClass('invalid')" rows="4" value="" title="Minimal character count is 10"
                ...
                <div class="input-group bar-srch" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;">
                  ...
                  <input oninput="$(this).removeClass('invalid');" type="text" onkeyup="changed_details()"
                    oninput="$(this).removeClass('invalid')" value="<?= $suserrow['pincode'] ?>"
                    placeholder="Postcode / Zip" id="shipping_postcode" maxlength="6" name="shipping_postcode"
                    class="input-text validate"
                    onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"
