                        ...
                        <div class="snipcart-thumb">
                          <div style="display: flex;justify-content: center;height: 200px;width:100%;background: white;text-align: center;">
                            <a class="img-cont" href="../Product/single.php?id=<?= $row['item_description_id'] ?>">
                              <img title=" " alt=" " class="img_size" src="../../images/<?= $row['category_id'] ?>/<?= $row['sub_category_id'] ?>/<?= $row['item_description_id'] ?>.jpg"></a>
                          </div>
                          <?php
                    ...
                    <figure>
                      <div class="snipcart-item block">
                        <div class="snipcart-thumb">
                          <div style="display: flex;justify-content: center;height: 200px;width:100%;background: white;text-align: center;">
                            <a class="img-cont" href="../Product/single.php?id=<?= $row['item_description_id'] ?>">
                              <img title=" " alt=" " class="img_size" src="../../images/<?= $row['category_id'] ?>/<?= $row['sub_category_id'] ?>/<?= $row['item_description_id'] ?>.jpg">
                            </a>
                          </div>
                          <?php
                          if (strlen($row['item_name']) >= 35) {
