...
<script>
  ...
  if ($(window).width() < 635) {
    ...
    ?>
      location.href =
        '../Product/products_limited.php?category_id=<?= $_GET['category_id'] ?> & subcategory_id=<?= $_GET['subcategory_id'] ?>';
    <?php
    } else if (isset($_GET['category_id'])) {
    ?>
    ...
    function sortandfilter(val, type) {
      ...
      if ($('#' + val).prop('checked') == false) {
        ...
        newtag.addClass('filter-tag-' + type + "-" +
          val); //ADDING CLASS WITH NAME AS " filter-tag-name-+'type_name'+get(cat || brand)+(sub_category_id || brand_id) "
        if (type == 'brand' || type == 'category') {
        ...
        ?>
          <div class="wrapper hide_nav_small" style="margin: 0;width: 100% !important;">
            <div class="d-md-flex align-items-md-center" style="width: 100%;">
              ...
              if (isset($_GET['item'])) {
              ?>
                <div class="h3" style="font-family: 'Poppins', sans-serif">
                  Search results <span class='fa fa-search'></span>
                </div>
              <?php
              } else {
              ?>
              ...
              <div class="ml-auto d-flex align-items-center views">
                ...
                ?>
                  <span class="btn-pdt_pg gridview" onclick="location.href='../Product/products_limited.php?category_id=<?= $_GET['category_id'] ?>'">
                    &nbsp;
                    <span class="fas fa-th px-md-2 px-1"></span>
                    <span class="px-md-2 px-1">Grid view</span></span>
                <?php
                }
                ?>
                ...
                ?>
                  <div class="py-3 side-nav-filters-head">
                    ...
                    <ul id="cat-filter-mob" class="list-group collapse" style="margin-bottom: 0px; ">
                      ...
                      ?>
                        <la onclick="sortandfilter('getcat-<?= $getcat_row['sub_category_id'] ?>','category')"
                ...
                <div class="py-3 side-nav-filters-head">
                  ...
                  <form class=" pricing collapse range-field my-5" id="mob-pricing-filter" style="margin:5px !important">
                    <div class="div-wrapper">
                      <label>
                        <h2 style="margin:0px;">
                          <span class="badge blue lighten-2 mb-4">Minimum</span>
                        </h2>
