                                        ...
                                        <table style="width: 180px;margin-top: 5px;"
                                          ...
                                          <tr>
                                            <td style="padding: 0px;padding-left: 10px;padding-right: 10px;">
                                              <input id="check_s<?= $store_id . "i" . $item_description_id ?>"
                                                class="checktobuy" onclick="addorremove(this)" type="checkbox"
                                                name="select_item" value="s-<?= $store_id . "_i-" . $item_description_id ?>">
                                            </td>
                                            <td>
                                    ...
                                    <tr style="width: 100%">
                                      <table width="100%" class="tbl_s<?= $store_id . "i" . $item_description_id ?>">
                                        <tr class="product-quantity quantity buttons_added"
                                          ...
                                          <td>
                                            <p><a id="update_item" style="font-weight: bold;float: left;margin-top: -10px;"
                                                onclick="updateitem(<?= $item_description_id . ',' . $store_id ?>)"
                                                value="Update Cart" name="update_cart">&nbsp;Update&nbsp;</a>
                                            </p>
                                          </td>
                                          <td>
                                              ...
                                              <div style="padding: 0px;margin: 0px;">
                                                ...
                                                <select id="sel_s<?= $store_id . "i" . $item_description_id ?>"
                                                  ...
                                                  <option value="<?= $row1['quantity'] ?>"
                                                    id="sel_opt_s<?= $store_id . "i" . $item_description_id ?>" selected
                                                    disabled>
                                                    <?= $row1['quantity'] ?>
                                                  </option>
                                                  <option value="0" class="sc-update-quantity-option"
                                                    data-a-css-class="quantity-option" data-a-html-content="0 (Delete)">
                                                    0 (Delete)</option>
                        ...
                        <div class="col-md-6" style="float:right;">
                          <h4 style="padding-right: 10px;text-transform: capitalize;color:#000;float: right;">
                            Subtotals(<span id="total_rm_cnt">
                              <?= $item_cnt ?>
                            </span> item) <small style="font-weight: bolder;">&#8377;</small><b id="tot_val2">
                              <?= $row['subtotal'] ?>
                            </b></h4>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="div-wrapper"
                              ...
                              <div style="padding: 10px;">
                                <button type="button"
                                  ...
                                  onclick="updatecart()" name="update_cart" class="btn-primary btn button"><i
                            ...
                            <tbody>
                                <tr class="cart-subtotal" style="background-color: #f2f3f4">
                                    <th style="background-color: #fff">Cart Subtotal</th>
                                        <td><span class="amount tot_val" id="tot_val1" style="background-color: #f2f3f4">&#8377;<? //=$row['subtotal']
                                                                                                                                ?></span></td>
                                </tr>
                                <tr class="order-total tot_val">
                                    <th style="background-color: #fff">Order Subtotal</th>
                                    <td><strong><span class="amount tot_val" id="tot_val2">&#8377;<? //=$row['subtotal']
                                                                                                  ?></span></strong> </td>
                                </tr>
                            </tbody>
                        </table>
                  ...
                  <div id="collapse2" class="panel-collapse collapse in">
                    <ul class="list-group" style="list-style: none;">
                      ...
                      <li class="list-group-itemb"
                        ...
                        <a href="../Product/allitems.php"><button class="vwbt" onmouseover="$(this).css('color','#00c0ef')"
              ...
              <div class="difcat " style="border-radius: 5px;">
                ...
                <div class="difrow hidescroll" id="difrow<?= $row['item_description_id'] ?>"
                  ...
                  <button class="left-arrow-btn-all shadow_all_none"
                    onclick="moveleft('difrow<?= $row['item_description_id'] ?>')" style="display: none;"><i
              ...
              <div class="row emp_cart" style="background-color: #fff;margin:0;">
                <div class="product-content-right">
                  <center><img style="justify-content: center;" class="sidebar-title"
                    ...
                    <h2 class="sidebar-title" style="text-align: center;display: inline-flex;font-weight: 600;">Your
                      Cart
                      is Empty</h2>
                  </center>
                </div>
