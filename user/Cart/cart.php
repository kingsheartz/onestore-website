    ...
    <div class="side-ext-l side-ext-r" style="display:flex;width: 100%;padding:0;justify-content: flex-end;padding-right: 0px;position: fixed;right:0;bottom:0;z-index: 99;">
      <div class="shadow_l" style="background-color: rgb(250, 245, 245);padding-left:10px;padding-right:10px;display:flex;justify-content: center;align-items: center;width:200px">
        ...
        <h5 style="float:left;font-weight: bold;">Selected <span id="sel_itcnt">0</span> item(s)
          ...
          <span style="float: left;margin-bottom: -5px;margin-top: 5px;">
            Subtotals <i class="fa fa-inr"></i>
            <span id="sub_mul">0</span>
          </span>
        </h5>
      </div>
    </div>
        ...
        ?>
            <div class="col-md-9" style="margin:0px;padding: 0px;margin: 0px;">
              <div class="product-content-right nopadding-margin" style="margin:0px;padding: 0px;margin-right: 10px;background-color: white;border-radius: 10px;">
                <h2 class="sidebar-title" style="border-left: 5px solid #ff5722;border-top-left-radius: 10px;text-align: left;padding-bottom: 30px;padding-top: 20px;background-color: white;margin-top: 0px;font-weight:normal;border-bottom:#333;margin-bottom: 0px;border-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; ">
                                      ...
                                      <td class="product-name" colspan="2" style="padding: 0px;margin-top: 5px;">
                                        ...
                                        <div style="margin-right:10px;background-color: #02171e;padding-right:20px;padding-left:10px;width: 100%;border-radius: 2px;margin-bottom: -8px;padding-top:8px;padding-bottom:8px;text-align:justify">
                                          <div style="display: flex;">
                                            <a class="pd_name" href="#" style="color: white;font-weight: normal;text-align:justify;">
                                    ...
                                    <tr class="cart_item" style="width: 100%; background-color: #fff">
                                      <td style="padding: 0px;width: 20%">
                                        <table style="width: 180px;margin-top: 5px;" class="tbl_s<?= $store_id . "i" . $item_description_id ?>">
                                          <tr>
                                            <va style="padding: 0px;padding-left: 10px;padding-right: 10px;">
                                              <input
                    ...
                    <div class="cart_totals shadow_all_none" style="width: 100%;margin:0px;padding: 0px;padding-top: 0px;">
                      <div class="row">
                        <div class="col-md-6" style="float:right;">
                          <h4 style="padding-right: 10px;text-transform: capitalize;color:#000;float: right;">
                            Subtotals(<span id="total_rm_cnt"><?= $item_cnt ?></span> item)
                            <small style="font-weight: bolder;">&#8377;</small>
                            ...
                            <div class="div-wrapper" style="padding-left: 15px;padding-right: 15px;grid-gap: 0px;padding-top: 20px;">
                              ...
                              <div style="padding: 10px;">
                                <button
                                  ...
                                  onclick="go()"
                                  name="proceed"
                                  class="checkout-button btn btn-primary button alt wc-forward">
                ...
                <div id="collapse2" class="panel-collapse collapse in">
                  <ul class="list-group" style="list-style: none;">
                    ...
                    ?>
                        <li class="list-group-itemb" style="display: flex;padding:5px;" onclick="location.href='../Product/single.php?id=<?= $row['item_description_id'] ?>'">
                          <div style="width:70px">
                            <img class="smimg" aria-colspan="" src="../../images/<?= $row['category_id'] ?>/<?= $row['sub_category_id'] ?>/<?= $row['item_description_id'] ?>.jpg">
                          </div>
                          <div style="position: relative;float:left;width:100%;padding:20px">
                            <?= $row['item_name'] ?>
                            <button class="price">
                    ...
                    <li class="list-group-itemb" style="padding:10px;height:50px;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #d606ff), color-stop(1, hsl(283, 99%, 34%))) !important;">
                      <a
                        href="../Product/diff_views.php?popular=1">
                        <button
                          class="vwbt"
    ...
    ?>
      <div class="row emp_cart">
        <div class="product-content-right">
          <center>
            <img style="justify-content: center;" class="sidebar-title" src="../../images/logo/cart-empty.png">
      ...
      <div class="element_grid">
          ...
          <h4 class="show_cat_list_main tb-padding sidebar-title cart_empty_show_cat" style="border-left: 5px solid <?= $bgcolor[$rancolor1] ?>;border-top-left-radius: 10px;text-align: left;padding-bottom: 10px;padding-top: 10px;background-color: white;font-weight:normal;border-bottom:#333;margin-bottom: -5px;margin-top: 13px;border-top-right-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; overflow: hidden;font-size: 18px;">
            ...
            <span style="float: right;margin-right: 5px;margin-top: -4px;">
              <button
                ...
                name="proceed"
                class="checkout-button button alt wc-forward">
                <a href="../Product/products_viewall.php?category_id=<?= $cat_id1 ?>&subcategory_id=<?= $sub_cat_id1 ?>" style="color:<?= $c1 ?>;">
                  View all
                </a>
              </button>
            </span>
        ...
        <div class="shadow_b">
          <h4 class="show_cat_list_main tb-padding sidebar-title cart_empty_show_cat" style="border-left: 5px solid <?= $bgcolor[$rancolor2] ?>;border-top-left-radius: 10px;text-align: left;padding-bottom: 10px;padding-top: 10px;background-color: white;font-weight:normal;border-bottom:#333;margin-bottom: -5px;margin-top: 13px;border-top-right-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; overflow: hidden;font-size: 18px;">
            <?= $sub_cat_name2 ?>
            <i style="color: #ff5722;" class="fa fa-arrow-right"></i>
            <span style="float: right;margin-right: 5px;margin-top: -4px;">
              <button
                type="button"
                ...
                name="proceed"
                class="checkout-button button alt wc-forward">
                <a href="../Product/products_viewall.php?category_id=<?= $cat_id2 ?>&subcategory_id=<?= $sub_cat_id2 ?>" style="color:<?= $c2 ?>;">
                  View all
                </a>
              </button>
            </span>
            ...
            $sub_cat_name2 = $sub_catrow2['sub_category_name'];
              ...
              <div class="row emp_cart" style="background-color: #fff;margin:0;">
                <div class="product-content-right">
                  <center>
                    <img style="justify-content: center;" class="sidebar-title" src="../../images/logo/cart-empty.png">
                    <h2 class="sidebar-title" style="text-align: center;display: inline-flex;font-weight: 600;">
                      Your Cart is Empty
                    </h2>
                  </center>
                </div>
            ...
            function updatecart() {
              ...
              while ($row1 = $stmt1->fetch(PDO::FETCH_ASSOC)) {
                ...
                while ($row2 = $stmt2->fetch(PDO::FETCH_ASSOC)) {
                  $subcat = $row2['sub_category_name'];
              ?>
                  var total_amt = document.getElementById('total_s' + '<?= $store_id . "i" . $item_description_id ?>')
                    .innerHTML;
