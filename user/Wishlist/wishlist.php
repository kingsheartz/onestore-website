            ...
            <h3>
              <div class="div-wrapper">
                ...
                <div class="wishlist-method  caw-active" style="display: none;">
                  <span class="fa fa-file-text" style="color: #F1E5B5">
                    <span style="color: #0f99ff;">Create a wishlist</span>
                  </span>
                </div>
                ...
                <div class="wishlist-method sw-active" style="border-left:1px solid #fff;display: none;">
                  <span class="fa fa-search" style="color: #fe9126">
                    <span style="color: #0f99ff">Search wishlist</span>
                  </span>
                </div>
              </div>
            </h3>
              ...
              <div class="div-wrapper">
                <div
                  ...
                  <div class="wishlist-method  caw-active" style="display:flex;align-items: center;justify-content: center;display: none;">
                    <span class="fa fa-file-text" style="color: #F1E5B5">
                      <span style="color: #0f99ff;">Create</span>
                    </span>
                  </div>
                </div>
                <div style="background-color: black;padding: 15px;border-radius: 5px;">
                  ...
                  <div class="wishlist-method yw-active" style="display:flex;align-items: center;justify-content: center;">
                    <span class="fa fa-heart" style="color:#c50505 ">
                      <span style="color: #0f99ff;">Wishlist</span>
                    </span>
                  </div>
                </div>
                <div style="background-color: black;padding: 15px;border-radius: 5px;">
                  <div class="wishlist-method sw" style="display:flex;align-items: center;justify-content: center;">
                    <span class="fa fa-search"> Search</span>
                  </div>
                  <div class="wishlist-method sw-active" style="display:flex;align-items: center;justify-content: center;display: none;">
                    <span class="fa fa-search" style="color: #fe9126">
                      <span style="color: #0f99ff;">Search</span>
                    </span>
                  </div>
                </div>
              </div>
      ...
      <div class="your_wishlist">
        <div class="your_wishlist_large">
          ...
          if (isset($_SESSION['onestore_id'])) {
            ...
            $stmt_check->execute(array(':user_id' => $_SESSION['onestore_id']));
            ...
            $stmt_wish->execute(array(':user_id' => $_SESSION['onestore_id']));
            if ($row_check['cnt'] > 0) {
          ?>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr class="wltr del_w_<?= $row_wish['wishlist_id'] ?>">
                            ...
                            ?>
                            <div onclick="location.href='../Wishlist/wishlist_single.php?wishlist_id=<?= $row_wish['wishlist_id'] ?>'">
                              <td onclick="location.href='../Wishlist/wishlist_single.php?wishlist_id=<?= $row_wish['wishlist_id'] ?>'">
                            ...
                            <td>
                              <h4>
                                <select style="font-size: 16px;" onchange="actions(this,'<?= $row_wish['wishlist_id'] ?>')" id="sharewid_<?= $row_wish['wishlist_id'] ?>">
                                  ...
                                  <option value="2" style="color: #333;">Delete</option>
                                  <option value="wishlist_share.php?sharelink=<?= $row_wish['share_link'] ?>" style="color: #333;">Share</option>
                                </select>
                              </h4>
                            </td>
                          </tr>
            ...
            ?>
              <h4 style="margin-top: 50px;color: #ccc">
                No lists are found.
                <a data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#myModal_create_wishlist">
                  Create one!
                </a>
              </h4>
              <br><br><br><br><br>
            ...
            <h4 style="margin-top: 50px;color: #ccc">
              ...
              <a href="#myModal" data-toggle="modal" data-dismiss="modal"> Log in!</a>
            </h4>
          <?php
          }
          ?>
                ...
                <div class="col-md-12" style="margin: 0;padding: 0;width: 100%">
                  ...
                  ?>
                    <div id="show_wishlist_small">
                      <table
                        class="wltr ywl_table_small del_w_<?= $row_wish['wishlist_id'] ?>"
                        cellpadding="20px"
                        cellspacing="20px"
                        width="100%"
                        style="background-color: rgba(0,0,0,.65);">
                        <tr style="background-color: #0f99cc;" onclick="location.href='../Wishlist/wishlist_single.php?wishlist_id=<?= $row_wish['wishlist_id'] ?>'">
                          <th colspan="2">
                            <h4 class="ywl_table_small_list_head" title="<?= $row_wish['list_name'] ?>">
                              <?= $listname ?>
                              &nbsp;<i class="fa fa-file-text"></i>
                              <i class="fa fa-heart" style="font-size: 12px;color:#c50505 "></i>
                            </h4>
                          </th>
                        </tr>
                        <tr>
                          ...
                          <td colspan="2">
                            <table style="width:100%">
                              <tr>
                                <td>
                                  <h4>
                                    <i class="fa fa-edit" onclick="location.href='../Wishlist/wishlist_single.php?wishlist_id=<?= $row_wish['wishlist_id'] ?>&setting=1'"></i>
                                  </h4>
                                </td>
                                <td>
                                  <h4>
                                    <i class="fa fa-trash" onclick='del_list("<?= $row_wish['wishlist_id'] ?>")'></i>
                                  </h4>
                                </td>
                                <td>
                                  <h4>
                                    <i class="fa fa-share" onclick="copylink(<?= $row_wish['wishlist_id'] ?>,'wishlist_share.php?sharelink=<?= $row_wish['share_link'] ?>')"></i>
                                  </h4>
                                </td>
                              </tr>
                            </table>
                ...
                <table id="wishlisttable" cellpadding="20px" cellspacing="20px" width="100%">
                  <tr>
                    <div class="input-group bar-srch" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;">
                      ...
                      <span id="" class="input-group-btn">
                        <button
                          onmouseover="$(this).css('background-color','#0d99cc')"
      ...
      <div class="modal-body">
        ...
        <form action="#" onsubmit="return create_my_list()" method="post" enctype="multipart/form-data">
          <table style="background-color: #fff;width: 100%" class="create_wishlist_table">
            ...
            <tr>
              <td>
                <div class="div-wrapper" style="grid-gap: 0;margin: auto;display: flex;"><input type="radio" id="public" class="privacy" name="privacy" value='public'>
            ...
            <tr>
              <td>
                <div class="div-wrapper" style="grid-gap: 0;margin: auto;display: flex;"><input type="radio" id="shared" class="privacy" name="privacy" value="shared">
...
<script type="text/javascript">
  function copylink(wid, link) {
    ...
    var fb_content = '<div class="fb-share-button"  data-href="' + link +
      '" data-layout="button_count" data-size="small" style="margin:auto;width: 30px;height: 30px;background-color: #395693;border-radius:3px;display: flex;align-items: center;justify-content: center;"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fone-store.ml%2F/user/Wishlist/wishlist.php%3Fsharelink%3D' +
      code[1] +
            ...
            success: function(data) { //if registration is success
              if (data.status == 'success') {
                var markup = '<tr class="wltr del_w_' + data.wid +
                  ...
                  '"><h4 title="list_name">' + listname +
                  '</h4></td><td onclick="location.href=\'wishlist_single.php?wishlist_id=\'' + data.wid +
                  '"><h4>' + privacy +
                  '</h4></td><td onclick="location.href=\'wishlist_single.php?wishlist_id=\'' + data.wid +
                  '"><h4>0</h4></td><td onclick="location.href=\'wishlist_single.php?wishlist_id=\'' + data.wid +
                  '"><h4>' + data.date +
                  '</h4></td><td><h4><select style="font-size: 16px;" onchange=\'actions(this,' + data.wid +
                  ')\'><option value="0" selected="" disabled="">Select</option><option value="1" style="color: #333;">Edit</option><option value="2" style="color: #333;">Delete</i></option><option value="../Wishlist/wishlist.php?sharelink=' +
                  data.link + '" style="color: #333;">Share</i></option></select></h4></td></tr>';
                var tableBody = $('#show_wishlist');
                tableBody.append(markup);
                var link = '../Wishlist/wishlist.php?sharelink=' + data.link;
                var markupsmall = '<table class="wltr ywl_table_small del_w_' + data.wid +
                  '" cellpadding="20px" cellspacing="20px" width="100%" style="background-color: rgba(0,0,0,.65);"><tr style="background-color: #0f99cc;" onclick="location.href=\'wishlist_single.php?wishlist_id=\'' +
                  data.wid + '"><th colspan="2"><h4 class="ywl_table_small_list_head" title="' + listname + '">' +
                  listname +
                  ' &nbsp;<i class="fa fa-file-text"></i><i class="fa fa-heart" style="font-size: 12px;color:#c50505 "></i></h4></th></tr><tr><th class="ywl_small_table_th"><h4>Privacy</h4></th><td class="ywl_small_table_td"><h4>' +
                  privacy +
                  '</h4></td></tr><tr><th class="ywl_small_table_th"><h4>Item count</h4></th><td class="ywl_small_table_td"><h4>0</h4></td></tr><tr><th class="ywl_small_table_th"><h4>Created on</h4></th><td class="ywl_small_table_td"><h4>' +
                  data.date +
                  '</h4></td></tr><tr><td colspan="2"><table style="width:100%"><tr><td><h4><i class="fa fa-edit" onclick="location.href=\'wishlist_single.php?wishlist_id=' +
                  data.wid + '&setting=1\'"></i></h4></td><td><h4><i class="fa fa-trash" onclick=\'del_list(' +
                  data.wid + ')\'></i></h4></td><td><h4><i class="fa fa-share" onclick="copylink(' + data.wid +
                  ',\'' + link + '\')"></i></h4></td></tr></table></td></tr></table><br>';
