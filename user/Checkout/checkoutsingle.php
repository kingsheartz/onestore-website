...
if(checkBox_user.checked==false && checkBox_diff.checked==false){
    ...
    var data = { "buynow_placeorder": 1, "user": 1, "user_id": uid, "order_notes": order_notes, "pdt_cnt": quantity, "total_amt": total_amt, "idid": idid, "store_id": store_id, "order_type": order_type };
