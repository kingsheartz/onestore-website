...
<div class="footer">
  <div class="container">
    <div class="w3_footer_grids">
      ...
      <div class="col-md-3 col-sm-6 w3_footer_grid">
        ...
        <ul class="info">
          <li>
            <i class="fa fa-arrow-right" aria-hidden="true"></i><a href="../Main/about.php">About Us</a>
          </li>
          <li>
            <i class="fa fa-arrow-right" aria-hidden="true"></i><a href="../Main/contact.php">Contact Us</a>
          </li>
          <li>
            <i class="fa fa-arrow-right" aria-hidden="true"></i><a href="../Main/terms&conditions.php">T&C</a>
          </li>
          <li>
            <i class="fa fa-arrow-right" aria-hidden="true"></i><a href="../Main/privacy.php">Privacy Policy</a>
          </li>
        </ul>
      </div>
      <div class="col-md-3 col-sm-6 w3_footer_grid">
  ...
  <div class="footer-copy">
    <div class="container">
      <p>© 2020 OneStore. All rights reserved | <a id="me" onmouseover="$('#me').css('color','#0c99cc')" onmouseleave="$('#me').css('color','#fe9126')" href="www.one-store.com">Krishnendu</a></p>
    </div>
  </div>
</div>
