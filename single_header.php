...
<div class="std_text2" style="color:white;font-size:17px">Please wait...</div>
<!--RESPONSE AWAITING-->
...
<?php
  ...
  while ($row=$sql->fetch(PDO::FETCH_ASSOC)) {
?>
  <li value="<?=$row['category_id']?>"><a style='font-family:sans-serif;border:1px white;' href="#<?=$row['category_id']?>"><?=$row['category_name']?></a></li>
...
<!--////////////////////////////////////////////////#1#/////////////////////////////////////////////////////////////////-->
    ...
    <div class="dropdown-container  side_drop_li_main slide_drop_li_main_first">
        <a href="products.php?category_id=1&subcategory_id=1" style="width: 100%;padding: 0px">
        ...
        <a href="products.php?category_id=1&subcategory_id=2" style="width: 100%;padding: 0px">
        ...
        <a href="products.php?category_id=1&subcategory_id=3" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=1&subcategory_id=4" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=1&subcategory_id=5" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=1&subcategory_id=6" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#2#/////////////////////////////////////////////////////////////////-->
    ...
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products.php?category_id=2&subcategory_id=7" style="width: 100%;padding: 0px;padding-top: 37px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px; ">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=2&subcategory_id=8" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=2&subcategory_id=9" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=2&subcategory_id=10" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=2&subcategory_id=11" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=2&subcategory_id=12" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
                <span style="font-family: arial;font-weight: 700; "> Dried Fruits,Nuts and Seeds</span>
            </li>
        </a>
        <a href="products.php?category_id=2&subcategory_id=13" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
                <span style="font-family: arial;font-weight: 700; "> Rice,Flour and Pulses</span>
            </li>
        </a>
        <a href="products.php?category_id=2&subcategory_id=14" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
                <span style="font-family: arial;font-weight: 700; "> Snack Foods</span>
            </li>
        </a>
        <a href="products.php?category_id=2&subcategory_id=15" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#3#/////////////////////////////////////////////////////////////////-->   
    ...
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products.php?category_id=3&subcategory_id=16" style="width: 100%;padding: 0px;padding-top: 74px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=3&subcategory_id=17" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#4#/////////////////////////////////////////////////////////////////-->
    ...
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products.php?category_id=4&subcategory_id=18" style="width: 100%;padding: 0px;padding-top: 111px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=4&subcategory_id=19" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=4&subcategory_id=20" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=4&subcategory_id=21" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=4&subcategory_id=22" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=4&subcategory_id=23" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#5#/////////////////////////////////////////////////////////////////-->
    ...
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products.php?category_id=5&subcategory_id=24" style="width: 100%;padding: 0px;padding-top: 148px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=5&subcategory_id=25" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=5&subcategory_id=26" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#6#/////////////////////////////////////////////////////////////////-->
    ...
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products.php?category_id=6&subcategory_id=27" style="width: 100%;padding: 0px;padding-top: 185px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=6&subcategory_id=28" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=6&subcategory_id=29" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=6&subcategory_id=30" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=6&subcategory_id=31" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#7#/////////////////////////////////////////////////////////////////-->
    ...
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products.php?category_id=7&subcategory_id=32" style="width: 100%;padding: 0px;padding-top: 222px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=7&subcategory_id=33" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=7&subcategory_id=34" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=7&subcategory_id=35" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=7&subcategory_id=36" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=7&subcategory_id=37" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=7&subcategory_id=38" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#8#/////////////////////////////////////////////////////////////////-->
    ...
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products.php?category_id=8&subcategory_id=39" style="width: 100%;padding: 0px;padding-top: 259px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=8&subcategory_id=40" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=8&subcategory_id=41" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=8&subcategory_id=42" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=8&subcategory_id=43" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=8&subcategory_id=44" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=8&subcategory_id=45" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=8&subcategory_id=46" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=8&subcategory_id=47" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=8&subcategory_id=48" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
...
<!--////////////////////////////////////////////////#9#/////////////////////////////////////////////////////////////////-->
    ...
    <div class="dropdown-container side_drop_li_main slide_drop_li_main_first">
        <a href="products.php?category_id=9&subcategory_id=49" style="width: 100%;padding: 0px;padding-top: 296px;">
        <li class="side_drop_li"  onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;margin-top:22px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=9&subcategory_id=50" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=9&subcategory_id=51" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=9&subcategory_id=52" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
        ...
        <a href="products.php?category_id=9&subcategory_id=53" style="width: 100%;padding: 0px">
        <li class="side_drop_li" onmouseover="$(this).css('color','white')" onmouseleave="$(this).css('background-color','white')" style="padding-bottom: 8px;padding-top: 8px;">&nbsp;
                <span class="fa fa-arrow-right"></span>
