...
<!-- checkout -->
	<div class="checkout" style="padding-top: 0px;padding-bottom: 0px; background-color: rgba(255,255,255,0.05);">
		<div class="container" style="margin-left:0px;margin-right:6px;width: 100%;padding:0;"><br>
			<h2 style="padding:15px;">Your shopping cart contains: <span style="font-family: arial">1 Product(s)</span></h2>
            ...
            <div class="woocommerce-billing-fields small-size">
                <div class="checkout-left-basket" style="width: 100%;background-color: white">
                    <ul style="margin: 0px;padding:0px;width: 100%;">
                        <div style="width: 100%;">
                            <li><h4 style="font-weight: bolder;width: 100%;" class="shadow_b">Shopping Items <i class="fa fa-shopping-cart"></i></h4></li>
                        </div>
                    </ul>
                </div>
            </div>
...
?>
					<tr class="rem1">
						...
						<td class="invert-image"><a href="single.php?id=<?=$row['item_description_id']?>"><img src="images\<?=$row['category_id']?>\<?=$row['sub_category_id']?>\<?=$row['item_description_id']?>.jpg" alt=" " class="img-responsive" /></a>
...
<!--------------------------------------------------------------------------------------------------------------------------------------------------------->
                            <div class="btn_sub_q"  style="padding: 0px;margin: 0px;width: 25px;display: flex;"><button style="background-color: #02171e;-webkit-box-shadow: inset 0px 0px 15px 3px #02171e;box-shadow: inset 0px 0px 15px 3px #02171e;width: 100%;max-width: 30px;height: 25px ;font-weight: bold;border-color: #02171e;color: white;font-size: 14px;border-radius: 5px;border-top-right-radius: 0px;border-bottom-right-radius: 0px;" type="button" id="sub_s<?=$store_id."i".$idid?>" onclick="sub_item_all('<?=$store_id?>','<?=$idid?>','<?=$t_mrp?>')">-</button>
                            </div>


                            <div style="padding: 0px;margin: 0px;">
                                <button id="btn_s<?=$store_id."i".$idid?>" type="button" style="width: 100%;width: 30px;height: 25px;font-weight: bold;font-size: 14px;background-color: white;outline: none;border-color:#02171e;padding: 0" onclick="$(this).hide();if($(this).html()<10){$('#sel_s<?=$store_id."i".$idid?>').show();}else{$('#qnty_s<?=$store_id."i".$idid?>').show();}">1</button>

                                <select id="sel_s<?=$store_id."i".$idid?>"  onchange="select_item_option('<?=$store_id?>','<?=$idid?>','<?=$t_mrp?>');" name="quantity" autocomplete="off" style="width: 100%;max-width: 30px;bottom: 0;box-shadow: none;outline: none;border-color:#aaa;height:25px;display: none;background-color: white">
                                ...
                                <input type="number" id="qnty_s<?=$store_id."i".$idid?>" size="4"  onchange="total('<?=$store_id?>','<?=$idid?>','<?=$t_mrp?>')" onblur="$(this).hide();$('#sel_s<?=$store_id."i".$idid?>').hide();$('#btn_s<?=$store_id."i".$idid?>').show()" style="text-align: center;display: none;height: 25px;width: 100%;max-width: 40px;outline: none;font-weight: bold" class="input-text qty text" title="Quantity" value="<?=$row1['quantity']?>" min="1" step="1" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57">

                            </div>  

                            <div class="btn_add_q"  style="padding: 0px;margin: 0px;width:25px"><button style="background-color: #02171e;-webkit-box-shadow: inset 0px 0px 15px 3px #02171e;box-shadow: inset 0px 0px 15px 3px #02171e;width: 100%;max-width: 45px;height: 25px;font-weight: bold;border-color: #02171e;color: white;font-size: 14px;border-radius: 5px;border-top-left-radius: 0px;border-bottom-left-radius: 0px;" id="add_s<?=$store_id."i".$idid?>" onclick="add_item_all('<?=$store_id?>','<?=$idid?>','<?=$t_mrp?>')" type="button">+</button></div>
                            </div>
                        </td>
                        <td class="invert">
                            <div class="invert_details" style="margin:auto;justify-content: left;align-items:left;display:flex;padding-left:20px;">
                                <ul style="list-style: none;">
                                    ...
                                    <li style="text-align: left;">
                                        Price : &#8377; <span id="price_s<?=$store_id."i".$idid?>"><?=$row['price']?></span><span class="smallqty"> /<small>(1 Qty)</small></span>
                                    </li>
                                    <li style="text-align: left;">
                                        Quantity :  1
                                    </li>
                                    <li>
                                        <p style="margin:0px;margin-top: 10px;">                
                                            <select style="outline: none;border:none;background-color:#006904;color: white;padding: 5px;border-radius: 3px;padding-top: 5px;padding-bottom: 5px;align-items: flex-start;justify-content: flex-start;display: flex; "  id="order_s<?=$store_id."i".$idid?>">
        ...
        <div class="col-md-4 col-sm-12 pdt_block" style="padding: 0px;padding-right:15px;">
            <div class="woocommerce-billing-fields">
				<div class="checkout-left-basket" style="width: 100%;background-color: white;">
					<ul style="margin: 0px;padding:0px;width: 100%;">
						<div style="width: 100%;">
                            <li class="large-size"><h4 style="font-weight: bolder;width: 100%;" class="shadow_b">Shopping Items <i class="fa fa-shopping-cart"></i></h4></li>	
...
?>													
                                    ...
                                    <li style="color: #333"><?=$row['item_name']?> <i>-</i> <span>&#8377; <span id="mrp_s<?=$store_id."i".$idid?>"><?=$row['mrp'] ?></span></span></li>
<?php
$qty=1;
...
?>
                                    ...
                                    <li>Total Savings <i>-</i> 
                                        ...
                                        <span>&#8377;<span id="save_s<?=$store_id."i".$idid?>"><?=$total_mrp-$total_amt." "?></span></span>
                                    </li>
                                    <li><i style="font-weight: bolder;font-family:sans-serif; ;color: black;font-style: unset;">Total <i>-</i> </i><span style="font-weight: bolder;font-family:sans-serif; ;color: black;">&#8377;<span id="total_s<?=$store_id."i".$idid?>"><?=$total_amt?></span></span></li><hr>
                                    </div><br>
                                    <a href="onestore.php"><li  id="bill_gap" class="shadow_b" style="padding:10px;background-color:#3399cc "><i class="glyphicon glyphicon-menu-left"  style="color: white" aria-hidden="true"></i><span style="color: white">Continue Shopping</span></li></a>
                                </div> 
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-sm-12" style="padding-left: 0px;">
                    <div class="product-content-right" style="width: 100%">
                        <div class="woocommerce">
                            ...
                            <div class="col-sm-10">
                                <p style="color: grey;"><b>NOTE : </b>Booked products need to received from the corresponding shops.</p>
                            </div>
                            <div class="col-sm-1"></div>
                                    ...
                                    <div class="col-sm-5" >
                                        ...
                                        <div class="woocommerce-shipping-fields">
                                            ...
                                            <label class="" for="order_comments">Order Notes <i class="fa fa-file-text-o"></i></label>
	                                            <textarea cols="5" rows="2" placeholder="Notes about your order, e.g. special notes for delivery." id="order_comments" name="order_comments" oninput="$(this).removeClass('invalid')" title="Minimal character count is 10" placeholder="Street address" class="input-text validate" onfocus="$('#myTextarea').prop('selectionStart');"></textarea>
                                            </p> 
                                        ...
                                        <div id="payment">
                                            ...
                                            <div class="form-row place-order" style="width: 100%">
                                                 <button type="button" data-value="Place order"  id="place_order" name="woocommerce_checkout_place_order" class="button alt real_btn place_order" style="width: 100%;font-size:1em" onclick="placeorder()"><i class="fas fa-shopping-bag"></i>&nbsp; PLACE ORDER </button>
											</div>
                                            <div class="form-row place-order" style="width: 100%">
                                                 <button class="load_btn place_order" data-value="Place order" style="display:none;width: 100%;" name="woocommerce_checkout_place_order" type="button" ><i class="fa fa-refresh fa-spin"></i>&nbsp;PLACE ORDER</button>
											</div>
                                            <div class="clear"></div>
                                        </div>
                                    </div>
...
.then((willSubmit) => {
    if (willSubmit.dismiss) {
        ...
        $.ajax({
            url: "functions.php", //passing page info
            data: {"buynow_placeorder":1,"user":2,"user_id":uid,"shipping_first_name":shipping_first_name,"shipping_last_name":shipping_last_name,"shipping_ph_no":shipping_ph_no,"shipping_ph_no2":shipping_ph_no2,"shipping_address_1":shipping_address_1,"shipping_postcode":shipping_postcode,"order_notes":order_notes,"pdt_cnt":quantity,"total_amt":total_amt,"idid":idid,"store_id":store_id,"order_type":order_type},  //form data
            type: "post",   //post data
            dataType: "json",   //datatype=json format
            timeout:30000,   //waiting time 30 sec
