...
if(isset($_GET['item'])){
?>
  location.href='products_limited.php?item=<?=$_GET['item']?>';
<?php
}
else if (isset($_GET['category_id']) && isset($_GET['subcategory_id']) ) {
?> 
  location.href='products_limited.php?category_id=<?=$_GET['category_id']?> & subcategory_id=<?=$_GET['subcategory_id']?>';
<?php
}
else if (isset($_GET['category_id'])){  
?>
  location.href='products_limited.php?category_id=<?=$_GET['category_id']?>';
<?php
}
?>
 }
...
if(isset($_GET['item'])){
?>
        <span class="btn-pdt_pg gridview" onclick="location.href='products_limited.php?item=<?=$_GET['item']?>'"> &nbsp; <span class="fas fa-th px-md-2 px-1"></span><span class="px-md-2 px-1">Grid view</span></span> 
<?php
}
else if (isset($_GET['category_id']) && isset($_GET['subcategory_id']) ) {
?> 
        <span class="btn-pdt_pg gridview" onclick="location.href='products_limited.php?category_id=<?=$_GET['category_id']?> & subcategory_id=<?=$_GET['subcategory_id']?>'"> &nbsp; <span class="fas fa-th px-md-2 px-1"></span><span class="px-md-2 px-1">Grid view</span></span> 

<?php
}
else if (isset($_GET['category_id'])){  
?>
        <span class="btn-pdt_pg gridview" onclick="location.href='products_limited.php?category_id=<?=$_GET['category_id']?>'"> &nbsp; <span class="fas fa-th px-md-2 px-1"></span><span class="px-md-2 px-1">Grid view</span></span> 

<?php
}
?>
          <span class="btn-pdt_pg listview"> &nbsp; <span class="fas fa-list-ul text-success"></span><span class="px-md-2 px-1">List view</span> </span> 
...
?>
            ...
            <div class="py-3 side-nav-filters-head">
                <h5 data-toggle="collapse" data-target="#cat-filter" aria-expanded="false" aria-controls="cat-filter"  class="font-weight-bold side-nav-filters" style="width: 100%;color:white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #01222b)) !important;" onclick="if($('.cat-right').css('display')=='none'){$('.cat-right').show();$('.cat-down').hide();}else{$('.cat-right').hide();$('.cat-down').show();}">Categories<i class="fa fa-angle-down cat-right" style="float: right;padding-right:5px"></i><i class="fa fa-angle-up cat-down" style="float: right;display: none;padding-right:5px"></i></h5>
...
?>
                   <li onclick="sortandfilter('getcat-<?=$getcat_row['sub_category_id']?>','category')" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category cat-font  getcat-<?=$getcat_row['sub_category_id']?>" style="background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #004f63)) !important;color:#ddd "> <label style="display:flex;justify-content:center;align-items:center;margin-top:3px;" class="options"><span class="val-getcat-<?=$getcat_row['sub_category_id']?>"><?=$getcat_row['sub_category_name']?></span><input value="<?=$getcat_row['sub_category_name']?>" id="getcat-<?=$getcat_row['sub_category_id']?>" type="radio" disabled name="radio-getcat-<?=$getcat_row['sub_category_id']?>"> <span class="checkmark"></span> </label><span class="badge badge-primary badge-pill"><?=$getsubcatqnty_row['qntycnt']?></span> </li>
<?php
}
?>
...
?>
            ...
            <div class="py-3 side-nav-filters-head">
                <h5 data-toggle="collapse" data-target="#brand-filter" aria-expanded="false" aria-controls="brand-filter"  class="font-weight-bold side-nav-filters" style="width: 100%;color:white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #01222b)) !important;" onclick="if($('.brand-right').css('display')=='none'){$('.brand-right').show();$('.brand-down').hide();}else{$('.brand-right').hide();$('.brand-down').show();}">Brands <i class="fa fa-angle-down brand-right" style="float: right;padding-right:5px"></i><i class="fa fa-angle-up brand-down" style="float: right;display: none;padding-right:5px"></i></h5>
...
?>
            ...
            <div class="py-3 side-nav-filters-head">
                <h5 data-toggle="collapse" data-target="#rating-filter" aria-expanded="false" aria-controls="rating-filter"  class="font-weight-bold side-nav-filters" style="width: 100%;color:white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #01222b)) !important;"onclick="if($('.rating-right').css('display')=='none'){$('.rating-right').show();$('.rating-down').hide();}else{$('.rating-right').hide();$('.rating-down').show();}">Rating <i class="fa fa-angle-down rating-right" style="float: right;padding-right:5px"></i><i class="fa fa-angle-up rating-down" style="float: right;display: none;padding-right:5px"></i></h5>
            ...
            <div class="py-3 side-nav-filters-head">
                <h5 data-toggle="collapse" data-target="#pricing-filter" aria-expanded="false" aria-controls="pricing-filter"  class="font-weight-bold side-nav-filters" style="width: 100%;color:white;background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #002b41), color-stop(1, #01222b)) !important;"onclick="if($('.pricing-right').css('display')=='none'){$('.pricing-right').show();$('.pricing-down').hide();}else{$('.pricing-right').hide();$('.pricing-down').show();}">Price <i class="fa fa-angle-down pricing-right" style="float: right;padding-right:5px"></i><i class="fa fa-angle-up pricing-down" style="float: right;display: none;padding-right:5px"></i></h5>
...
<div class="col-sm-3 col-xs-3" style="background-color:#fff" onclick="location.href='single.php?id=<?=$row['item_description_id']?>'">
  <table>  
...
<div class="col-sm-7 col-xs-7" style="min-height:200px;padding:0;">
  <table width="100%" style="padding:0px;margin:0px;">              
    ...
    $row1=$st1->fetch(PDO::FETCH_ASSOC);
    ?>
    <tr class=" dw"><th class="cust_header2"><li>Brand</li></th><td class="cust_details"><?=$row1['brand_name']?></td></tr>
    <?php
    }
    ...
    <tr class=" dw"><th class="cust_header2"><li>Category</th>
      <td class="cust_details"><?=$row_feature['category_name']?></li></td>
    </tr>
    <tr class=" dw"><th class="cust_header2"><li>Sub Category</th>
      <td class="cust_details"><?=$row_feature['sub_category_name']?></li></td>
    </tr>
    <tr class=" dw"><th class="cust_header2"><li>Seller</th>
      <td class="cust_details"><?=$row_feature['store_name']?></li></td>
    </tr>
  </table> 
