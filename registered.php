        ...
        <div class="container" style="padding: 0px;">
            ...
            <div class="col-lg-4 col-md-5 lt_menu" style="color: white">
                ...
                <div class="stprd">
                    ...
                    <div style="border-top-right-radius: 10px;border-bottom-right-radius: 10px " class="stage_reg stage_reg_4"></div>
                ...
                <ul style="list-style: none;">
                    ...
                    <a class="left-log">
                        <li class="ad my-account my-account-active">
                            <i  class="fa fa-arrow-right"></i> Profile Information</li>
                    </a>
                    <hr class="account-li-bottom">

                    <a class="left-log">
                        <li class="cep my-account">
                            <i  class="fa fa-arrow-right"></i> Log in Information</li>
                    </a>
                    <hr class="account-li-bottom">
            ...
            <div class="account-details pi account-details-active tab_reg" >
                ...
                <form action="#" onsubmit="return err_display_fn();">
                    ...
                    <p id="nameerror" style="display: none;color: red;font-weight: bolder;margin:0px"><i style="color: yellow" class="fa fa-warning"></i> Can't use any symbols(@ # $ % ... )</p>
                    ...
                    <div class="input-group input-group_form  bar-srch input-field"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top: 15px;" >  
                        <input  type="text" id="first_name" oninput="$(this).removeClass('invalid');" required=" " style="margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;" pattern="^\S[a-zA-Z]{2,30}$" title="Minimum character '3'.Use alphabets" class="validate">
                        <label class="form-label" for="first_name">First Name</label>
                        <span class="input-group-btn">
                            <button   style="color: #000;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px" class="btn btn-default search_btn" type="button"><span class="fas fa-user" style="color: #777"></span></button>
                        </span>
                    </div>

                    <div class="input-group input-group_form bar-srch input-field"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top: 15px;" >  
                        <input  type="text" id="last_name" oninput="$(this).removeClass('invalid');" required=" " style="margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;'" pattern="^[a-zA-Z ]{1,20}$" title="Use alphabets" class="validate">
                        <label class="form-label" for="last_name">Last Name</label>
                        <span class="input-group-btn">
                            <button   style="color: #000;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px" class="btn btn-default search_btn" type="button"><span class="   glyphicon glyphicon-text-color"></span></button>
                        </span>
                    </div>
...
<!---------------------------------------------------------------------------------------------------------------------------->
                        <div class="input-group-btn mob-panel"  style=" position: relative;">
                            <button type="button"  class="btn btn-default dropdown-toggle mob-btn" onclick="moblistview()"  style="position: relative;padding:10px;border-top-right-radius:0px;border-bottom-right-radius:0px;">
...
<!---------------------------------------------------------------------------------------------------------------------------->
                        <input  type="tel" id="phone" oninput="$(this).removeClass('invalid')" required=" " style="margin: 0px;z-index: 0;border-radius: 0px;" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57;" pattern="^\d{10}$" title="Phone Number Format (9876543210)- 10 digits" maxlength="10" class="validate">
                        <label class="form-label label-ph" for="phone">Phone</label>
                        <span class="input-group-btn">
                            <button   style="color: #000;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px" class="btn btn-default search_btn" type="button"><span class="glyphicon glyphicon-earphone"></span></button>
                        </span>
                    </div>
                    ...
                    <ul style=";margin-bottom: -20px;">
                        <li style="list-style:none; ">
                            <div id="pin" class="input-group input-group_form bar-srch input-field"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;" > 
                                <input type="tel" oninput="$(this).removeClass('invalid')" class="locmark validate" id="regpin" value="" name="pincode" maxlength="6" required=" " style="width: 100%;margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;'" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" pattern="^\d{6}$" title="PIN Number Format (654321)- 6 digits">
                                ...
                                <span id="hide_pin1" class="input-group-btn" style="display: none;">
                                        <button onclick="reglocate()" onmouseover="$(this).css('background-color','#ee8126');$(this).css('border-color','#ee8126')" onmouseleave="$(this).css('background-color','#fe9126');$(this).css('border-color','#fe9126')" style="color: white;background-color:#fe9126;padding-top:10px;padding-bottom: 10px;outline: none;border-color:#fe9126 " class="btn btn-default search_btn" type="button"><span class="fa fa-search"></span></button>
                                </span>
...
<!---------------------------------------------------------------------------------------------------------------------------------------------->
                            ...
                            <div class="input-group input-group_form bar-srch input-field"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;" > 
                                <select name="po_list" oninput="$(this).removeClass('invalid')" class="locmark validate" id="po_list1" name="pincode" required=" " style="width: 100%;height: 40px;margin: 0px;z-index: 0;border-radius: 5px;border:1px solid #DBDBDB;border-top-right-radius: 0px;border-bottom-right-radius: 0px;'">
                                    <option value="0" selected="" disabled="">Location</option>
                                </select> 
                              
                                <span id="hide_locate" class="input-group-btn" >
                                        <button onclick="regsetlocation()" onmouseover="$(this).css('background-color','#4f994f')" onmouseleave="$(this).css('background-color','#006904')" style="color: white;background-color:#006904;padding-top:10px;padding-bottom: 10px;outline: none;" class="btn btn-default search_btn popuptext pin" type="button"><span class="fa fa-check"></span></button>
                                </span>
                            </div> 
                            </div>  
                        </li><br>                                     
...
<!------------------------------------------------------------------------------------------------------------------------------------------->                   
                ...
                <div class="form-group input-field" style="text-align: right;width: 100%;position: relative;">
                    <textarea rows="4" oninput="$(this).removeClass('invalid')" title="Minimal character count is 10" required="" id="address" class="validate"></textarea>
                ...
                <div class="register-check-box">
                    <div class="check">
                        <label class="checkbox"><input type="checkbox" id="subscribe" name="checkbox"><i> </i>Subscribe to Newsletter</label>
                    </div>
                </div>
...
<!--EMAIL-->  
                ...
                <p id="emailerror" style="display: none;color: red;font-weight: bolder;margin:0px"><i style="color: yellow" class="fa fa-warning"></i> example@gmail.com</p>

                    <div class="input-group input-group_form bar-srch input-field"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top: 15px;" >  
                        <input  type="email" oninput="$(this).removeClass('invalid')" name="email" id="email" required=" " style="margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;'" class="validate">
                        <label class="form-label" for="email">Email Address</label>
                        <span class="input-group-btn">
                            <button   style="color: #000;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px" class="btn btn-default search_btn" type="button"><span class="glyphicon glyphicon-envelope"></span></button>
                        </span>
                    </div>

<!---------------------------------------------------------------------------------------------------------------------------------------------->
<!--PASSWORD--> 
                    <p class="capson_warning" style="display: none;color: #d9534f"><i class="fa fa-warning"></i> &nbsp;WARNING! Caps lock is ON.</p>
                    <div id="pass" style="">
                        <div class="input-group input-group_form bar-srch input-field"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top: 15px;" >  
                            <input  type="password" id="passfir" oninput="$(this).removeClass('invalid')" value="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required=" " class="password_fields validate" style="margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;" onblur="err_display_fn()">
                            <label class="form-label" for="passfir">Password</label>
                            <span id="dis_pass1" class="input-group-btn">
                                <button onclick="view()" onmouseover="$(this).css('background-color','#c0c0c0')" onmouseleave="$(this).css('background-color','#f1f2f3')" style="color: #000;background-color:#f1f2f3;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px" class="reg-btn-pass btn btn-default search_btn" type="button"><span class="fas fa-eye"></span></button>
                            </span>
                            <span id="hide_pass1" class="input-group-btn" style="display: none;">
                                <button onclick="view()" onmouseover="$(this).css('background-color','#c0c0c0')" onmouseleave="$(this).css('background-color','#f1f2f3')" style="color: #000;background-color:#f1f2f3;padding-top:10px;padding-bottom: 10px;outline: none;" class="reg-btn-pass btn btn-default search_btn" type="button"><span class="fas fa-eye-slash"></span></button>
                            </span>
                        </div>
                        ...
                        <div class="input-group input-group_form bar-srch input-field"style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top: 15px;" >  
                            <input type="password" oninput="$(this).removeClass('invalid')" id="passre" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Confirm your password by re-type as above" required=" " class="password_fields validate" style="margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;">
                            <label class="form-label" for="passre">Confirm password</label>
                            <span class="input-group-btn">
                                <button   style="color: #000;padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px" class=" btn btn-default search_btn" type="button"><span class="glyphicon glyphicon-lock"></span></button>
                            </span>
                        </div>
                    </div>
...
<!--EMAIL-->  
                ...
                <p id="emailerror" style="display: none;color: red;font-weight: bolder;margin:0px"><i style="color: yellow" class="fa fa-warning"></i> example@gmail.com</p>
                                        ...
                                        <h5 id="ship-to-different-address" class="">
                                            ...
                                            <input type="radio" onclick="" style="float: left;" value="register_details" name="use-as-register-checkbox" id="use-as-register-checkbox">
                                            <span class="checkmark"></span>
                                            </label>      
                                            <br><br>
					                        <label class="options" for="stda_check" >Add to a different address?
                                                <input type="radio" style="float: left;" onclick="stda()" name="use-as-register-checkbox"  class="stda-checkbox" id="stda_check" > <span class="checkmark"></span>
					                        </label>
                                        </h5>
                                             ...
                                             <div class="shipping_address" style="display: none;" id="stda_div" >
                                                ...
                                                <p id="shipping_first_name_field" class="form-row form-row-first validate-required">
                                                    <label class="" for="shipping_first_name" style="font-weight: normal;text-transform: capitalize;">First Name <abbr title="required" class="required" style="color: #c50505">*</abbr>
                                                    </label>
                                                    <input type="text" oninput="$(this).removeClass('invalid')" value="" placeholder="First name" id="shipping_first_name" name="shipping_first_name" class="input-text validate" pattern="^\S[a-zA-Z]{3,30}$" title="Minimum character '3'.Use alphabets" required="">
                                                </p>

                                                <p id="shipping_last_name_field" class="form-row form-row-last validate-required">
                                                    <label class="" for="shipping_last_name" style="font-weight: normal;text-transform: capitalize;">Last Name <abbr title="required" class="required" style="color: #c50505">*</abbr>
                                                    </label>
                                                    <input type="text" oninput="$(this).removeClass('invalid')" value="" placeholder="Last name" id="shipping_last_name" name="shipping_last_name" class="input-text validate" pattern="^[a-zA-Z ]{1,20}$" title="Use alphabets" required="">
                                                </p>

                                                <p id="shipping_phone_number_field" class="form-row form-row-last validate-required">
                                                    <label class="" for="shipping_phone_number" style="font-weight: normal;text-transform: capitalize;">Phone Number<abbr title="required" class="required" style="color: #c50505">*</abbr>
                                                    </label>
                                                    <input type="text" oninput="$(this).removeClass('invalid')" value="" placeholder="Phone number" id="shipping_ph_no" maxlength="10" name="shipping_ph_no" class="input-text validate" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57;" pattern="^\d{10}$" title="Phone Number Format (9876543210)- 10 digits" required="">
                                                </p>

                                                <p id="shipping_phone_number2_field" class="form-row form-row-last validate-required">
                                                    <label class="" for="shipping_ph_no2" style="font-weight: normal;text-transform: capitalize;">Alternate phone number<small title="required" class="required" style="color: #c50505"> (Optional)</small>
                                                    </label>
                                                    <input type="text" oninput="$(this).removeClass('invalid')" value="" placeholder="Alternate Phone Number" id="shipping_ph_no2" maxlength="10" name="shipping_ph_no2" class="input-text validate" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57;" pattern="^(\d{0}|\d{10})$" title="Phone Number Format (9876543210)- 10 digits">
                                                </p>
                                                <div class="clear"></div>

                                                <p id="shipping_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                    <label class="" for="shipping_address_1" style="font-weight: normal;text-transform: capitalize;">Address <abbr title="required" class="required" style="color: #c50505">*</abbr>
                                                    </label>
                                                    <textarea oninput="$(this).removeClass('invalid')" value="" title="Minimal character count is 10" placeholder="Street address" id="shipping_address_1" name="shipping_address_1" class="input-text validate" required=""></textarea>
                                                </p>
                                                ...
                                                <p id="shipping_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                                    <label class="" for="shipping_postcode" style="font-weight: normal;text-transform: capitalize;">Postcode <abbr title="required" class="required" style="color: #c50505">*</abbr>
                                                    </label>
                                                    <input type="text" oninput="$(this).removeClass('invalid')" value="" placeholder="Postcode / Zip" id="shipping_postcode" maxlength="6" name="shipping_postcode" class="input-text validate" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" pattern="^\d{6}$" title="PIN Number Format (654321)- 6 digits" required="">
                                                </p>
...
<div id="update_user_details" style="display: none;">
                    ...
                    <div class="register-check-box">
                        <div class="check">
                            <label class="checkbox"><input type="checkbox" id="accept" name="checkbox"><i> </i>I accept the <a href="terms&conditions.php" target="_blank">terms and conditions</a></label>
                        </div>
                    </div>
                    <div class="div-wrapper" style="display: flex;align-items: flex-end;justify-content: flex-end;">
                        <button type="button" style="padding:8px;border-radius: 50%;padding-left: 9px;padding-right: 9px;background-color: #02171e" onclick="nextPrev(-1)">
                        ...
                        <button class="shadow_b load_btn" style="display:none" type="button" ><i class="fa fa-refresh fa-spin"></i>&nbsp;Register</button>
                    </div>
</div>
...
<!------------------------------------------------------------------------------------------------------------------------------>
  <div style="overflow:auto;">
    <div style="float:right;">
      <button type="button" id="prevBtn" style="background-color: #999;color: #ffffff;border: none;padding: 6px 10px;font-size: 15px;font-family: Raleway;cursor: pointer;" onclick="nextPrev(-1)">Previous</button>

      <button type="button" id="nextBtn" style="background-color: #0c77cc;color: #ffffff;border: none;padding: 6px 20px;font-size: 15px;font-family: Raleway;cursor: pointer;" onclick="nextPrev(1)">Next</button>
    </div>
  </div>
