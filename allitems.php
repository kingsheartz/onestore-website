...
<div class="table1">
 <h4 style="margin-top: 10px;border-bottom:  1px solid#E3E3E3;padding:10px;"><i class="fas fa-boxes" style="font-size: 24px;padding-right: 12px"aria-hidden="true"></i>Latest Products</h4>
...
continue;}
  ...
  <button onclick="location.href='viewsubcat.php?category_id=<?=$ct?>'">View All</button></span>
...
?>
  ...
  justify-content: center;height: 200px;width:100%;background: white;text-align: center;"><img class="image" align="middle" src="images/<?=$row['category_id']?>/<?=$row['sub_category_id']?>/<?=$row['item_description_id']?>.jpg" onclick="location.href='single.php?id=<?=$row['item_description_id']?>'"></div>
<?php
