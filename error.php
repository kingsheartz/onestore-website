...
if(isset($_SESSION['failed'])){
  ...
  echo'<div id="cont"><div style="padding-top:100px;"><center><a href="onestore.php" ><img src="images/logo/logomail.png"  ></a></center></div>';
  ...
  echo"<center><a style='font-size:34px;color:white;font-weight:bold;text-decoration:none' href='login.php'><i style='color:#FFB04A' class='fas fa-hand-point-right'></i> <span style='color:red'><u>Log In</u></span></a></center>";
  echo'</div></div>';
}
?>
</div>
