...
function check(){
  ...
  if(ele==""){
    ...
    location.href="products_limited.php?item="+ele;
  }
}
...
function check2(){
 ...
 $(document).on('click', '.item_search_list_p', function(){ //this is the function I am trying to get to work.
...
function searchele(){
  ...
  if(cat==0){
    ...
    for (var i = 0; i <item.length; i++) {
          ...
          html+='<p class="item_search_list_p" style="margin: 0;padding: 7px 10px;border: 1px solid #CCCCCC;border-top: none;cursor: pointer;"><img src="images/'+item[i].category_id+'/'+item[i].sub_category_id+'/'+item[i].item_description_id+'.jpg" style="max-width:80px;height:30px">'+item[i].item_name+'</p>';
...
function searchele2(){
  if(document.getElementById('search2').value==null || document.getElementById('search2').value==""){
