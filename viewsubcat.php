...
?>
 <div class="products col-lg-3 col-sm-4 col-xs-6" onclick="location.href='single.php?id=<?=$row['item_description_id']?>'">
 ...
 ?>      
	...
	?>
        <li class="<?php if($pageno >= $number_of_page){ echo 'disabled'; } ?>">
            <a id="next" href="<?php if($pageno >= $number_of_page){ echo '#'; } else { 
