...
$result_con.='<div class="order-single" style="margin:0;padding:0;" onclick="location.href=\'ordersingle.php?nopid='.$row['new_ordered_products_id'].'\'">
<div class="col-sm-2 col-xs-2" onclick="location.href=\'single.php?id='.$row['item_description_id'].'\'">
  <table>            
